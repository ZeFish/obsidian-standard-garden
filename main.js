...
`),r=Object.entries(t).map(([i,l])=>{let d=i.slice(2),u=at.has(d)&&typeof l=="string"&&l.includes(" ")&&!l.startsWith("'")&&!l.startsWith('"')?"'"+l+"'":l;return`  ${i}: ${u} !important;`}).join(`
`),s=[o,`html body {
${r}
}`].filter(Boolean).join(`
