...
`&&(h=h.slice(0,-1)),h=h.replace(wa,`$&${c}`));let u=!1,g,b=-1;for(g=0;g<t.length;++g){let T=t[g];if(T===" ")u=!0;else if(T===`
...
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${c}`),N=!1,x=un(n,!0);r!=="folded"&&e!==C.BLOCK_FOLDED&&(x.onOverflow=()=>{N=!0});let w=xt(`${y}${T}${h}`,c,fn,x);if(!N)return`>${S}
${c}${w}`}return t=t.replace(/\n+/g,`$&${c}`),`|${S}
${c}${y}${t}${h}`}function qi(o,e,t,n){let{type:a,value:s}=o,{actualString:r,implicitKey:i,indent:l,indentStep:c,inFlow:f}=e;if(i&&s.includes(`
...
`?d+=`
`:p=`
`:(d+=p+b,p=" ",h=!1)}switch(a.chomp){case"-":break;case"+":for(let u=i;u<r.length;++u)d+=`
...
`};delete o.items,Object.assign(o,{type:t,source:e,end:[a]});break}default:{let n="indent"in o?o.indent:-1,a="end"in o&&Array.isArray(o.end)?o.end.filter(s=>s.type==="space"||s.type==="comment"||s.type==="newline"):[];for(let s of Object.keys(o))s!=="type"&&s!=="offset"&&delete o[s];Object.assign(o,{type:t,indent:n,source:e,end:a})}}}var ur=E(()=>{Wa();za();Pt();Nt()});function _n(o){switch(o.type){case"block-scalar":{let e="";for(let t of o.props)e+=_n(t);return e+o.source}case"block-map":case"block-seq":{let e="";for(let t of o.items)e+=Vn(t);return e}case"flow-collection":{let e=o.start.source;for(let t of o.items)e+=Vn(t);for(let t of o.end)e+=t.source;return e}case"document":{let e=Vn(o);if(o.end)for(let t of o.end)e+=t.source;return e}default:{let e=o.source;if("end"in o&&o.end)for(let t of o.end)e+=t.source;return e}}}function Vn({start:o,key:e,sep:t,value:n}){let a="";for(let s of o)a+=s.source;if(e&&(a+=_n(e)),t)for(let s of t)a+=s.source;return n&&(a+=_n(n)),a}var hr,mr=E(()=>{hr=o=>"type"in o?_n(o):Vn(o)});function Be(o,e){"type"in o&&o.type==="document"&&(o={start:o.start,value:o.value}),yr(Object.freeze([]),o,e)}function yr(o,e,t){let n=t(e,o);if(typeof n=="symbol")return n;for(let a of["key","value"]){let s=e[a];if(s&&"items"in s){for(let r=0;r<s.items.length;++r){let i=yr(Object.freeze(o.concat([[a,r]])),s.items[r],t);if(typeof i=="number")r=i-1;else{if(i===Qa)return Qa;i===gr&&(s.items.splice(r,1),r-=1)}}typeof n=="function"&&a==="key"&&(n=n(e,o))}}return typeof n=="function"?n(e,o):n}var Qa,il,gr,br=E(()=>{Qa=Symbol("break visit"),il=Symbol("skip children"),gr=Symbol("remove item");Be.BREAK=Qa;Be.SKIP=il;Be.REMOVE=gr;Be.itemAtPath=(o,e)=>{let t=o;for(let[n,a]of e){let s=t?.[n];if(s&&"items"in s)t=s.items[a];else return}return t};Be.parentCollection=(o,e)=>{let t=Be.itemAtPath(o,e.slice(0,-1)),n=e[e.length-1][0],a=t?.[n];if(a&&"items"in a)return a;throw new Error("Parent collection not found")}});var Kn={};sa(Kn,{BOM:()=>Ht,DOCUMENT:()=>jt,FLOW_END:()=>Vt,SCALAR:()=>ct,createScalarToken:()=>dr,isCollection:()=>ll,isScalar:()=>cl,prettyToken:()=>dl,resolveAsScalar:()=>cr,setScalarValue:()=>fr,stringify:()=>hr,tokenType:()=>$a,visit:()=>Be});function dl(o){switch(o){case Ht:return"<BOM>";case jt:return"<DOC>";case Vt:return"<FLOW_END>";case ct:return"<SCALAR>";default:return JSON.stringify(o)}}function $a(o){switch(o){case Ht:return"byte-order-mark";case jt:return"doc-mode";case Vt:return"flow-error-end";case ct:return"scalar";case"---":return"doc-start";case"...":return"doc-end";case"":case`
`:case`\r
`:return"newline";case"-":return"seq-item-ind";case"?":return"explicit-key-ind";case":":return"map-value-ind";case"{":return"flow-map-start";case"}":return"flow-map-end";case"[":return"flow-seq-start";case"]":return"flow-seq-end";case",":return"comma"}switch(o[0]){case" ":case"	":return"space";case"#":return"comment";case"%":return"directive-line";case"*":return"alias";case"&":return"anchor";case"!":return"tag";case"'":return"single-quoted-scalar";case'"':return"double-quoted-scalar";case"|":case">":return"block-scalar-header"}return null}var Ht,jt,Vt,ct,ll,cl,Gn=E(()=>{ur();mr();br();Ht="\uFEFF",jt="",Vt="",ct="",ll=o=>!!o&&"items"in o,cl=o=>!!o&&(o.type==="scalar"||o.type==="single-quoted-scalar"||o.type==="double-quoted-scalar"||o.type==="block-scalar")});function me(o){switch(o){case void 0:case" ":case`
