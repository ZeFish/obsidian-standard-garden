...
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${c}`),N=!1,x=un(n,!0);s!=="folded"&&e!==E.BLOCK_FOLDED&&(x.onOverflow=()=>{N=!0});let w=xt(`${y}${T}${u}`,c,fn,x);if(!N)return`>${S}
${c}${w}`}return t=t.replace(/\n+/g,`$&${c}`),`|${S}
${c}${y}${t}${u}`}function Bi(o,e,t,n){let{type:a,value:r}=o,{actualString:s,implicitKey:i,indent:l,indentStep:c,inFlow:f}=e;if(i&&r.includes(`
...
${l}`);if(s){let p=h=>h.default&&h.tag!=="tag:yaml.org,2002:str"&&h.test?.test(d),{compat:u,tags:m}=e.doc.schema;if(m.some(p)||u?.some(p))return $e(r,e)}return i?d:xt(d,l,ba,un(e,!1))}function Ne(o,e,t,n){let{implicitKey:a,inFlow:r}=e,s=typeof o.value=="string"?o:Object.assign({},o,{value:String(o.value)}),{type:i}=o;i!==E.QUOTE_DOUBLE&&/[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(s.value)&&(i=E.QUOTE_DOUBLE);let l=f=>{switch(f){case E.BLOCK_FOLDED:case E.BLOCK_LITERAL:return a||r?$e(s.value,e):pn(s,e,t,n);case E.QUOTE_DOUBLE:return Tt(s.value,e);case E.QUOTE_SINGLE:return wa(s.value,e);case E.PLAIN:return Bi(s,e,t,n);default:return null}},c=l(i);if(c===null){let{defaultKeyType:f,defaultStringType:d}=e.options,p=a&&f||d;if(c=l(p),c===null)throw new Error(`Unsupported default string type ${p}`)}return c}var un,hn,ka,Nt=C(()=>{K();mr();un=(o,e)=>({indentAtStart:e?o.indent.length:o.indentAtStart,lineWidth:o.options.lineWidth,minContentWidth:o.options.minContentWidth}),hn=o=>/^(%|---|\.\.\.)/m.test(o);try{ka=new RegExp(`(^|(?<!
))
+(?!
|$)`,"g")}catch{ka=/\n+(?!\n|$)/g}});function mn(o,e){let t=Object.assign({blockQuote:!0,commentString:ur,defaultKeyType:null,defaultStringType:"PLAIN",directives:null,doubleQuotedAsJSON:!1,doubleQuotedMinMultiLineLength:40,falseStr:"false",flowCollectionPadding:!0,indentSeq:!0,lineWidth:80,minContentWidth:20,nullStr:"null",simpleKeys:!1,singleQuote:null,trailingComma:!1,trueStr:"true",verifyAliasOrder:!0},o.schema.toStringOptions,e),n;switch(t.collectionStyle){case"block":n=!1;break;case"flow":n=!0;break;default:n=null}return{anchors:new Set,doc:o,flowCollectionPadding:t.flowCollectionPadding?" ":"",indent:"",indentStep:typeof t.indent=="number"?" ".repeat(t.indent):"  ",inFlow:n,options:t}}function qi(o,e){if(e.tag){let a=o.filter(r=>r.tag===e.tag);if(a.length>0)return a.find(r=>r.format===e.format)??a[0]}let t,n;if(M(e)){n=e.value;let a=o.filter(r=>r.identify?.(n));if(a.length>1){let r=a.filter(s=>s.test);r.length>0&&(a=r)}t=a.find(r=>r.format===e.format)??a.find(r=>!r.format)}else n=e,t=o.find(a=>a.nodeClass&&n instanceof a.nodeClass);if(!t){let a=n?.constructor?.name??(n===null?"null":typeof n);throw new Error(`Tag not resolved for ${a} value`)}return t}function Hi(o,e,{anchors:t,doc:n}){if(!n.directives)return"";let a=[],r=(M(o)||q(o))&&o.anchor;r&&on(r)&&(t.add(r),a.push(`&${r}`));let s=o.tag??(e.default?null:e.tag);return s&&a.push(n.directives.tagString(s)),a.join(" ")}function Ce(o,e,t,n){if(I(o))return o.toString(e,t,n);if(te(o)){if(e.doc.directives)return o.toString(e);if(e.resolvedAliases?.has(o))throw new TypeError("Cannot stringify circular structure without alias nodes");e.resolvedAliases?e.resolvedAliases.add(o):e.resolvedAliases=new Set([o]),o=o.resolve(e.doc)}let a,r=U(o)?o:e.doc.createNode(o,{onTagObj:l=>a=l});a??(a=qi(e.doc.schema.tags,r));let s=Hi(r,a,e);s.length>0&&(e.indentAtStart=(e.indentAtStart??0)+s.length+1);let i=typeof a.stringify=="function"?a.stringify(r,e,t,n):M(r)?Ne(r,e,t,n):r.toString(e,t,n);return s?M(r)||i[0]==="{"||i[0]==="["?`${s} ${i}`:`${s}
${e.indent}${i}`:i}var Ct=C(()=>{rn();B();vt();Nt()});function gr({key:o,value:e},t,n,a){let{allNullValues:r,doc:s,indent:i,indentStep:l,options:{commentString:c,indentSeq:f,simpleKeys:d}}=t,p=U(o)&&o.comment||null;if(d){if(p)throw new Error("With simple keys, key nodes cannot have comments");if(q(o)||!U(o)&&typeof o=="object"){let x="With simple keys, collection cannot be used as a key value";throw new Error(x)}}let u=!d&&(!o||p&&e==null&&!t.inFlow||q(o)||(M(o)?o.type===E.BLOCK_FOLDED||o.type===E.BLOCK_LITERAL:typeof o=="object"));t=Object.assign({},t,{allNullValues:!1,implicitKey:!u&&(d||!r),indent:i+l});let m=!1,h=!1,g=Ce(o,t,()=>m=!0,()=>h=!0);if(!u&&!t.inFlow&&g.length>1024){if(d)throw new Error("With simple keys, single line scalar must not span more than 1024 characters");u=!0}if(t.inFlow){if(r||e==null)return m&&n&&n(),g===""?"?":u?`? ${g}`:g}else if(r&&!d||e==null&&u)return g=`? ${g}`,p&&!m?g+=we(g,t.indent,c(p)):h&&a&&a(),g;m&&(p=null),u?(p&&(g+=we(g,t.indent,c(p))),g=`? ${g}
${i}:`):(g=`${g}:`,p&&(g+=we(g,t.indent,c(p))));let b,y,k;U(e)?(b=!!e.spaceBefore,y=e.commentBefore,k=e.comment):(b=!1,y=null,k=null,e&&typeof e=="object"&&(e=s.createNode(e))),t.implicitKey=!1,!u&&!p&&M(e)&&(t.indentAtStart=g.length+1),h=!1,!f&&l.length>=2&&!t.inFlow&&!u&&oe(e)&&!e.flow&&!e.tag&&!e.anchor&&(t.indent=t.indent.substring(2));let S=!1,T=Ce(e,t,()=>S=!0,()=>h=!0),N=" ";if(p||b||y){if(N=b?`
`:"",y){let x=c(y);N+=`
${se(x,t.indent)}`}T===""&&!t.inFlow?N===`
`&&k&&(N=`

`):N+=`
${t.indent}`}else if(!u&&q(e)){let x=T[0],w=T.indexOf(`
...
${t.indent}`)}}else(T===""||T[0]===`
`)&&(N="");return g+=N+T,t.inFlow?S&&n&&n():k&&!S?g+=we(g,t.indent,c(k)):h&&a&&a(),g}var yr=C(()=>{B();K();Ct();vt()});function gn(o,e){(o==="debug"||o==="warn")&&console.warn(e)}var va=C(()=>{});function xa(o,e,t){let n=wr(o,t);if(oe(n))for(let a of n.items)Sa(o,e,a);else if(Array.isArray(n))for(let a of n)Sa(o,e,a);else Sa(o,e,n)}function Sa(o,e,t){let n=wr(o,t);if(!ae(n))throw new Error("Merge sources must be maps or map aliases");let a=n.toJSON(null,o,Map);for(let[r,s]of a)e instanceof Map?e.has(r)||e.set(r,s):e instanceof Set?e.add(r):Object.prototype.hasOwnProperty.call(e,r)||Object.defineProperty(e,r,{value:s,writable:!0,enumerable:!0,configurable:!0});return e}function wr(o,e){return o&&te(e)?e.resolve(o.doc,o):e}var yn,fe,br,bn=C(()=>{B();K();yn="<<",fe={identify:o=>o===yn||typeof o=="symbol"&&o.description===yn,default:"key",tag:"tag:yaml.org,2002:merge",test:/^<<$/,resolve:()=>Object.assign(new E(Symbol(yn)),{addToJSMap:xa}),stringify:()=>yn},br=(o,e)=>(fe.identify(e)||M(e)&&(!e.type||e.type===E.PLAIN)&&fe.identify(e.value))&&o?.doc.schema.tags.some(t=>t.tag===fe.tag&&t.default)});function wn(o,e,{key:t,value:n}){if(U(t)&&t.addToJSMap)t.addToJSMap(o,e,n);else if(br(o,t))xa(o,e,n);else{let a=G(t,"",o);if(e instanceof Map)e.set(a,G(n,a,o));else if(e instanceof Set)e.add(a);else{let r=ji(t,a,o),s=G(n,r,o);r in e?Object.defineProperty(e,r,{value:s,writable:!0,enumerable:!0,configurable:!0}):e[r]=s}}return e}function ji(o,e,t){if(e===null)return"";if(typeof e!="object")return String(e);if(U(o)&&t?.doc){let n=mn(t.doc,{});n.anchors=new Set;for(let r of t.anchors.keys())n.anchors.add(r.anchor);n.inFlow=!0,n.inStringifyKey=!0;let a=o.toString(n);if(!t.mapKeyWarned){let r=JSON.stringify(a);r.length>40&&(r=r.substring(0,36)+'..."'),gn(t.doc.options.logLevel,`Keys with collection values will be stringified due to JS Object restrictions: ${r}. Set mapAsMap: true to use object keys.`),t.mapKeyWarned=!0}return a}return JSON.stringify(e)}var Ta=C(()=>{va();bn();Ct();B();Fe()});function et(o,e,t){let n=Te(o,void 0,t),a=Te(e,void 0,t);return new _(n,a)}var _,De=C(()=>{wt();yr();Ta();B();_=class o{constructor(e,t=null){Object.defineProperty(this,Z,{value:ua}),this.key=e,this.value=t}clone(e){let{key:t,value:n}=this;return U(t)&&(t=t.clone(e)),U(n)&&(n=n.clone(e)),new o(t,n)}toJSON(e,t){let n=t?.mapAsMap?new Map:{};return wn(t,n,this)}toString(e,t,n){return e?.doc?gr(this,e,t,n):JSON.stringify(this)}}});function vn(o,e,t){return(e.inFlow??o.flow?Vi:_i)(o,e,t)}function _i({comment:o,items:e},t,{blockItemPrefix:n,flowChars:a,itemIndent:r,onChompKeep:s,onComment:i}){let{indent:l,options:{commentString:c}}=t,f=Object.assign({},t,{indent:r,type:null}),d=!1,p=[];for(let m=0;m<e.length;++m){let h=e[m],g=null;if(U(h))!d&&h.spaceBefore&&p.push(""),kn(t,p,h.commentBefore,d),h.comment&&(g=h.comment);else if(I(h)){let y=U(h.key)?h.key:null;y&&(!d&&y.spaceBefore&&p.push(""),kn(t,p,y.commentBefore,d))}d=!1;let b=Ce(h,f,()=>g=null,()=>d=!0);g&&(b+=we(b,r,c(g))),d&&g&&(d=!1),p.push(n+b)}let u;if(p.length===0)u=a.start+a.end;else{u=p[0];for(let m=1;m<p.length;++m){let h=p[m];u+=h?`
${l}${h}`:`
`}}return o?(u+=`
`+se(c(o),l),i&&i()):d&&s&&s(),u}function Vi({items:o},e,{flowChars:t,itemIndent:n}){let{indent:a,indentStep:r,flowCollectionPadding:s,options:{commentString:i}}=e;n+=r;let l=Object.assign({},e,{indent:n,inFlow:!0,type:null}),c=!1,f=0,d=[];for(let m=0;m<o.length;++m){let h=o[m],g=null;if(U(h))h.spaceBefore&&d.push(""),kn(e,d,h.commentBefore,!1),h.comment&&(g=h.comment);else if(I(h)){let y=U(h.key)?h.key:null;y&&(y.spaceBefore&&d.push(""),kn(e,d,y.commentBefore,!1),y.comment&&(c=!0));let k=U(h.value)?h.value:null;k?(k.comment&&(g=k.comment),k.commentBefore&&(c=!0)):h.value==null&&y?.comment&&(g=y.comment)}g&&(c=!0);let b=Ce(h,l,()=>g=null);c||(c=d.length>f||b.includes(`
...
${r}${a}${h}`:`
`;return`${m}
${a}${u}`}else return`${p}${s}${d.join(" ")}${s}${u}`}function kn({indent:o,options:{commentString:e}},t,n,a){if(n&&a&&(n=n.replace(/^\n+/,"")),n){let r=se(e(n),o);t.push(r.trimStart())}}var Na=C(()=>{B();Ct();vt()});function Me(o,e){let t=M(e)?e.value:e;for(let n of o)if(I(n)&&(n.key===e||n.key===t||M(n.key)&&n.key.value===t))return n}var V,Oe=C(()=>{Na();Ta();dn();B();De();K();V=class extends Ye{static get tagName(){return"tag:yaml.org,2002:map"}constructor(e){super(ce,e),this.items=[]}static from(e,t,n){let{keepUndefined:a,replacer:r}=n,s=new this(e),i=(l,c)=>{if(typeof r=="function")c=r.call(t,l,c);else if(Array.isArray(r)&&!r.includes(l))return;(c!==void 0||a)&&s.items.push(et(l,c,n))};if(t instanceof Map)for(let[l,c]of t)i(l,c);else if(t&&typeof t=="object")for(let l of Object.keys(t))i(l,t[l]);return typeof e.sortMapEntries=="function"&&s.items.sort(e.sortMapEntries),s}add(e,t){let n;I(e)?n=e:!e||typeof e!="object"||!("key"in e)?n=new _(e,e?.value):n=new _(e.key,e.value);let a=Me(this.items,n.key),r=this.schema?.sortMapEntries;if(a){if(!t)throw new Error(`Key ${n.key} already set`);M(a.value)&&cn(n.value)?a.value.value=n.value:a.value=n.value}else if(r){let s=this.items.findIndex(i=>r(n,i)<0);s===-1?this.items.push(n):this.items.splice(s,0,n)}else this.items.push(n)}delete(e){let t=Me(this.items,e);return t?this.items.splice(this.items.indexOf(t),1).length>0:!1}get(e,t){let a=Me(this.items,e)?.value;return(!t&&M(a)?a.value:a)??void 0}has(e){return!!Me(this.items,e)}set(e,t){this.add(new _(e,t),!0)}toJSON(e,t,n){let a=n?new n:t?.mapAsMap?new Map:{};t?.onCreate&&t.onCreate(a);for(let r of this.items)wn(t,a,r);return a}toString(e,t,n){if(!e)return JSON.stringify(this);for(let a of this.items)if(!I(a))throw new Error(`Map items must all be pairs; found ${JSON.stringify(a)} instead`);return!e.allNullValues&&this.hasAllNullValues(!1)&&(e=Object.assign({},e,{allNullValues:!0})),vn(this,e,{blockItemPrefix:"",flowChars:{start:"{",end:"}"},itemIndent:e.indent||"",onChompKeep:n,onComment:t})}}});var pe,tt=C(()=>{B();Oe();pe={collection:"map",default:!0,nodeClass:V,tag:"tag:yaml.org,2002:map",resolve(o,e){return ae(o)||e("Expected a mapping for this tag"),o},createNode:(o,e,t)=>V.from(o,e,t)}});function Sn(o){let e=M(o)?o.value:o;return e&&typeof e=="string"&&(e=Number(e)),typeof e=="number"&&Number.isInteger(e)&&e>=0?e:null}var z,Re=C(()=>{wt();Na();dn();B();K();Fe();z=class extends Ye{static get tagName(){return"tag:yaml.org,2002:seq"}constructor(e){super(xe,e),this.items=[]}add(e){this.items.push(e)}delete(e){let t=Sn(e);return typeof t!="number"?!1:this.items.splice(t,1).length>0}get(e,t){let n=Sn(e);if(typeof n!="number")return;let a=this.items[n];return!t&&M(a)?a.value:a}has(e){let t=Sn(e);return typeof t=="number"&&t<this.items.length}set(e,t){let n=Sn(e);if(typeof n!="number")throw new Error(`Expected a valid index, not ${e}.`);let a=this.items[n];M(a)&&cn(t)?a.value=t:this.items[n]=t}toJSON(e,t){let n=[];t?.onCreate&&t.onCreate(n);let a=0;for(let r of this.items)n.push(G(r,String(a++),t));return n}toString(e,t,n){return e?vn(this,e,{blockItemPrefix:"- ",flowChars:{start:"[",end:"]"},itemIndent:(e.indent||"")+"  ",onChompKeep:n,onComment:t}):JSON.stringify(this)}static from(e,t,n){let{replacer:a}=n,r=new this(e);if(t&&Symbol.iterator in Object(t)){let s=0;for(let i of t){if(typeof a=="function"){let l=t instanceof Set?i:String(s++);i=a.call(t,l,i)}r.items.push(Te(i,void 0,n))}}return r}}});var ue,nt=C(()=>{B();Re();ue={collection:"seq",default:!0,nodeClass:z,tag:"tag:yaml.org,2002:seq",resolve(o,e){return oe(o)||e("Expected a sequence for this tag"),o},createNode:(o,e,t)=>z.from(o,e,t)}});var Ie,Et=C(()=>{Nt();Ie={identify:o=>typeof o=="string",default:!0,tag:"tag:yaml.org,2002:str",resolve:o=>o,stringify(o,e,t,n){return e=Object.assign({actualString:!0},e),Ne(o,e,t,n)}}});var _e,xn=C(()=>{K();_e={identify:o=>o==null,createNode:()=>new E(null),default:!0,tag:"tag:yaml.org,2002:null",test:/^(?:~|[Nn]ull|NULL)?$/,resolve:()=>new E(null),stringify:({source:o},e)=>typeof o=="string"&&_e.test.test(o)?o:e.options.nullStr}});var Lt,Ca=C(()=>{K();Lt={identify:o=>typeof o=="boolean",default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:[Tt]rue|TRUE|[Ff]alse|FALSE)$/,resolve:o=>new E(o[0]==="t"||o[0]==="T"),stringify({source:o,value:e},t){if(o&&Lt.test.test(o)){let n=o[0]==="t"||o[0]==="T";if(e===n)return o}return e?t.options.trueStr:t.options.falseStr}}});function X({format:o,minFractionDigits:e,tag:t,value:n}){if(typeof n=="bigint")return String(n);let a=typeof n=="number"?n:Number(n);if(!isFinite(a))return isNaN(a)?".nan":a<0?"-.inf":".inf";let r=Object.is(n,-0)?"-0":JSON.stringify(n);if(!o&&e&&(!t||t==="tag:yaml.org,2002:float")&&/^-?\d/.test(r)&&!r.includes("e")){let s=r.indexOf(".");s<0&&(s=r.length,r+=".");let i=e-(r.length-s-1);for(;i-- >0;)r+="0"}return r}var at=C(()=>{});var Tn,Nn,Cn,Ea=C(()=>{K();at();Tn={identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^(?:[-+]?\.(?:inf|Inf|INF)|\.nan|\.NaN|\.NAN)$/,resolve:o=>o.slice(-3).toLowerCase()==="nan"?NaN:o[0]==="-"?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY,stringify:X},Nn={identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"EXP",test:/^[-+]?(?:\.[0-9]+|[0-9]+(?:\.[0-9]*)?)[eE][-+]?[0-9]+$/,resolve:o=>parseFloat(o),stringify(o){let e=Number(o.value);return isFinite(e)?e.toExponential():X(o)}},Cn={identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^[-+]?(?:\.[0-9]+|[0-9]+\.[0-9]*)$/,resolve(o){let e=new E(parseFloat(o)),t=o.indexOf(".");return t!==-1&&o[o.length-1]==="0"&&(e.minFractionDigits=o.length-t-1),e},stringify:X}});function kr(o,e,t){let{value:n}=o;return En(n)&&n>=0?t+n.toString(e):X(o)}var En,La,Ln,Fn,An,Fa=C(()=>{at();En=o=>typeof o=="bigint"||Number.isInteger(o),La=(o,e,t,{intAsBigInt:n})=>n?BigInt(o):parseInt(o.substring(e),t);Ln={identify:o=>En(o)&&o>=0,default:!0,tag:"tag:yaml.org,2002:int",format:"OCT",test:/^0o[0-7]+$/,resolve:(o,e,t)=>La(o,2,8,t),stringify:o=>kr(o,8,"0o")},Fn={identify:En,default:!0,tag:"tag:yaml.org,2002:int",test:/^[-+]?[0-9]+$/,resolve:(o,e,t)=>La(o,0,10,t),stringify:X},An={identify:o=>En(o)&&o>=0,default:!0,tag:"tag:yaml.org,2002:int",format:"HEX",test:/^0x[0-9a-fA-F]+$/,resolve:(o,e,t)=>La(o,2,16,t),stringify:o=>kr(o,16,"0x")}});var vr,Sr=C(()=>{tt();xn();nt();Et();Ca();Ea();Fa();vr=[pe,ue,Ie,_e,Lt,Ln,Fn,An,Tn,Nn,Cn]});function xr(o){return typeof o=="bigint"||Number.isInteger(o)}var Dn,Ki,Gi,Tr,Nr=C(()=>{K();tt();nt();Dn=({value:o})=>JSON.stringify(o),Ki=[{identify:o=>typeof o=="string",default:!0,tag:"tag:yaml.org,2002:str",resolve:o=>o,stringify:Dn},{identify:o=>o==null,createNode:()=>new E(null),default:!0,tag:"tag:yaml.org,2002:null",test:/^null$/,resolve:()=>null,stringify:Dn},{identify:o=>typeof o=="boolean",default:!0,tag:"tag:yaml.org,2002:bool",test:/^true$|^false$/,resolve:o=>o==="true",stringify:Dn},{identify:xr,default:!0,tag:"tag:yaml.org,2002:int",test:/^-?(?:0|[1-9][0-9]*)$/,resolve:(o,e,{intAsBigInt:t})=>t?BigInt(o):parseInt(o,10),stringify:({value:o})=>xr(o)?o.toString():JSON.stringify(o)},{identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^-?(?:0|[1-9][0-9]*)(?:\.[0-9]*)?(?:[eE][-+]?[0-9]+)?$/,resolve:o=>parseFloat(o),stringify:Dn}],Gi={default:!0,tag:"",test:/^/,resolve(o,e){return e(`Unresolved plain scalar ${JSON.stringify(o)}`),o}},Tr=[pe,ue].concat(Ki,Gi)});var Ft,Aa=C(()=>{K();Nt();Ft={identify:o=>o instanceof Uint8Array,default:!1,tag:"tag:yaml.org,2002:binary",resolve(o,e){if(typeof atob=="function"){let t=atob(o.replace(/[\n\r]/g,"")),n=new Uint8Array(t.length);for(let a=0;a<t.length;++a)n[a]=t.charCodeAt(a);return n}else return e("This environment does not support reading binary tags; either Buffer or atob is required"),o},stringify({comment:o,type:e,value:t},n,a,r){if(!t)return"";let s=t,i;if(typeof btoa=="function"){let l="";for(let c=0;c<s.length;++c)l+=String.fromCharCode(s[c]);i=btoa(l)}else throw new Error("This environment does not support writing binary tags; either Buffer or btoa is required");if(e??(e=E.BLOCK_LITERAL),e!==E.QUOTE_DOUBLE){let l=Math.max(n.options.lineWidth-n.indent.length,n.options.minContentWidth),c=Math.ceil(i.length/l),f=new Array(c);for(let d=0,p=0;d<c;++d,p+=l)f[d]=i.substr(p,l);i=f.join(e===E.BLOCK_LITERAL?`
`:" ")}return Ne({comment:o,type:e,value:i},n,a,r)}}});function Da(o,e){if(oe(o))for(let t=0;t<o.items.length;++t){let n=o.items[t];if(!I(n)){if(ae(n)){n.items.length>1&&e("Each pair must have its own sequence indicator");let a=n.items[0]||new _(new E(null));if(n.commentBefore&&(a.key.commentBefore=a.key.commentBefore?`${n.commentBefore}
${a.key.commentBefore}`:n.commentBefore),n.comment){let r=a.value??a.key;r.comment=r.comment?`${n.comment}
${r.comment}`:n.comment}n=a}o.items[t]=I(n)?n:new _(n)}}else e("Expected a sequence for this tag");return o}function Ma(o,e,t){let{replacer:n}=t,a=new z(o);a.tag="tag:yaml.org,2002:pairs";let r=0;if(e&&Symbol.iterator in Object(e))for(let s of e){typeof n=="function"&&(s=n.call(e,String(r++),s));let i,l;if(Array.isArray(s))if(s.length===2)i=s[0],l=s[1];else throw new TypeError(`Expected [key, value] tuple: ${s}`);else if(s&&s instanceof Object){let c=Object.keys(s);if(c.length===1)i=c[0],l=s[i];else throw new TypeError(`Expected tuple with one key, not ${c.length} keys`)}else i=s;a.items.push(et(i,l,t))}return a}var At,Mn=C(()=>{B();De();K();Re();At={collection:"seq",default:!1,tag:"tag:yaml.org,2002:pairs",resolve:Da,createNode:Ma}});var ot,Dt,Oa=C(()=>{B();Fe();Oe();Re();Mn();ot=class o extends z{constructor(){super(),this.add=V.prototype.add.bind(this),this.delete=V.prototype.delete.bind(this),this.get=V.prototype.get.bind(this),this.has=V.prototype.has.bind(this),this.set=V.prototype.set.bind(this),this.tag=o.tag}toJSON(e,t){if(!t)return super.toJSON(e);let n=new Map;t?.onCreate&&t.onCreate(n);for(let a of this.items){let r,s;if(I(a)?(r=G(a.key,"",t),s=G(a.value,r,t)):r=G(a,"",t),n.has(r))throw new Error("Ordered maps must not include duplicate keys");n.set(r,s)}return n}static from(e,t,n){let a=Ma(e,t,n),r=new this;return r.items=a.items,r}};ot.tag="tag:yaml.org,2002:omap";Dt={collection:"seq",identify:o=>o instanceof Map,nodeClass:ot,default:!1,tag:"tag:yaml.org,2002:omap",resolve(o,e){let t=Da(o,e),n=[];for(let{key:a}of t.items)M(a)&&(n.includes(a.value)?e(`Ordered maps must not include duplicate keys: ${a.value}`):n.push(a.value));return Object.assign(new ot,t)},createNode:(o,e,t)=>ot.from(o,e,t)}});function Cr({value:o,source:e},t){return e&&(o?Ra:Ia).test.test(e)?e:o?t.options.trueStr:t.options.falseStr}var Ra,Ia,Er=C(()=>{K();Ra={identify:o=>o===!0,default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:Y|y|[Yy]es|YES|[Tt]rue|TRUE|[Oo]n|ON)$/,resolve:()=>new E(!0),stringify:Cr},Ia={identify:o=>o===!1,default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:N|n|[Nn]o|NO|[Ff]alse|FALSE|[Oo]ff|OFF)$/,resolve:()=>new E(!1),stringify:Cr}});var Lr,Fr,Ar,Dr=C(()=>{K();at();Lr={identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^(?:[-+]?\.(?:inf|Inf|INF)|\.nan|\.NaN|\.NAN)$/,resolve:o=>o.slice(-3).toLowerCase()==="nan"?NaN:o[0]==="-"?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY,stringify:X},Fr={identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"EXP",test:/^[-+]?(?:[0-9][0-9_]*)?(?:\.[0-9_]*)?[eE][-+]?[0-9]+$/,resolve:o=>parseFloat(o.replace(/_/g,"")),stringify(o){let e=Number(o.value);return isFinite(e)?e.toExponential():X(o)}},Ar={identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^[-+]?(?:[0-9][0-9_]*)?\.[0-9_]*$/,resolve(o){let e=new E(parseFloat(o.replace(/_/g,""))),t=o.indexOf(".");if(t!==-1){let n=o.substring(t+1).replace(/_/g,"");n[n.length-1]==="0"&&(e.minFractionDigits=n.length)}return e},stringify:X}});function On(o,e,t,{intAsBigInt:n}){let a=o[0];if((a==="-"||a==="+")&&(e+=1),o=o.substring(e).replace(/_/g,""),n){switch(t){case 2:o=`0b${o}`;break;case 8:o=`0o${o}`;break;case 16:o=`0x${o}`;break}let s=BigInt(o);return a==="-"?BigInt(-1)*s:s}let r=parseInt(o,t);return a==="-"?-1*r:r}function Pa(o,e,t){let{value:n}=o;if(Mt(n)){let a=n.toString(e);return n<0?"-"+t+a.substr(1):t+a}return X(o)}var Mt,Mr,Or,Rr,Ir,Pr=C(()=>{at();Mt=o=>typeof o=="bigint"||Number.isInteger(o);Mr={identify:Mt,default:!0,tag:"tag:yaml.org,2002:int",format:"BIN",test:/^[-+]?0b[0-1_]+$/,resolve:(o,e,t)=>On(o,2,2,t),stringify:o=>Pa(o,2,"0b")},Or={identify:Mt,default:!0,tag:"tag:yaml.org,2002:int",format:"OCT",test:/^[-+]?0[0-7_]+$/,resolve:(o,e,t)=>On(o,1,8,t),stringify:o=>Pa(o,8,"0")},Rr={identify:Mt,default:!0,tag:"tag:yaml.org,2002:int",test:/^[-+]?[0-9][0-9_]*$/,resolve:(o,e,t)=>On(o,0,10,t),stringify:X},Ir={identify:Mt,default:!0,tag:"tag:yaml.org,2002:int",format:"HEX",test:/^[-+]?0x[0-9a-fA-F_]+$/,resolve:(o,e,t)=>On(o,2,16,t),stringify:o=>Pa(o,16,"0x")}});var rt,Ot,Ua=C(()=>{B();De();Oe();rt=class o extends V{constructor(e){super(e),this.tag=o.tag}add(e){let t;I(e)?t=e:e&&typeof e=="object"&&"key"in e&&"value"in e&&e.value===null?t=new _(e.key,null):t=new _(e,null),Me(this.items,t.key)||this.items.push(t)}get(e,t){let n=Me(this.items,e);return!t&&I(n)?M(n.key)?n.key.value:n.key:n}set(e,t){if(typeof t!="boolean")throw new Error(`Expected boolean value for set(key, value) in a YAML set, not ${typeof t}`);let n=Me(this.items,e);n&&!t?this.items.splice(this.items.indexOf(n),1):!n&&t&&this.items.push(new _(e))}toJSON(e,t){return super.toJSON(e,t,Set)}toString(e,t,n){if(!e)return JSON.stringify(this);if(this.hasAllNullValues(!0))return super.toString(Object.assign({},e,{allNullValues:!0}),t,n);throw new Error("Set items must all have null values")}static from(e,t,n){let{replacer:a}=n,r=new this(e);if(t&&Symbol.iterator in Object(t))for(let s of t)typeof a=="function"&&(s=a.call(t,s,s)),r.items.push(et(s,null,n));return r}};rt.tag="tag:yaml.org,2002:set";Ot={collection:"map",identify:o=>o instanceof Set,nodeClass:rt,default:!1,tag:"tag:yaml.org,2002:set",createNode:(o,e,t)=>rt.from(o,e,t),resolve(o,e){if(ae(o)){if(o.hasAllNullValues(!0))return Object.assign(new rt,o);e("Set items must all have null values")}else e("Expected a mapping for this tag");return o}}});function Ba(o,e){let t=o[0],n=t==="-"||t==="+"?o.substring(1):o,a=s=>e?BigInt(s):Number(s),r=n.replace(/_/g,"").split(":").reduce((s,i)=>s*a(60)+a(i),a(0));return t==="-"?a(-1)*r:r}function Ur(o){let{value:e}=o,t=s=>s;if(typeof e=="bigint")t=s=>BigInt(s);else if(isNaN(e)||!isFinite(e))return X(o);let n="";e<0&&(n="-",e*=t(-1));let a=t(60),r=[e%a];return e<60?r.unshift(0):(e=(e-r[0])/a,r.unshift(e%a),e>=60&&(e=(e-r[0])/a,r.unshift(e))),n+r.map(s=>String(s).padStart(2,"0")).join(":").replace(/000000\d*$/,"")}var Rn,In,st,qa=C(()=>{at();Rn={identify:o=>typeof o=="bigint"||Number.isInteger(o),default:!0,tag:"tag:yaml.org,2002:int",format:"TIME",test:/^[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+$/,resolve:(o,e,{intAsBigInt:t})=>Ba(o,t),stringify:Ur},In={identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"TIME",test:/^[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+\.[0-9_]*$/,resolve:o=>Ba(o,!1),stringify:Ur},st={identify:o=>o instanceof Date,default:!0,tag:"tag:yaml.org,2002:timestamp",test:RegExp("^([0-9]{4})-([0-9]{1,2})-([0-9]{1,2})(?:(?:t|T|[ \\t]+)([0-9]{1,2}):([0-9]{1,2}):([0-9]{1,2}(\\.[0-9]+)?)(?:[ \\t]*(Z|[-+][012]?[0-9](?::[0-9]{2})?))?)?$"),resolve(o){let e=o.match(st.test);if(!e)throw new Error("!!timestamp expects a date, starting with yyyy-mm-dd");let[,t,n,a,r,s,i]=e.map(Number),l=e[7]?Number((e[7]+"00").substr(1,3)):0,c=Date.UTC(t,n-1,a,r||0,s||0,i||0,l),f=e[8];if(f&&f!=="Z"){let d=Ba(f,!1);Math.abs(d)<30&&(d*=60),c-=6e4*d}return new Date(c)},stringify:({value:o})=>o?.toISOString().replace(/(T00:00:00)?\.000Z$/,"")??""}});var Ha,Br=C(()=>{tt();xn();nt();Et();Aa();Er();Dr();Pr();bn();Oa();Mn();Ua();qa();Ha=[pe,ue,Ie,_e,Ra,Ia,Mr,Or,Rr,Ir,Lr,Fr,Ar,Ft,fe,Dt,At,Ot,Rn,In,st]});function Pn(o,e,t){let n=qr.get(e);if(n&&!o)return t&&!n.includes(fe)?n.concat(fe):n.slice();let a=n;if(!a)if(Array.isArray(o))a=[];else{let r=Array.from(qr.keys()).filter(s=>s!=="yaml11").map(s=>JSON.stringify(s)).join(", ");throw new Error(`Unknown schema "${e}"; use one of ${r} or define customTags array`)}if(Array.isArray(o))for(let r of o)a=a.concat(r);else typeof o=="function"&&(a=o(a.slice()));return t&&(a=a.concat(fe)),a.reduce((r,s)=>{let i=typeof s=="string"?Hr[s]:s;if(!i){let l=JSON.stringify(s),c=Object.keys(Hr).map(f=>JSON.stringify(f)).join(", ");throw new Error(`Unknown custom tag ${l}; use one of ${c}`)}return r.includes(i)||r.push(i),r},[])}var qr,Hr,jr,_r=C(()=>{tt();xn();nt();Et();Ca();Ea();Fa();Sr();Nr();Aa();bn();Oa();Mn();Br();Ua();qa();qr=new Map([["core",vr],["failsafe",[pe,ue,Ie]],["json",Tr],["yaml11",Ha],["yaml-1.1",Ha]]),Hr={binary:Ft,bool:Lt,float:Cn,floatExp:Nn,floatNaN:Tn,floatTime:In,int:Fn,intHex:An,intOct:Ln,intTime:Rn,map:pe,merge:fe,null:_e,omap:Dt,pairs:At,seq:ue,set:Ot,timestamp:st},jr={"tag:yaml.org,2002:binary":Ft,"tag:yaml.org,2002:merge":fe,"tag:yaml.org,2002:omap":Dt,"tag:yaml.org,2002:pairs":At,"tag:yaml.org,2002:set":Ot,"tag:yaml.org,2002:timestamp":st}});var Wi,Ve,ja=C(()=>{B();tt();nt();Et();_r();Wi=(o,e)=>o.key<e.key?-1:o.key>e.key?1:0,Ve=class o{constructor({compat:e,customTags:t,merge:n,resolveKnownTags:a,schema:r,sortMapEntries:s,toStringDefaults:i}){this.compat=Array.isArray(e)?Pn(e,"compat"):e?Pn(null,e):null,this.name=typeof r=="string"&&r||"core",this.knownTags=a?jr:{},this.tags=Pn(t,this.name,n),this.toStringOptions=i??null,Object.defineProperty(this,ce,{value:pe}),Object.defineProperty(this,ee,{value:Ie}),Object.defineProperty(this,xe,{value:ue}),this.sortMapEntries=typeof s=="function"?s:s===!0?Wi:null}clone(){let e=Object.create(o.prototype,Object.getOwnPropertyDescriptors(this));return e.tags=this.tags.slice(),e}}});function Vr(o,e){let t=[],n=e.directives===!0;if(e.directives!==!1&&o.directives){let l=o.directives.toString(o);l?(t.push(l),n=!0):o.directives.docStart&&(n=!0)}n&&t.push("---");let a=mn(o,e),{commentString:r}=a.options;if(o.commentBefore){t.length!==1&&t.unshift("");let l=r(o.commentBefore);t.unshift(se(l,""))}let s=!1,i=null;if(o.contents){if(U(o.contents)){if(o.contents.spaceBefore&&n&&t.push(""),o.contents.commentBefore){let f=r(o.contents.commentBefore);t.push(se(f,""))}a.forceBlockIndent=!!o.comment,i=o.contents.comment}let l=i?void 0:()=>s=!0,c=Ce(o.contents,a,()=>i=null,l);i&&(c+=we(c,"",r(i))),(c[0]==="|"||c[0]===">")&&t[t.length-1]==="---"?t[t.length-1]=`--- ${c}`:t.push(c)}else t.push(Ce(o.contents,a));if(o.directives?.docEnd)if(o.comment){let l=r(o.comment);l.includes(`
...
`+v.comment:w.comment=v.comment);let D=new _(w,L);if(t.options.keepSourceTokens&&(D.srcToken=b),s){let F=c;Bn(t,F.items,w)&&a(x,"DUPLICATE_KEY","Map keys must be unique"),F.items.push(D)}else{let F=new V(t.schema);F.flow=!0,F.items.push(D);let P=(L??w).range;F.range=[w.range[0],P[1],P[2]],c.items.push(F)}d=L?L.range[2]:v.end}}let p=s?"}":"]",[u,...m]=n.end,h=d;if(u?.source===p)h=u.offset+u.source.length;else{let g=i[0].toUpperCase()+i.substring(1),b=f?`${g} must end with a ${p}`:`${g} in block collection must be sufficiently indented and end with a ${p}`;a(d,f?"MISSING_CHAR":"BAD_INDENT",b),u&&u.source.length!==1&&m.unshift(u)}if(m.length>0){let g=ve(m,h,t.options.strict,a);g.comment&&(c.comment?c.comment+=`
`+g.comment:c.comment=g.comment),c.range=[n.offset,h,g.offset]}else c.range=[n.offset,h,h];return c}var Ka,Ga,Yr=C(()=>{B();De();Oe();Re();lt();Ut();Un();Va();Ka="Block collections are not allowed within flow collections",Ga=o=>o&&(o.type==="block-map"||o.type==="block-seq")});function Wa(o,e,t,n,a,r){let s=t.type==="block-map"?Wr(o,e,t,n,r):t.type==="block-seq"?Jr(o,e,t,n,r):Zr(o,e,t,n,r),i=s.constructor;return a==="!"||a===i.tagName?(s.tag=i.tagName,s):(a&&(s.tag=a),s)}function Qr(o,e,t,n,a){let r=n.tag,s=r?e.directives.tagName(r.source,p=>a(r,"TAG_RESOLVE_FAILED",p)):null;if(t.type==="block-seq"){let{anchor:p,newlineAfterProp:u}=n,m=p&&r?p.offset>r.offset?p:r:p??r;m&&(!u||u.offset<m.offset)&&a(m,"MISSING_CHAR","Missing newline after block sequence props")}let i=t.type==="block-map"?"map":t.type==="block-seq"?"seq":t.start.source==="{"?"map":"seq";if(!r||!s||s==="!"||s===V.tagName&&i==="map"||s===z.tagName&&i==="seq")return Wa(o,e,t,a,s);let l=e.schema.tags.find(p=>p.tag===s&&p.collection===i);if(!l){let p=e.schema.knownTags[s];if(p?.collection===i)e.schema.tags.push(Object.assign({},p,{default:!1})),l=p;else return p?a(r,"BAD_COLLECTION_TYPE",`${p.tag} used for ${i} collection, but expects ${p.collection??"scalar"}`,!0):a(r,"TAG_RESOLVE_FAILED",`Unresolved tag: ${s}`,!0),Wa(o,e,t,a,s)}let c=Wa(o,e,t,a,s,l),f=l.resolve?.(c,p=>a(r,"TAG_RESOLVE_FAILED",p),e.options)??c,d=U(f)?f:new E(f);return d.range=c.range,d.tag=s,l?.format&&(d.format=l.format),d}var $r=C(()=>{B();K();Oe();Re();zr();Xr();Yr()});function qn(o,e,t){let n=e.offset,a=zi(e,o.options.strict,t);if(!a)return{value:"",type:null,comment:"",range:[n,n,n]};let r=a.mode===">"?E.BLOCK_FOLDED:E.BLOCK_LITERAL,s=e.source?Ji(e.source):[],i=s.length;for(let h=s.length-1;h>=0;--h){let g=s[h][1];if(g===""||g==="\r")i=h;else break}if(i===0){let h=a.chomp==="+"&&s.length>0?`
...
`;for(let h=f;h<i;++h){let[g,b]=s[h];c+=g.length+b.length+1;let y=b[b.length-1]==="\r";if(y&&(b=b.slice(0,-1)),b&&g.length<l){let S=`Block scalar lines must not be less indented than their ${a.indent?"explicit indentation indicator":"first line"}`;t(c-b.length-(y?2:1),"BAD_INDENT",S),g=""}r===E.BLOCK_LITERAL?(d+=p+g.slice(l)+b,p=`
`):g.length>l||b[0]==="	"?(p===" "?p=`
`:!u&&p===`
`&&(p=`
...
`&&(d+=`
`);break;default:d+=`
`}let m=n+a.length+e.source.length;return{value:d,type:r,comment:a.comment,range:[n,m,m]}}function zi({offset:o,props:e},t,n){if(e[0].type!=="block-scalar-header")return n(e[0],"IMPOSSIBLE","Block scalar header not found"),null;let{source:a}=e[0],r=a[0],s=0,i="",l=-1;for(let p=1;p<a.length;++p){let u=a[p];if(!i&&(u==="-"||u==="+"))i=u;else{let m=Number(u);!s&&m?s=m:l===-1&&(l=o+p)}}l!==-1&&n(l,"UNEXPECTED_TOKEN",`Block scalar header includes extra characters: ${a}`);let c=!1,f="",d=a.length;for(let p=1;p<e.length;++p){let u=e[p];switch(u.type){case"space":c=!0;case"newline":d+=u.source.length;break;case"comment":t&&!c&&n(u,"MISSING_CHAR","Comments must be separated from other tokens by white space characters"),d+=u.source.length,f=u.source.substring(1);break;case"error":n(u,"UNEXPECTED_TOKEN",u.message),d+=u.source.length;break;default:{let m=`Unexpected token in block scalar header: ${u.type}`;n(u,"UNEXPECTED_TOKEN",m);let h=u.source;h&&typeof h=="string"&&(d+=h.length)}}}return{mode:r,indent:s,chomp:i,comment:f,length:d}}function Ji(o){let e=o.split(/\n( *)/),t=e[0],n=t.match(/^( *)/),r=[n?.[1]?[n[1],t.slice(n[1].length)]:["",t]];for(let s=1;s<e.length;s+=2)r.push([e[s],e[s+1]]);return r}var za=C(()=>{K()});function Hn(o,e,t){let{offset:n,type:a,source:r,end:s}=o,i,l,c=(p,u,m)=>t(n+p,u,m);switch(a){case"scalar":i=E.PLAIN,l=Xi(r,c);break;case"single-quoted-scalar":i=E.QUOTE_SINGLE,l=Zi(r,c);break;case"double-quoted-scalar":i=E.QUOTE_DOUBLE,l=Yi(r,c);break;default:return t(o,"UNEXPECTED_TOKEN",`Expected a flow scalar value, but found: ${a}`),{value:"",type:null,comment:"",range:[n,n+r.length,n+r.length]}}let f=n+r.length,d=ve(s,f,e,t);return{value:l,type:i,comment:d.comment,range:[n,f,d.offset]}}function Xi(o,e){let t="";switch(o[0]){case"	":t="a tab character";break;case",":t="flow indicator character ,";break;case"%":t="directive indicator character %";break;case"|":case">":{t=`block scalar indicator ${o[0]}`;break}case"@":case"`":{t=`reserved character ${o[0]}`;break}}return t&&e(0,"BAD_SCALAR_START",`Plain value cannot start with ${t}`),es(o)}function Zi(o,e){return(o[o.length-1]!=="'"||o.length===1)&&e(o.length,"MISSING_CHAR","Missing closing 'quote"),es(o.slice(1,-1)).replace(/''/g,"'")}function es(o){let e,t;try{e=new RegExp(`(.*?)(?<![ 	])[ 	]*\r?
`,"sy"),t=new RegExp(`[ 	]*(.*?)(?:(?<![ 	])[ 	]*)?\r?
`,"sy")}catch{e=/(.*?)[ \t]*\r?\n/sy,t=/[ \t]*(.*?)[ \t]*\r?\n/sy}let n=e.exec(o);if(!n)return o;let a=n[1],r=" ",s=e.lastIndex;for(t.lastIndex=s;n=t.exec(o);)n[1]===""?r===`
`?a+=r:r=`
`:(a+=r+n[1],r=" "),s=t.lastIndex;let i=/[ \t]*(.*)/sy;return i.lastIndex=s,n=i.exec(o),a+r+(n?.[1]??"")}function Yi(o,e){let t="";for(let n=1;n<o.length-1;++n){let a=o[n];if(!(a==="\r"&&o[n+1]===`
`))if(a===`
`){let{fold:r,offset:s}=Qi(o,n);t+=r,n=s}else if(a==="\\"){let r=o[++n],s=$i[r];if(s)t+=s;else if(r===`
`)for(r=o[n+1];r===" "||r==="	";)r=o[++n+1];else if(r==="\r"&&o[n+1]===`
`)for(r=o[++n+1];r===" "||r==="	";)r=o[++n+1];else if(r==="x"||r==="u"||r==="U"){let i=r==="x"?2:r==="u"?4:8;t+=el(o,n+1,i,e),n+=i}else{let i=o.substr(n-1,2);e(n-1,"BAD_DQ_ESCAPE",`Invalid escape sequence ${i}`),t+=i}}else if(a===" "||a==="	"){let r=n,s=o[n+1];for(;s===" "||s==="	";)s=o[++n+1];s!==`
`&&!(s==="\r"&&o[n+2]===`
`)&&(t+=n>r?o.slice(r,n+1):a)}else t+=a}return(o[o.length-1]!=='"'||o.length===1)&&e(o.length,"MISSING_CHAR",'Missing closing "quote'),t}function Qi(o,e){let t="",n=o[e+1];for(;(n===" "||n==="	"||n===`
`||n==="\r")&&!(n==="\r"&&o[e+2]!==`
`);)n===`
`&&(t+=`
`),e+=1,n=o[e+1];return t||(t=" "),{fold:t,offset:e}}function el(o,e,t,n){let a=o.substr(e,t),s=a.length===t&&/^[0-9a-fA-F]+$/.test(a)?parseInt(a,16):NaN;try{return String.fromCodePoint(s)}catch{let i=o.substr(e-2,t+2);return n(e-2,"BAD_DQ_ESCAPE",`Invalid escape sequence ${i}`),i}}var $i,Ja=C(()=>{K();lt();$i={0:"\0",a:"\x07",b:"\b",e:"\x1B",f:"\f",n:`
`,r:"\r",t:"	",v:"\v",N:"\x85",_:"\xA0",L:"\u2028",P:"\u2029"," ":" ",'"':'"',"/":"/","\\":"\\","	":"	"}});function Xa(o,e,t,n){let{value:a,type:r,comment:s,range:i}=e.type==="block-scalar"?qn(o,e,n):Hn(e,o.options.strict,n),l=t?o.directives.tagName(t.source,d=>n(t,"TAG_RESOLVE_FAILED",d)):null,c;o.options.stringKeys&&o.atKey?c=o.schema[ee]:l?c=tl(o.schema,a,l,t,n):e.type==="scalar"?c=nl(o,a,e,n):c=o.schema[ee];let f;try{let d=c.resolve(a,p=>n(t??e,"TAG_RESOLVE_FAILED",p),o.options);f=M(d)?d:new E(d)}catch(d){let p=d instanceof Error?d.message:String(d);n(t??e,"TAG_RESOLVE_FAILED",p),f=new E(a)}return f.range=i,f.source=a,r&&(f.type=r),l&&(f.tag=l),c.format&&(f.format=c.format),s&&(f.comment=s),f}function tl(o,e,t,n,a){if(t==="!")return o[ee];let r=[];for(let i of o.tags)if(!i.collection&&i.tag===t)if(i.default&&i.test)r.push(i);else return i;for(let i of r)if(i.test?.test(e))return i;let s=o.knownTags[t];return s&&!s.collection?(o.tags.push(Object.assign({},s,{default:!1,test:void 0})),s):(a(n,"TAG_RESOLVE_FAILED",`Unresolved tag: ${t}`,t!=="tag:yaml.org,2002:str"),o[ee])}function nl({atKey:o,directives:e,schema:t},n,a,r){let s=t.tags.find(i=>(i.default===!0||o&&i.default==="key")&&i.test?.test(n))||t[ee];if(t.compat){let i=t.compat.find(l=>l.default&&l.test?.test(n))??t[ee];if(s.tag!==i.tag){let l=e.tagString(s.tag),c=e.tagString(i.tag),f=`Value may be parsed as either ${l} or ${c}`;r(a,"TAG_RESOLVE_FAILED",f,!0)}}return s}var ts=C(()=>{B();K();za();Ja()});function ns(o,e,t){if(e){t??(t=e.length);for(let n=t-1;n>=0;--n){let a=e[n];switch(a.type){case"space":case"comment":case"newline":o-=a.source.length;continue}for(a=e[++n];a?.type==="space";)o+=a.source.length,a=e[++n];break}}return o}var as=C(()=>{});function Za(o,e,t,n){let a=o.atKey,{spaceBefore:r,comment:s,anchor:i,tag:l}=t,c,f=!0;switch(e.type){case"alias":c=ol(o,e,n),(i||l)&&n(e,"ALIAS_PROPS","An alias node must not specify any properties");break;case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":case"block-scalar":c=Xa(o,e,l,n),i&&(c.anchor=i.source.substring(1));break;case"block-map":case"block-seq":case"flow-collection":try{c=Qr(al,o,e,t,n),i&&(c.anchor=i.source.substring(1))}catch(d){let p=d instanceof Error?d.message:String(d);n(e,"RESOURCE_EXHAUSTION",p)}break;default:{let d=e.type==="error"?e.message:`Unsupported token (type: ${e.type})`;n(e,"UNEXPECTED_TOKEN",d),f=!1}}return c??(c=jn(o,e.offset,void 0,null,t,n)),i&&c.anchor===""&&n(i,"BAD_ALIAS","Anchor cannot be an empty string"),a&&o.options.stringKeys&&(!M(c)||typeof c.value!="string"||c.tag&&c.tag!=="tag:yaml.org,2002:str")&&n(l??e,"NON_STRING_KEY","With stringKeys, all keys must be strings"),r&&(c.spaceBefore=!0),s&&(e.type==="scalar"&&e.source===""?c.comment=s:c.commentBefore=s),o.options.keepSourceTokens&&f&&(c.srcToken=e),c}function jn(o,e,t,n,{spaceBefore:a,comment:r,anchor:s,tag:i,end:l},c){let f={type:"scalar",offset:ns(e,t,n),indent:-1,source:""},d=Xa(o,f,i,c);return s&&(d.anchor=s.source.substring(1),d.anchor===""&&c(s,"BAD_ALIAS","Anchor cannot be an empty string")),a&&(d.spaceBefore=!0),r&&(d.comment=r,d.range[2]=l),d}function ol({options:o},{offset:e,source:t,end:n},a){let r=new de(t.substring(1));r.source===""&&a(e,"BAD_ALIAS","Alias cannot be an empty string"),r.source.endsWith(":")&&a(e+t.length-1,"BAD_ALIAS","Alias ending in : is ambiguous",!0);let s=e+t.length,i=ve(n,s,o.strict,a);return r.range=[e,s,i.offset],i.comment&&(r.comment=i.comment),r}var al,os=C(()=>{bt();B();$r();ts();lt();as();al={composeNode:Za,composeEmptyNode:jn}});function rs(o,e,{offset:t,start:n,value:a,end:r},s){let i=Object.assign({_directives:e},o),l=new he(void 0,i),c={atKey:!1,atRoot:!0,directives:l.directives,options:l.options,schema:l.schema},f=ke(n,{indicator:"doc-start",next:a??r?.[0],offset:t,onError:s,parentIndent:0,startOnNewline:!0});f.found&&(l.directives.docStart=!0,a&&(a.type==="block-map"||a.type==="block-seq")&&!f.hasNewline&&s(f.end,"MISSING_CHAR","Block collection cannot start on same line with directives-end marker")),l.contents=a?Za(c,a,f,s):jn(c,f.end,n,null,f,s);let d=l.contents.range[2],p=ve(r,d,!1,s);return p.comment&&(l.comment=p.comment),l.range=[t,d,p.offset],l}var ss=C(()=>{Rt();os();lt();Ut()});function qt(o){if(typeof o=="number")return[o,o+1];if(Array.isArray(o))return o.length===2?o:[o[0],o[1]];let{offset:e,source:t}=o;return[e,e+(typeof t=="string"?t.length:1)]}function is(o){let e="",t=!1,n=!1;for(let a=0;a<o.length;++a){let r=o[a];switch(r[0]){case"#":e+=(e===""?"":n?`

`:`
`)+(r.substring(1)||" "),t=!0,n=!1;break;case"%":o[a+1]?.[0]!=="#"&&(a+=1),t=!1;break;default:t||(n=!0),t=!1}}return{comment:e,afterEmptyLine:n}}var Ue,Ya=C(()=>{ha();Rt();Pt();B();ss();lt();Ue=class{constructor(e={}){this.doc=null,this.atDirectives=!1,this.prelude=[],this.errors=[],this.warnings=[],this.onError=(t,n,a,r)=>{let s=qt(t);r?this.warnings.push(new Ge(s,n,a)):this.errors.push(new Q(s,n,a))},this.directives=new be({version:e.version||"1.2"}),this.options=e}decorate(e,t){let{comment:n,afterEmptyLine:a}=is(this.prelude);if(n){let r=e.contents;if(t)e.comment=e.comment?`${e.comment}
...
${s}`:n}}if(t){for(let r=0;r<this.errors.length;++r)e.errors.push(this.errors[r]);for(let r=0;r<this.warnings.length;++r)e.warnings.push(this.warnings[r])}else e.errors=this.errors,e.warnings=this.warnings;this.prelude=[],this.errors=[],this.warnings=[]}streamInfo(){return{comment:is(this.prelude).comment,directives:this.directives,errors:this.errors,warnings:this.warnings}}*compose(e,t=!1,n=-1){for(let a of e)yield*this.next(a);yield*this.end(t,n)}*next(e){switch(e.type){case"directive":this.directives.add(e.source,(t,n,a)=>{let r=qt(e);r[0]+=t,this.onError(r,"BAD_DIRECTIVE",n,a)}),this.prelude.push(e.source),this.atDirectives=!0;break;case"document":{let t=rs(this.options,this.directives,e,this.onError);this.atDirectives&&!t.directives.docStart&&this.onError(e,"MISSING_CHAR","Missing directives-end/doc-start indicator line"),this.decorate(t,!1),this.doc&&(yield this.doc),this.doc=t,this.atDirectives=!1;break}case"byte-order-mark":case"space":break;case"comment":case"newline":this.prelude.push(e.source);break;case"error":{let t=e.source?`${e.message}: ${JSON.stringify(e.source)}`:e.message,n=new Q(qt(e),"UNEXPECTED_TOKEN",t);this.atDirectives||!this.doc?this.errors.push(n):this.doc.errors.push(n);break}case"doc-end":{if(!this.doc){let n="Unexpected doc-end without preceding document";this.errors.push(new Q(qt(e),"UNEXPECTED_TOKEN",n));break}this.doc.directives.docEnd=!0;let t=ve(e.end,e.offset+e.source.length,this.doc.options.strict,this.onError);if(this.decorate(this.doc,!0),t.comment){let n=this.doc.comment;this.doc.comment=n?`${n}
${t.comment}`:t.comment}this.doc.range[2]=t.offset;break}default:this.errors.push(new Q(qt(e),"UNEXPECTED_TOKEN",`Unsupported token ${e.type}`))}}*end(e=!1,t=-1){if(this.doc)this.decorate(this.doc,!0),yield this.doc,this.doc=null;else if(e){let n=Object.assign({_directives:this.directives},this.options),a=new he(void 0,n);this.atDirectives&&this.onError(t,"MISSING_CHAR","Missing directives-end indicator line"),a.range=[0,t,t],this.decorate(a,!1),yield a}}}});function ls(o,e=!0,t){if(o){let n=(a,r,s)=>{let i=typeof a=="number"?a:Array.isArray(a)?a[0]:a.offset;if(t)t(i,r,s);else throw new Q([i,i+1],r,s)};switch(o.type){case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":return Hn(o,e,n);case"block-scalar":return qn({options:{strict:e}},o,n)}}return null}function cs(o,e){let{implicitKey:t=!1,indent:n,inFlow:a=!1,offset:r=-1,type:s="PLAIN"}=e,i=Ne({type:s,value:o},{implicitKey:t,indent:n>0?" ".repeat(n):"",inFlow:a,options:{blockQuote:!0,lineWidth:-1}}),l=e.end??[{type:"newline",offset:-1,indent:n,source:`
`}];switch(i[0]){case"|":case">":{let c=i.indexOf(`
`),f=i.substring(0,c),d=i.substring(c+1)+`
`,p=[{type:"block-scalar-header",offset:r,indent:n,source:f}];return fs(p,l)||p.push({type:"newline",offset:-1,indent:n,source:`
`}),{type:"block-scalar",offset:r,indent:n,props:p,source:d}}case'"':return{type:"double-quoted-scalar",offset:r,indent:n,source:i,end:l};case"'":return{type:"single-quoted-scalar",offset:r,indent:n,source:i,end:l};default:return{type:"scalar",offset:r,indent:n,source:i,end:l}}}function ds(o,e,t={}){let{afterKey:n=!1,implicitKey:a=!1,inFlow:r=!1,type:s}=t,i="indent"in o?o.indent:null;if(n&&typeof i=="number"&&(i+=2),!s)switch(o.type){case"single-quoted-scalar":s="QUOTE_SINGLE";break;case"double-quoted-scalar":s="QUOTE_DOUBLE";break;case"block-scalar":{let c=o.props[0];if(c.type!=="block-scalar-header")throw new Error("Invalid block scalar header");s=c.source[0]===">"?"BLOCK_FOLDED":"BLOCK_LITERAL";break}default:s="PLAIN"}let l=Ne({type:s,value:e},{implicitKey:a||i===null,indent:i!==null&&i>0?" ".repeat(i):"",inFlow:r,options:{blockQuote:!0,lineWidth:-1}});switch(l[0]){case"|":case">":rl(o,l);break;case'"':Qa(o,l,"double-quoted-scalar");break;case"'":Qa(o,l,"single-quoted-scalar");break;default:Qa(o,l,"scalar")}}function rl(o,e){let t=e.indexOf(`
`),n=e.substring(0,t),a=e.substring(t+1)+`
`;if(o.type==="block-scalar"){let r=o.props[0];if(r.type!=="block-scalar-header")throw new Error("Invalid block scalar header");r.source=n,o.source=a}else{let{offset:r}=o,s="indent"in o?o.indent:-1,i=[{type:"block-scalar-header",offset:r,indent:s,source:n}];fs(i,"end"in o?o.end:void 0)||i.push({type:"newline",offset:-1,indent:s,source:`
`});for(let l of Object.keys(o))l!=="type"&&l!=="offset"&&delete o[l];Object.assign(o,{type:"block-scalar",indent:s,props:i,source:a})}}function fs(o,e){if(e)for(let t of e)switch(t.type){case"space":case"comment":o.push(t);break;case"newline":return o.push(t),!0}return!1}function Qa(o,e,t){switch(o.type){case"scalar":case"double-quoted-scalar":case"single-quoted-scalar":o.type=t,o.source=e;break;case"block-scalar":{let n=o.props.slice(1),a=e.length;o.props[0].type==="block-scalar-header"&&(a-=o.props[0].source.length);for(let r of n)r.offset+=a;delete o.props,Object.assign(o,{type:t,source:e,end:n});break}case"block-map":case"block-seq":{let a={type:"newline",offset:o.offset+e.length,indent:o.indent,source:`
`};delete o.items,Object.assign(o,{type:t,source:e,end:[a]});break}default:{let n="indent"in o?o.indent:-1,a="end"in o&&Array.isArray(o.end)?o.end.filter(r=>r.type==="space"||r.type==="comment"||r.type==="newline"):[];for(let r of Object.keys(o))r!=="type"&&r!=="offset"&&delete o[r];Object.assign(o,{type:t,indent:n,source:e,end:a})}}}var ps=C(()=>{za();Ja();Pt();Nt()});function Vn(o){switch(o.type){case"block-scalar":{let e="";for(let t of o.props)e+=Vn(t);return e+o.source}case"block-map":case"block-seq":{let e="";for(let t of o.items)e+=_n(t);return e}case"flow-collection":{let e=o.start.source;for(let t of o.items)e+=_n(t);for(let t of o.end)e+=t.source;return e}case"document":{let e=_n(o);if(o.end)for(let t of o.end)e+=t.source;return e}default:{let e=o.source;if("end"in o&&o.end)for(let t of o.end)e+=t.source;return e}}}function _n({start:o,key:e,sep:t,value:n}){let a="";for(let r of o)a+=r.source;if(e&&(a+=Vn(e)),t)for(let r of t)a+=r.source;return n&&(a+=Vn(n)),a}var us,hs=C(()=>{us=o=>"type"in o?Vn(o):_n(o)});function Be(o,e){"type"in o&&o.type==="document"&&(o={start:o.start,value:o.value}),gs(Object.freeze([]),o,e)}function gs(o,e,t){let n=t(e,o);if(typeof n=="symbol")return n;for(let a of["key","value"]){let r=e[a];if(r&&"items"in r){for(let s=0;s<r.items.length;++s){let i=gs(Object.freeze(o.concat([[a,s]])),r.items[s],t);if(typeof i=="number")s=i-1;else{if(i===$a)return $a;i===ms&&(r.items.splice(s,1),s-=1)}}typeof n=="function"&&a==="key"&&(n=n(e,o))}}return typeof n=="function"?n(e,o):n}var $a,sl,ms,ys=C(()=>{$a=Symbol("break visit"),sl=Symbol("skip children"),ms=Symbol("remove item");Be.BREAK=$a;Be.SKIP=sl;Be.REMOVE=ms;Be.itemAtPath=(o,e)=>{let t=o;for(let[n,a]of e){let r=t?.[n];if(r&&"items"in r)t=r.items[a];else return}return t};Be.parentCollection=(o,e)=>{let t=Be.itemAtPath(o,e.slice(0,-1)),n=e[e.length-1][0],a=t?.[n];if(a&&"items"in a)return a;throw new Error("Parent collection not found")}});var Kn={};sa(Kn,{BOM:()=>Ht,DOCUMENT:()=>jt,FLOW_END:()=>_t,SCALAR:()=>ct,createScalarToken:()=>cs,isCollection:()=>il,isScalar:()=>ll,prettyToken:()=>cl,resolveAsScalar:()=>ls,setScalarValue:()=>ds,stringify:()=>us,tokenType:()=>eo,visit:()=>Be});function cl(o){switch(o){case Ht:return"<BOM>";case jt:return"<DOC>";case _t:return"<FLOW_END>";case ct:return"<SCALAR>";default:return JSON.stringify(o)}}function eo(o){switch(o){case Ht:return"byte-order-mark";case jt:return"doc-mode";case _t:return"flow-error-end";case ct:return"scalar";case"---":return"doc-start";case"...":return"doc-end";case"":case`
`:case`\r
`:return"newline";case"-":return"seq-item-ind";case"?":return"explicit-key-ind";case":":return"map-value-ind";case"{":return"flow-map-start";case"}":return"flow-map-end";case"[":return"flow-seq-start";case"]":return"flow-seq-end";case",":return"comma"}switch(o[0]){case" ":case"	":return"space";case"#":return"comment";case"%":return"directive-line";case"*":return"alias";case"&":return"anchor";case"!":return"tag";case"'":return"single-quoted-scalar";case'"':return"double-quoted-scalar";case"|":case">":return"block-scalar-header"}return null}var Ht,jt,_t,ct,il,ll,Gn=C(()=>{ps();hs();ys();Ht="\uFEFF",jt="",_t="",ct="",il=o=>!!o&&"items"in o,ll=o=>!!o&&(o.type==="scalar"||o.type==="single-quoted-scalar"||o.type==="double-quoted-scalar"||o.type==="block-scalar")});function me(o){switch(o){case void 0:case" ":case`
`:case"\r":case"	":return!0;default:return!1}}var bs,dl,Wn,fl,to,We,no=C(()=>{Gn();bs=new Set("0123456789ABCDEFabcdef"),dl=new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),Wn=new Set(",[]{}"),fl=new Set(` ,[]{}
\r	`),to=o=>!o||fl.has(o),We=class{constructor(){this.atEnd=!1,this.blockScalarIndent=-1,this.blockScalarKeep=!1,this.buffer="",this.flowKey=!1,this.flowLevel=0,this.indentNext=0,this.indentValue=0,this.lineEndPos=null,this.next=null,this.pos=0}*lex(e,t=!1){if(e){if(typeof e!="string")throw TypeError("source is not a string");this.buffer=this.buffer?this.buffer+e:e,this.lineEndPos=null}this.atEnd=!t;let n=this.next??"stream";for(;n&&(t||this.hasChars(1));)n=yield*this.parseNext(n)}atLineEnd(){let e=this.pos,t=this.buffer[e];for(;t===" "||t==="	";)t=this.buffer[++e];return!t||t==="#"||t===`
