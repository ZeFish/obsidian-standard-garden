...
`).forEach((r,s)=>{let i=e.createEl("p",{text:r,cls:s===0?"stnd-modal-message":"stnd-modal-detail"})});let t=e.createEl("div",{cls:"stnd-modal-btns"});t.createEl("button",{text:"Cancel",cls:"stnd-modal-btn-cancel"}).addEventListener("click",()=>{this.close(),this.onCancel()}),t.createEl("button",{text:this.confirmText,cls:"mod-cta"}).addEventListener("click",()=>{this.close(),this.onConfirm()})}onClose(){this.contentEl.empty()}};nr.exports={StndConfirmModal:la}});var or=j((fc,ar)=>{"use strict";var gt=require("obsidian"),da=class extends gt.Modal{constructor(e,t){super(e),this.plugin=t}onOpen(){let{contentEl:e}=this;e.addClass("stnd-modal"),e.addClass("stnd-ask-modal"),e.createEl("h2",{text:"\u2728 Ask Hyphe",cls:"stnd-modal-title"}),e.createEl("p",{text:"Ask Hyphe a question about your digital garden. Hyphe runs in the cloud on standard.garden and searches only across your published notes.",cls:"stnd-modal-detail"});let t=e.createEl("div",{cls:"stnd-ask-cloud-notice"});t.setText("\u{1F310} Online AI \xB7 Only searches notes published to standard.garden. Local drafts remain strictly private."),t.style.fontSize="11px",t.style.color="var(--text-muted)",t.style.marginBottom="14px",t.style.display="inline-flex",t.style.alignItems="center",t.style.gap="6px",t.style.padding="4px 8px",t.style.borderRadius="4px",t.style.background="var(--background-secondary)",t.style.border="1px solid var(--background-modifier-border)";let n=e.createEl("textarea",{cls:"stnd-modal-textarea",placeholder:"e.g., What did I learn about permaculture recently?"});n.style.width="100%",n.style.height="100px",n.style.marginBottom="15px",n.style.padding="10px",n.style.borderRadius="4px",n.style.border="1px solid var(--background-modifier-border)",n.style.background="var(--background-primary)",n.style.color="var(--text-normal)";let a=e.createEl("div",{cls:"stnd-modal-result-container"});a.style.display="none",a.style.marginTop="15px",a.style.padding="15px",a.style.borderRadius="4px",a.style.background="var(--background-secondary)",a.style.borderLeft="4px solid var(--interactive-accent)",a.style.maxHeight="300px",a.style.overflowY="auto";let r=a.createEl("div",{cls:"stnd-modal-result-text"});r.style.lineHeight="1.5",r.style.color="var(--text-normal)";let s=e.createEl("div",{cls:"stnd-modal-btns"});s.createEl("button",{text:"Close",cls:"stnd-modal-btn-cancel"}).addEventListener("click",()=>{this.close()});let l=s.createEl("button",{text:"Ask Hyphe",cls:"mod-cta"}),c=e.createEl("div",{cls:"stnd-ask-horizon"});c.setAttribute("aria-hidden","true"),c.innerHTML=`
    ...
    `;let f=async(d,p="garden")=>{let u=this.plugin.settings.apiKey;if(!u){new gt.Notice("Please connect your standard.garden account in Settings first."),a.style.display="block",r.empty(),r.style.fontStyle="normal",r.setText("Please connect your standard.garden account in Settings first to query Hyphe.");return}a.querySelectorAll(".stnd-modal-mycelium-prompt").forEach(m=>m.remove()),l.disabled=!0,n.disabled=!0,l.text=p==="mycelium"?"Searching Mycelium...":"Hyphe is searching...",a.style.display="block",r.empty(),r.setText(p==="mycelium"?"Hyphe is exploring the public Mycelium and weaving an answer...":"Hyphe is searching your published notes and generating an answer..."),r.style.fontStyle="italic";try{let m=await gt.requestUrl({url:`${this.plugin.settings.apiUrl}/ai/ask`,method:"POST",headers:{"Content-Type":"application/json","x-api-key":u},body:JSON.stringify({question:d,scope:p}),throw:!1});if(m.status<200||m.status>=300){let g=m.text;try{let b=JSON.parse(m.text||"{}");b.error&&(g=b.error)}catch{}throw new Error(g||`Server error (${m.status})`)}let h=m.json;if(r.style.fontStyle="normal",h.answer){if(r.empty(),await gt.MarkdownRenderer.renderMarkdown(h.answer,r,"",this),r.querySelectorAll("a").forEach(g=>{g.addEventListener("click",b=>{let y=g.getAttribute("href");if(y&&y.startsWith("/")){b.preventDefault();let k=y.replace(/^\/+|\/+$/g,""),S=this.plugin.garden?.bySlug?.get(k)||this.plugin.garden?.byTitleSlug?.get(k)||this.plugin.garden?.byBasenameSlug?.get(k);S?(this.app.workspace.getLeaf(!1).openFile(S),this.close()):this.plugin.settings.apiUsername&&window.open(`https://standard.garden${y}`,"_blank")}})}),h.mycelium_hints?.count>0&&h.scope!=="mycelium"){let g=h.mycelium_hints.count,b=h.mycelium_hints.authors?.length?` (${h.mycelium_hints.authors.join(", ")})`:"",y=a.createEl("div",{cls:"stnd-modal-mycelium-prompt"});y.style.marginTop="14px",y.style.paddingTop="10px",y.style.borderTop="1px dashed var(--background-modifier-border)",y.style.display="flex",y.style.alignItems="center",y.style.justifyContent="space-between",y.style.gap="8px";let k=y.createEl("span",{text:`\u{1F344} Le Myc\xE9lium public a ${g} note${g>1?"s":""} connexe${g>1?"s":""}${b}`});k.style.fontSize="11px",k.style.color="var(--text-muted)";let S=y.createEl("button",{cls:"mod-cta",text:"Explorer le Myc\xE9lium \u2192"});S.style.fontSize="11px",S.style.padding="3px 8px",S.style.cursor="pointer",S.addEventListener("click",()=>{f(d,"mycelium")})}}else r.setText("No response was returned by Hyphe.")}catch(m){r.style.fontStyle="normal",r.setText(`Error: ${m.message}`),console.error("Error during Hyphe query:",m)}finally{l.disabled=!1,n.disabled=!1,l.text="Ask Hyphe"}};l.addEventListener("click",()=>{let d=n.value.trim();if(!d){new gt.Notice("Please enter a question.");return}f(d,"garden")})}onClose(){this.contentEl.empty()}};ar.exports={StndAskModal:da}});var pa=j((pc,rr)=>{"use strict";var Ti=require("obsidian"),fa=class extends Ti.Modal{constructor(e,t,n){super(e),this.noteTitle=t,this.liveUrl=n}onOpen(){let{contentEl:e}=this;e.addClass("stnd-modal"),e.style.cssText="max-width: 480px; padding: 20px;";let t=e.createEl("h3",{text:"Share Note"});t.style.cssText="margin-bottom: 16px; font-size: var(--font-ui-medium); font-weight: var(--font-semibold);";let n=(l,c)=>{let f=e.createEl("div");f.style.cssText="margin-bottom: 16px;";let d=f.createEl("div");d.style.cssText="display: flex; align-items: center; justify-content: space-between; margin-bottom: 6px;",d.createEl("span",{text:l,cls:"stnd-panel-meta"});let p=f.createEl("div");p.style.cssText="display: flex; gap: 8px; align-items: center;";let u=p.createEl("input",{cls:"stnd-panel-input",type:"text",value:c});u.readOnly=!0,u.style.cssText="flex: 1; width: 100%; text-align: left; font-size: var(--font-ui-smaller); font-family: var(--font-monospace);";let m=p.createEl("button",{text:"Copy",cls:"stnd-panel-btn stnd-panel-btn-secondary"});m.style.cssText="flex-shrink: 0; font-size: var(--font-ui-smaller);",m.addEventListener("click",()=>{navigator.clipboard.writeText(c),m.setText("Copied!"),setTimeout(()=>m.setText("Copy"),1500)})};n("Direct URL",this.liveUrl);let a=`[${this.noteTitle}](${this.liveUrl})`;n("Markdown Link",a);let r=`<iframe src="${this.liveUrl}" width="100%" height="600" frameborder="0"></iframe>`;n("Embed Iframe",r);let s=e.createEl("div");s.style.cssText="display: flex; justify-content: flex-end; margin-top: 12px;",s.createEl("button",{text:"Close",cls:"stnd-panel-btn"}).addEventListener("click",()=>this.close())}onClose(){this.contentEl.empty()}};rr.exports={StndShareModal:fa}});function q(o){if(o&&typeof o=="object")switch(o[Z]){case ce:case xe:return!0}return!1}function I(o){if(o&&typeof o=="object")switch(o[Z]){case tn:case ce:case ee:case xe:return!0}return!1}var tn,nn,ce,ua,ee,xe,Z,te,ne,ae,R,D,oe,an,B=T(()=>{tn=Symbol.for("yaml.alias"),nn=Symbol.for("yaml.document"),ce=Symbol.for("yaml.map"),ua=Symbol.for("yaml.pair"),ee=Symbol.for("yaml.scalar"),xe=Symbol.for("yaml.seq"),Z=Symbol.for("yaml.node.type"),te=o=>!!o&&typeof o=="object"&&o[Z]===tn,ne=o=>!!o&&typeof o=="object"&&o[Z]===nn,ae=o=>!!o&&typeof o=="object"&&o[Z]===ce,R=o=>!!o&&typeof o=="object"&&o[Z]===ua,D=o=>!!o&&typeof o=="object"&&o[Z]===ee,oe=o=>!!o&&typeof o=="object"&&o[Z]===xe;an=o=>(D(o)||q(o))&&!!o.anchor});function re(o,e){let t=ir(e);ne(o)?Je(null,o.contents,t,Object.freeze([o]))===ye&&(o.contents=null):Je(null,o,t,Object.freeze([]))}function Je(o,e,t,n){let a=lr(o,e,t,n);if(I(a)||R(a))return cr(o,n,a),Je(o,a,t,n);if(typeof a!="symbol"){if(q(e)){n=Object.freeze(n.concat(e));for(let r=0;r<e.items.length;++r){let s=Je(r,e.items[r],t,n);if(typeof s=="number")r=s-1;else{if(s===Y)return Y;s===ye&&(e.items.splice(r,1),r-=1)}}}else if(R(e)){n=Object.freeze(n.concat(e));let r=Je("key",e.key,t,n);if(r===Y)return Y;r===ye&&(e.key=null);let s=Je("value",e.value,t,n);if(s===Y)return Y;s===ye&&(e.value=null)}}return a}async function Ze(o,e){let t=ir(e);ne(o)?await Xe(null,o.contents,t,Object.freeze([o]))===ye&&(o.contents=null):await Xe(null,o,t,Object.freeze([]))}async function Xe(o,e,t,n){let a=await lr(o,e,t,n);if(I(a)||R(a))return cr(o,n,a),Xe(o,a,t,n);if(typeof a!="symbol"){if(q(e)){n=Object.freeze(n.concat(e));for(let r=0;r<e.items.length;++r){let s=await Xe(r,e.items[r],t,n);if(typeof s=="number")r=s-1;else{if(s===Y)return Y;s===ye&&(e.items.splice(r,1),r-=1)}}}else if(R(e)){n=Object.freeze(n.concat(e));let r=await Xe("key",e.key,t,n);if(r===Y)return Y;r===ye&&(e.key=null);let s=await Xe("value",e.value,t,n);if(s===Y)return Y;s===ye&&(e.value=null)}}return a}function ir(o){return typeof o=="object"&&(o.Collection||o.Node||o.Value)?Object.assign({Alias:o.Node,Map:o.Node,Scalar:o.Node,Seq:o.Node},o.Value&&{Map:o.Value,Scalar:o.Value,Seq:o.Value},o.Collection&&{Map:o.Collection,Seq:o.Collection},o):o}function lr(o,e,t,n){if(typeof t=="function")return t(o,e,n);if(ae(e))return t.Map?.(o,e,n);if(oe(e))return t.Seq?.(o,e,n);if(R(e))return t.Pair?.(o,e,n);if(D(e))return t.Scalar?.(o,e,n);if(te(e))return t.Alias?.(o,e,n)}function cr(o,e,t){let n=e[e.length-1];if(q(n))n.items[o]=t;else if(R(n))o==="key"?n.key=t:n.value=t;else if(ne(n))n.contents=t;else{let a=te(n)?"alias":"scalar";throw new Error(`Cannot replace node with ${a} parent`)}}var Y,sr,ye,yt=T(()=>{B();Y=Symbol("break visit"),sr=Symbol("skip children"),ye=Symbol("remove node");re.BREAK=Y;re.SKIP=sr;re.REMOVE=ye;Ze.BREAK=Y;Ze.SKIP=sr;Ze.REMOVE=ye});var Ni,Ci,be,ha=T(()=>{B();yt();Ni={"!":"%21",",":"%2C","[":"%5B","]":"%5D","{":"%7B","}":"%7D"},Ci=o=>o.replace(/[!,[\]{}]/g,e=>Ni[e]),be=class o{constructor(e,t){this.docStart=null,this.docEnd=!1,this.yaml=Object.assign({},o.defaultYaml,e),this.tags=Object.assign({},o.defaultTags,t)}clone(){let e=new o(this.yaml,this.tags);return e.docStart=this.docStart,e}atDocument(){let e=new o(this.yaml,this.tags);switch(this.yaml.version){case"1.1":this.atNextDocument=!0;break;case"1.2":this.atNextDocument=!1,this.yaml={explicit:o.defaultYaml.explicit,version:"1.2"},this.tags=Object.assign({},o.defaultTags);break}return e}add(e,t){this.atNextDocument&&(this.yaml={explicit:o.defaultYaml.explicit,version:"1.1"},this.tags=Object.assign({},o.defaultTags),this.atNextDocument=!1);let n=e.trim().split(/[ \t]+/),a=n.shift();switch(a){case"%TAG":{if(n.length!==2&&(t(0,"%TAG directive should contain exactly two parts"),n.length<2))return!1;let[r,s]=n;return this.tags[r]=s,!0}case"%YAML":{if(this.yaml.explicit=!0,n.length!==1)return t(0,"%YAML directive should contain exactly one part"),!1;let[r]=n;if(r==="1.1"||r==="1.2")return this.yaml.version=r,!0;{let s=/^\d+\.\d+$/.test(r);return t(6,`Unsupported YAML version ${r}`,s),!1}}default:return t(0,`Unknown directive ${a}`,!0),!1}}tagName(e,t){if(e==="!")return"!";if(e[0]!=="!")return t(`Not a valid tag: ${e}`),null;if(e[1]==="<"){let s=e.slice(2,-1);return s==="!"||s==="!!"?(t(`Verbatim tags aren't resolved, so ${e} is invalid.`),null):(e[e.length-1]!==">"&&t("Verbatim tags must end with a >"),s)}let[,n,a]=e.match(/^(.*!)([^!]*)$/s);a||t(`The ${e} tag has no suffix`);let r=this.tags[n];if(r)try{return r+decodeURIComponent(a)}catch(s){return t(String(s)),null}return n==="!"?e:(t(`Could not resolve tag: ${e}`),null)}tagString(e){for(let[t,n]of Object.entries(this.tags))if(e.startsWith(n))return t+Ci(e.substring(n.length));return e[0]==="!"?e:`!<${e}>`}toString(e){let t=this.yaml.explicit?[`%YAML ${this.yaml.version||"1.2"}`]:[],n=Object.entries(this.tags),a;if(e&&n.length>0&&I(e.contents)){let r={};re(e.contents,(s,i)=>{I(i)&&i.tag&&(r[i.tag]=!0)}),a=Object.keys(r)}else a=[];for(let[r,s]of n)r==="!!"&&s==="tag:yaml.org,2002:"||(!e||a.some(i=>i.startsWith(s)))&&t.push(`%TAG ${r} ${s}`);return t.join(`
`)}};be.defaultYaml={explicit:!1,version:"1.2"};be.defaultTags={"!!":"tag:yaml.org,2002:"}});function on(o){if(/[\x00-\x19\s,[\]{}]/.test(o)){let t=`Anchor must not contain whitespace or control characters: ${JSON.stringify(o)}`;throw new Error(t)}return!0}function ma(o){let e=new Set;return re(o,{Value(t,n){n.anchor&&e.add(n.anchor)}}),e}function ga(o,e){for(let t=1;;++t){let n=`${o}${t}`;if(!e.has(n))return n}}function dr(o,e){let t=[],n=new Map,a=null;return{onAnchor:r=>{t.push(r),a??(a=ma(o));let s=ga(e,a);return a.add(s),s},setAnchors:()=>{for(let r of t){let s=n.get(r);if(typeof s=="object"&&s.anchor&&(D(s.node)||q(s.node)))s.node.anchor=s.anchor;else{let i=new Error("Failed to resolve repeated object (this should not happen)");throw i.source=r,i}}},sourceObjects:n}}var rn=T(()=>{B();yt()});function Fe(o,e,t,n){if(n&&typeof n=="object")if(Array.isArray(n))for(let a=0,r=n.length;a<r;++a){let s=n[a],i=Fe(o,n,String(a),s);i===void 0?delete n[a]:i!==s&&(n[a]=i)}else if(n instanceof Map)for(let a of Array.from(n.keys())){let r=n.get(a),s=Fe(o,n,a,r);s===void 0?n.delete(a):s!==r&&n.set(a,s)}else if(n instanceof Set)for(let a of Array.from(n)){let r=Fe(o,n,a,a);r===void 0?n.delete(a):r!==a&&(n.delete(a),n.add(r))}else for(let[a,r]of Object.entries(n)){let s=Fe(o,n,a,r);s===void 0?delete n[a]:s!==r&&(n[a]=s)}return o.call(e,t,n)}var ya=T(()=>{});function W(o,e,t){if(Array.isArray(o))return o.map((n,a)=>W(n,String(a),t));if(o&&typeof o.toJSON=="function"){if(!t||!an(o))return o.toJSON(e,t);let n={aliasCount:0,count:1,res:void 0};t.anchors.set(o,n),t.onCreate=r=>{n.res=r,delete t.onCreate};let a=o.toJSON(e,t);return t.onCreate&&t.onCreate(a),a}return typeof o=="bigint"&&!t?.keep?Number(o):o}var Le=T(()=>{B()});var De,sn=T(()=>{ya();B();Le();De=class{constructor(e){Object.defineProperty(this,Z,{value:e})}clone(){let e=Object.create(Object.getPrototypeOf(this),Object.getOwnPropertyDescriptors(this));return this.range&&(e.range=this.range.slice()),e}toJS(e,{mapAsMap:t,maxAliasCount:n,onAnchor:a,reviver:r}={}){if(!ne(e))throw new TypeError("A document argument is required");let s={anchors:new Map,doc:e,keep:!0,mapAsMap:t===!0,mapKeyWarned:!1,maxAliasCount:typeof n=="number"?n:100},i=W(this,"",s);if(typeof a=="function")for(let{count:l,res:c}of s.anchors.values())a(c,l);return typeof r=="function"?Fe(r,{"":i},"",i):i}}});function ln(o,e,t){if(te(e)){let n=e.resolve(o),a=t&&n&&t.get(n);return a?a.count*a.aliasCount:0}else if(q(e)){let n=0;for(let a of e.items){let r=ln(o,a,t);r>n&&(n=r)}return n}else if(R(e)){let n=ln(o,e.key,t),a=ln(o,e.value,t);return Math.max(n,a)}return 1}var de,bt=T(()=>{rn();yt();B();sn();Le();de=class extends De{constructor(e){super(tn),this.source=e,Object.defineProperty(this,"tag",{set(){throw new Error("Alias nodes cannot have tags")}})}resolve(e,t){if(t?.maxAliasCount===0)throw new ReferenceError("Alias resolution is disabled");let n;t?.aliasResolveCache?n=t.aliasResolveCache:(n=[],re(e,{Node:(r,s)=>{(te(s)||an(s))&&n.push(s)}}),t&&(t.aliasResolveCache=n));let a;for(let r of n){if(r===this)break;r.anchor===this.source&&(a=r)}return a}toJSON(e,t){if(!t)return{source:this.source};let{anchors:n,doc:a,maxAliasCount:r}=t,s=this.resolve(a,t);if(!s){let l=`Unresolved alias (the anchor must be set before the alias): ${this.source}`;throw new ReferenceError(l)}let i=n.get(s);if(i||(W(s,null,t),i=n.get(s)),i?.res===void 0){let l="This should not happen: Alias anchor was not resolved?";throw new ReferenceError(l)}if(r>=0&&(i.count+=1,i.aliasCount===0&&(i.aliasCount=ln(a,s,n)),i.count*i.aliasCount>r)){let l="Excessive alias count indicates a resource exhaustion attack";throw new ReferenceError(l)}return i.res}toString(e,t,n){let a=`*${this.source}`;if(e){if(on(this.source),e.options.verifyAliasOrder&&!e.anchors.has(this.source)){let r=`Unresolved alias (the anchor must be set before the alias): ${this.source}`;throw new Error(r)}if(e.implicitKey)return`${a} `}return a}}});var cn,C,K=T(()=>{B();sn();Le();cn=o=>!o||typeof o!="function"&&typeof o!="object",C=class extends De{constructor(e){super(ee),this.value=e}toJSON(e,t){return t?.keep?this.value:W(this.value,e,t)}toString(){return String(this.value)}};C.BLOCK_FOLDED="BLOCK_FOLDED";C.BLOCK_LITERAL="BLOCK_LITERAL";C.PLAIN="PLAIN";C.QUOTE_DOUBLE="QUOTE_DOUBLE";C.QUOTE_SINGLE="QUOTE_SINGLE"});function Fi(o,e,t){if(e){let n=t.filter(r=>r.tag===e),a=n.find(r=>!r.format)??n[0];if(!a)throw new Error(`Tag ${e} not found`);return a}return t.find(n=>n.identify?.(o)&&!n.format)}function Te(o,e,t){if(ne(o)&&(o=o.contents),I(o))return o;if(R(o)){let d=t.schema[ce].createNode?.(t.schema,null,t);return d.items.push(o),d}(o instanceof String||o instanceof Number||o instanceof Boolean||typeof BigInt<"u"&&o instanceof BigInt)&&(o=o.valueOf());let{aliasDuplicateObjects:n,onAnchor:a,onTagObj:r,schema:s,sourceObjects:i}=t,l;if(n&&o&&typeof o=="object"){if(l=i.get(o),l)return l.anchor??(l.anchor=a(o)),new de(l.anchor);l={anchor:null,node:null},i.set(o,l)}e?.startsWith("!!")&&(e=Ei+e.slice(2));let c=Fi(o,e,s.tags);if(!c){if(o&&typeof o.toJSON=="function"&&(o=o.toJSON()),!o||typeof o!="object"){let d=new C(o);return l&&(l.node=d),d}c=o instanceof Map?s[ce]:Symbol.iterator in Object(o)?s[xe]:s[ce]}r&&(r(c),delete t.onTagObj);let f=c?.createNode?c.createNode(t.schema,o,t):typeof c?.nodeClass?.from=="function"?c.nodeClass.from(t.schema,o,t):new C(o);return e?f.tag=e:c.default||(f.tag=c.tag),l&&(l.node=f),f}var Ei,wt=T(()=>{bt();B();K();Ei="tag:yaml.org,2002:"});function kt(o,e,t){let n=t;for(let a=e.length-1;a>=0;--a){let r=e[a];if(typeof r=="number"&&Number.isInteger(r)&&r>=0){let s=[];s[r]=n,n=s}else n=new Map([[r,n]])}return Te(n,void 0,{aliasDuplicateObjects:!1,keepUndefined:!1,onAnchor:()=>{throw new Error("This should not happen, please report a bug.")},schema:o,sourceObjects:new Map})}var Qe,Ye,dn=T(()=>{wt();B();sn();Qe=o=>o==null||typeof o=="object"&&!!o[Symbol.iterator]().next().done,Ye=class extends De{constructor(e,t){super(e),Object.defineProperty(this,"schema",{value:t,configurable:!0,enumerable:!1,writable:!0})}clone(e){let t=Object.create(Object.getPrototypeOf(this),Object.getOwnPropertyDescriptors(this));return e&&(t.schema=e),t.items=t.items.map(n=>I(n)||R(n)?n.clone(e):n),this.range&&(t.range=this.range.slice()),t}addIn(e,t){if(Qe(e))this.add(t);else{let[n,...a]=e,r=this.get(n,!0);if(q(r))r.addIn(a,t);else if(r===void 0&&this.schema)this.set(n,kt(this.schema,a,t));else throw new Error(`Expected YAML collection at ${n}. Remaining path: ${a}`)}}deleteIn(e){let[t,...n]=e;if(n.length===0)return this.delete(t);let a=this.get(t,!0);if(q(a))return a.deleteIn(n);throw new Error(`Expected YAML collection at ${t}. Remaining path: ${n}`)}getIn(e,t){let[n,...a]=e,r=this.get(n,!0);return a.length===0?!t&&D(r)?r.value:r:q(r)?r.getIn(a,t):void 0}hasAllNullValues(e){return this.items.every(t=>{if(!R(t))return!1;let n=t.value;return n==null||e&&D(n)&&n.value==null&&!n.commentBefore&&!n.comment&&!n.tag})}hasIn(e){let[t,...n]=e;if(n.length===0)return this.has(t);let a=this.get(t,!0);return q(a)?a.hasIn(n):!1}setIn(e,t){let[n,...a]=e;if(a.length===0)this.set(n,t);else{let r=this.get(n,!0);if(q(r))r.setIn(a,t);else if(r===void 0&&this.schema)this.set(n,kt(this.schema,a,t));else throw new Error(`Expected YAML collection at ${n}. Remaining path: ${a}`)}}}});function se(o,e){return/^\n+$/.test(o)?o.substring(1):e?o.replace(/^(?! *$)/gm,e):o}var fr,we,vt=T(()=>{fr=o=>o.replace(/^(?!$)(?: $)?/gm,"#");we=(o,e,t)=>o.endsWith(`
`)?se(t,e):t.includes(`
`)?`
`+se(t,e):(o.endsWith(" ")?"":" ")+t});function xt(o,e,t="flow",{indentAtStart:n,lineWidth:a=80,minContentWidth:r=20,onFold:s,onOverflow:i}={}){if(!a||a<0)return o;a<r&&(r=0);let l=Math.max(1+r,1+a-e.length);if(o.length<=l)return o;let c=[],f={},d=a-e.length;typeof n=="number"&&(n>a-Math.max(2,r)?c.push(0):d=a-n);let p,u,m=!1,h=-1,g=-1,b=-1;t===fn&&(h=pr(o,h,e.length),h!==-1&&(d=h+l));for(let k;k=o[h+=1];){if(t===St&&k==="\\"){switch(g=h,o[h+1]){case"x":h+=3;break;case"u":h+=5;break;case"U":h+=9;break;default:h+=1}b=h}if(k===`
`)t===fn&&(h=pr(o,h,e.length)),d=h+e.length+l,p=void 0;else{if(k===" "&&u&&u!==" "&&u!==`
`&&u!=="	"){let S=o[h+1];S&&S!==" "&&S!==`
`&&S!=="	"&&(p=h)}if(h>=d)if(p)c.push(p),d=p+l,p=void 0;else if(t===St){for(;u===" "||u==="	";)u=k,k=o[h+=1],m=!0;let S=h>b+1?h-2:g-1;if(f[S])return o;c.push(S),f[S]=!0,d=S+l,p=void 0}else m=!0}u=k}if(m&&i&&i(),c.length===0)return o;s&&s();let y=o.slice(0,c[0]);for(let k=0;k<c.length;++k){let S=c[k],N=c[k+1]||o.length;S===0?y=`
${e}${o.slice(0,N)}`:(t===St&&f[S]&&(y+=`${o[S]}\\`),y+=`
${e}${o.slice(S+1,N)}`)}return y}function pr(o,e,t){let n=e,a=e+1,r=o[a];for(;r===" "||r==="	";)if(e<a+t)r=o[++e];else{do r=o[++e];while(r&&r!==`
`);n=e,a=e+1,r=o[a]}return n}var ba,fn,St,ur=T(()=>{ba="flow",fn="block",St="quoted"});function Li(o,e,t){if(!e||e<0)return!1;let n=e-t,a=o.length;if(a<=n)return!1;for(let r=0,s=0;r<a;++r)if(o[r]===`
...
${t}`)+"'";return e.implicitKey?n:xt(n,t,ba,un(e,!1))}function $e(o,e){let{singleQuote:t}=e.options,n;if(t===!1)n=Tt;else{let a=o.includes('"'),r=o.includes("'");a&&!r?n=wa:r&&!a?n=Tt:n=t?wa:Tt}return n(o,e)}function pn({comment:o,type:e,value:t},n,a,r){let{blockQuote:s,commentString:i,lineWidth:l}=n.options;if(!s||/\n[\t ]+$/.test(t))return $e(t,n);let c=n.indent||(n.forceBlockIndent||hn(t)?"  ":""),f=s==="literal"?!0:s==="folded"||e===C.BLOCK_FOLDED?!1:e===C.BLOCK_LITERAL?!0:!Li(t,l,c.length);if(!t)return f?`|
`:`>
`;let d,p;for(p=t.length;p>0;--p){let N=t[p-1];if(N!==`
`&&N!=="	"&&N!==" ")break}let u=t.substring(p),m=u.indexOf(`
`);m===-1?d="-":t===u||m!==u.length-1?(d="+",r&&r()):d="",u&&(t=t.slice(0,-u.length),u[u.length-1]===`
`&&(u=u.slice(0,-1)),u=u.replace(ka,`$&${c}`));let h=!1,g,b=-1;for(g=0;g<t.length;++g){let N=t[g];if(N===" ")h=!0;else if(N===`
`)b=g;else break}let y=t.substring(0,b<g?b+1:g);y&&(t=t.substring(y.length),y=y.replace(/\n+/g,`$&${c}`));let S=(h?c?"2":"1":"")+d;if(o&&(S+=" "+i(o.replace(/ ?[\r\n]+/g," ")),a&&a()),!f){let N=t.replace(/\n+/g,`
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${c}`),x=!1,L=un(n,!0);s!=="folded"&&e!==C.BLOCK_FOLDED&&(L.onOverflow=()=>{x=!0});let w=xt(`${y}${N}${u}`,c,fn,L);if(!x)return`>${S}
${c}${w}`}return t=t.replace(/\n+/g,`$&${c}`),`|${S}
${c}${y}${t}${u}`}function Di(o,e,t,n){let{type:a,value:r}=o,{actualString:s,implicitKey:i,indent:l,indentStep:c,inFlow:f}=e;if(i&&r.includes(`
`)||f&&/[[\]{},]/.test(r))return $e(r,e);if(/^[\n\t ,[\]{}#&*!|>'"%@`]|^[?-]$|^[?-][ \t]|[\n:][ \t]|[ \t]\n|[\n\t ]#|[\n\t :]$/.test(r))return i||f||!r.includes(`
`)?$e(r,e):pn(o,e,t,n);if(!i&&!f&&a!==C.PLAIN&&r.includes(`
`))return pn(o,e,t,n);if(hn(r)){if(l==="")return e.forceBlockIndent=!0,pn(o,e,t,n);if(i&&l===c)return $e(r,e)}let d=r.replace(/\n+/g,`$&
${l}`);if(s){let p=h=>h.default&&h.tag!=="tag:yaml.org,2002:str"&&h.test?.test(d),{compat:u,tags:m}=e.doc.schema;if(m.some(p)||u?.some(p))return $e(r,e)}return i?d:xt(d,l,ba,un(e,!1))}function Ne(o,e,t,n){let{implicitKey:a,inFlow:r}=e,s=typeof o.value=="string"?o:Object.assign({},o,{value:String(o.value)}),{type:i}=o;i!==C.QUOTE_DOUBLE&&/[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(s.value)&&(i=C.QUOTE_DOUBLE);let l=f=>{switch(f){case C.BLOCK_FOLDED:case C.BLOCK_LITERAL:return a||r?$e(s.value,e):pn(s,e,t,n);case C.QUOTE_DOUBLE:return Tt(s.value,e);case C.QUOTE_SINGLE:return wa(s.value,e);case C.PLAIN:return Di(s,e,t,n);default:return null}},c=l(i);if(c===null){let{defaultKeyType:f,defaultStringType:d}=e.options,p=a&&f||d;if(c=l(p),c===null)throw new Error(`Unsupported default string type ${p}`)}return c}var un,hn,ka,Nt=T(()=>{K();ur();un=(o,e)=>({indentAtStart:e?o.indent.length:o.indentAtStart,lineWidth:o.options.lineWidth,minContentWidth:o.options.minContentWidth}),hn=o=>/^(%|---|\.\.\.)/m.test(o);try{ka=new RegExp(`(^|(?<!
))
+(?!
|$)`,"g")}catch{ka=/\n+(?!\n|$)/g}});function mn(o,e){let t=Object.assign({blockQuote:!0,commentString:fr,defaultKeyType:null,defaultStringType:"PLAIN",directives:null,doubleQuotedAsJSON:!1,doubleQuotedMinMultiLineLength:40,falseStr:"false",flowCollectionPadding:!0,indentSeq:!0,lineWidth:80,minContentWidth:20,nullStr:"null",simpleKeys:!1,singleQuote:null,trailingComma:!1,trueStr:"true",verifyAliasOrder:!0},o.schema.toStringOptions,e),n;switch(t.collectionStyle){case"block":n=!1;break;case"flow":n=!0;break;default:n=null}return{anchors:new Set,doc:o,flowCollectionPadding:t.flowCollectionPadding?" ":"",indent:"",indentStep:typeof t.indent=="number"?" ".repeat(t.indent):"  ",inFlow:n,options:t}}function Ai(o,e){if(e.tag){let a=o.filter(r=>r.tag===e.tag);if(a.length>0)return a.find(r=>r.format===e.format)??a[0]}let t,n;if(D(e)){n=e.value;let a=o.filter(r=>r.identify?.(n));if(a.length>1){let r=a.filter(s=>s.test);r.length>0&&(a=r)}t=a.find(r=>r.format===e.format)??a.find(r=>!r.format)}else n=e,t=o.find(a=>a.nodeClass&&n instanceof a.nodeClass);if(!t){let a=n?.constructor?.name??(n===null?"null":typeof n);throw new Error(`Tag not resolved for ${a} value`)}return t}function Mi(o,e,{anchors:t,doc:n}){if(!n.directives)return"";let a=[],r=(D(o)||q(o))&&o.anchor;r&&on(r)&&(t.add(r),a.push(`&${r}`));let s=o.tag??(e.default?null:e.tag);return s&&a.push(n.directives.tagString(s)),a.join(" ")}function Ce(o,e,t,n){if(R(o))return o.toString(e,t,n);if(te(o)){if(e.doc.directives)return o.toString(e);if(e.resolvedAliases?.has(o))throw new TypeError("Cannot stringify circular structure without alias nodes");e.resolvedAliases?e.resolvedAliases.add(o):e.resolvedAliases=new Set([o]),o=o.resolve(e.doc)}let a,r=I(o)?o:e.doc.createNode(o,{onTagObj:l=>a=l});a??(a=Ai(e.doc.schema.tags,r));let s=Mi(r,a,e);s.length>0&&(e.indentAtStart=(e.indentAtStart??0)+s.length+1);let i=typeof a.stringify=="function"?a.stringify(r,e,t,n):D(r)?Ne(r,e,t,n):r.toString(e,t,n);return s?D(r)||i[0]==="{"||i[0]==="["?`${s} ${i}`:`${s}
${e.indent}${i}`:i}var Ct=T(()=>{rn();B();vt();Nt()});function hr({key:o,value:e},t,n,a){let{allNullValues:r,doc:s,indent:i,indentStep:l,options:{commentString:c,indentSeq:f,simpleKeys:d}}=t,p=I(o)&&o.comment||null;if(d){if(p)throw new Error("With simple keys, key nodes cannot have comments");if(q(o)||!I(o)&&typeof o=="object"){let L="With simple keys, collection cannot be used as a key value";throw new Error(L)}}let u=!d&&(!o||p&&e==null&&!t.inFlow||q(o)||(D(o)?o.type===C.BLOCK_FOLDED||o.type===C.BLOCK_LITERAL:typeof o=="object"));t=Object.assign({},t,{allNullValues:!1,implicitKey:!u&&(d||!r),indent:i+l});let m=!1,h=!1,g=Ce(o,t,()=>m=!0,()=>h=!0);if(!u&&!t.inFlow&&g.length>1024){if(d)throw new Error("With simple keys, single line scalar must not span more than 1024 characters");u=!0}if(t.inFlow){if(r||e==null)return m&&n&&n(),g===""?"?":u?`? ${g}`:g}else if(r&&!d||e==null&&u)return g=`? ${g}`,p&&!m?g+=we(g,t.indent,c(p)):h&&a&&a(),g;m&&(p=null),u?(p&&(g+=we(g,t.indent,c(p))),g=`? ${g}
${i}:`):(g=`${g}:`,p&&(g+=we(g,t.indent,c(p))));let b,y,k;I(e)?(b=!!e.spaceBefore,y=e.commentBefore,k=e.comment):(b=!1,y=null,k=null,e&&typeof e=="object"&&(e=s.createNode(e))),t.implicitKey=!1,!u&&!p&&D(e)&&(t.indentAtStart=g.length+1),h=!1,!f&&l.length>=2&&!t.inFlow&&!u&&oe(e)&&!e.flow&&!e.tag&&!e.anchor&&(t.indent=t.indent.substring(2));let S=!1,N=Ce(e,t,()=>S=!0,()=>h=!0),x=" ";if(p||b||y){if(x=b?`
`:"",y){let L=c(y);x+=`
${se(L,t.indent)}`}N===""&&!t.inFlow?x===`
`&&k&&(x=`

`):x+=`
${t.indent}`}else if(!u&&q(e)){let L=N[0],w=N.indexOf(`
`),v=w!==-1,E=t.inFlow??e.flow??e.items.length===0;if(v||!E){let M=!1;if(v&&(L==="&"||L==="!")){let F=N.indexOf(" ");L==="&"&&F!==-1&&F<w&&N[F+1]==="!"&&(F=N.indexOf(" ",F+1)),(F===-1||w<F)&&(M=!0)}M||(x=`
${t.indent}`)}}else(N===""||N[0]===`
`)&&(x="");return g+=x+N,t.inFlow?S&&n&&n():k&&!S?g+=we(g,t.indent,c(k)):h&&a&&a(),g}var mr=T(()=>{B();K();Ct();vt()});function gn(o,e){(o==="debug"||o==="warn")&&console.warn(e)}var va=T(()=>{});function xa(o,e,t){let n=yr(o,t);if(oe(n))for(let a of n.items)Sa(o,e,a);else if(Array.isArray(n))for(let a of n)Sa(o,e,a);else Sa(o,e,n)}function Sa(o,e,t){let n=yr(o,t);if(!ae(n))throw new Error("Merge sources must be maps or map aliases");let a=n.toJSON(null,o,Map);for(let[r,s]of a)e instanceof Map?e.has(r)||e.set(r,s):e instanceof Set?e.add(r):Object.prototype.hasOwnProperty.call(e,r)||Object.defineProperty(e,r,{value:s,writable:!0,enumerable:!0,configurable:!0});return e}function yr(o,e){return o&&te(e)?e.resolve(o.doc,o):e}var yn,fe,gr,bn=T(()=>{B();K();yn="<<",fe={identify:o=>o===yn||typeof o=="symbol"&&o.description===yn,default:"key",tag:"tag:yaml.org,2002:merge",test:/^<<$/,resolve:()=>Object.assign(new C(Symbol(yn)),{addToJSMap:xa}),stringify:()=>yn},gr=(o,e)=>(fe.identify(e)||D(e)&&(!e.type||e.type===C.PLAIN)&&fe.identify(e.value))&&o?.doc.schema.tags.some(t=>t.tag===fe.tag&&t.default)});function wn(o,e,{key:t,value:n}){if(I(t)&&t.addToJSMap)t.addToJSMap(o,e,n);else if(gr(o,t))xa(o,e,n);else{let a=W(t,"",o);if(e instanceof Map)e.set(a,W(n,a,o));else if(e instanceof Set)e.add(a);else{let r=Oi(t,a,o),s=W(n,r,o);r in e?Object.defineProperty(e,r,{value:s,writable:!0,enumerable:!0,configurable:!0}):e[r]=s}}return e}function Oi(o,e,t){if(e===null)return"";if(typeof e!="object")return String(e);if(I(o)&&t?.doc){let n=mn(t.doc,{});n.anchors=new Set;for(let r of t.anchors.keys())n.anchors.add(r.anchor);n.inFlow=!0,n.inStringifyKey=!0;let a=o.toString(n);if(!t.mapKeyWarned){let r=JSON.stringify(a);r.length>40&&(r=r.substring(0,36)+'..."'),gn(t.doc.options.logLevel,`Keys with collection values will be stringified due to JS Object restrictions: ${r}. Set mapAsMap: true to use object keys.`),t.mapKeyWarned=!0}return a}return JSON.stringify(e)}var Ta=T(()=>{va();bn();Ct();B();Le()});function et(o,e,t){let n=Te(o,void 0,t),a=Te(e,void 0,t);return new _(n,a)}var _,Ae=T(()=>{wt();mr();Ta();B();_=class o{constructor(e,t=null){Object.defineProperty(this,Z,{value:ua}),this.key=e,this.value=t}clone(e){let{key:t,value:n}=this;return I(t)&&(t=t.clone(e)),I(n)&&(n=n.clone(e)),new o(t,n)}toJSON(e,t){let n=t?.mapAsMap?new Map:{};return wn(t,n,this)}toString(e,t,n){return e?.doc?hr(this,e,t,n):JSON.stringify(this)}}});function vn(o,e,t){return(e.inFlow??o.flow?Ii:Ri)(o,e,t)}function Ri({comment:o,items:e},t,{blockItemPrefix:n,flowChars:a,itemIndent:r,onChompKeep:s,onComment:i}){let{indent:l,options:{commentString:c}}=t,f=Object.assign({},t,{indent:r,type:null}),d=!1,p=[];for(let m=0;m<e.length;++m){let h=e[m],g=null;if(I(h))!d&&h.spaceBefore&&p.push(""),kn(t,p,h.commentBefore,d),h.comment&&(g=h.comment);else if(R(h)){let y=I(h.key)?h.key:null;y&&(!d&&y.spaceBefore&&p.push(""),kn(t,p,y.commentBefore,d))}d=!1;let b=Ce(h,f,()=>g=null,()=>d=!0);g&&(b+=we(b,r,c(g))),d&&g&&(d=!1),p.push(n+b)}let u;if(p.length===0)u=a.start+a.end;else{u=p[0];for(let m=1;m<p.length;++m){let h=p[m];u+=h?`
${l}${h}`:`
`}}return o?(u+=`
`+se(c(o),l),i&&i()):d&&s&&s(),u}function Ii({items:o},e,{flowChars:t,itemIndent:n}){let{indent:a,indentStep:r,flowCollectionPadding:s,options:{commentString:i}}=e;n+=r;let l=Object.assign({},e,{indent:n,inFlow:!0,type:null}),c=!1,f=0,d=[];for(let m=0;m<o.length;++m){let h=o[m],g=null;if(I(h))h.spaceBefore&&d.push(""),kn(e,d,h.commentBefore,!1),h.comment&&(g=h.comment);else if(R(h)){let y=I(h.key)?h.key:null;y&&(y.spaceBefore&&d.push(""),kn(e,d,y.commentBefore,!1),y.comment&&(c=!0));let k=I(h.value)?h.value:null;k?(k.comment&&(g=k.comment),k.commentBefore&&(c=!0)):h.value==null&&y?.comment&&(g=y.comment)}g&&(c=!0);let b=Ce(h,l,()=>g=null);c||(c=d.length>f||b.includes(`
`)),m<o.length-1?b+=",":e.options.trailingComma&&(e.options.lineWidth>0&&(c||(c=d.reduce((y,k)=>y+k.length+2,2)+(b.length+2)>e.options.lineWidth)),c&&(b+=",")),g&&(b+=we(b,n,i(g))),d.push(b),f=d.length}let{start:p,end:u}=t;if(d.length===0)return p+u;if(!c){let m=d.reduce((h,g)=>h+g.length+2,2);c=e.options.lineWidth>0&&m>e.options.lineWidth}if(c){let m=p;for(let h of d)m+=h?`
${r}${a}${h}`:`
`;return`${m}
${a}${u}`}else return`${p}${s}${d.join(" ")}${s}${u}`}function kn({indent:o,options:{commentString:e}},t,n,a){if(n&&a&&(n=n.replace(/^\n+/,"")),n){let r=se(e(n),o);t.push(r.trimStart())}}var Na=T(()=>{B();Ct();vt()});function Me(o,e){let t=D(e)?e.value:e;for(let n of o)if(R(n)&&(n.key===e||n.key===t||D(n.key)&&n.key.value===t))return n}var V,Oe=T(()=>{Na();Ta();dn();B();Ae();K();V=class extends Ye{static get tagName(){return"tag:yaml.org,2002:map"}constructor(e){super(ce,e),this.items=[]}static from(e,t,n){let{keepUndefined:a,replacer:r}=n,s=new this(e),i=(l,c)=>{if(typeof r=="function")c=r.call(t,l,c);else if(Array.isArray(r)&&!r.includes(l))return;(c!==void 0||a)&&s.items.push(et(l,c,n))};if(t instanceof Map)for(let[l,c]of t)i(l,c);else if(t&&typeof t=="object")for(let l of Object.keys(t))i(l,t[l]);return typeof e.sortMapEntries=="function"&&s.items.sort(e.sortMapEntries),s}add(e,t){let n;R(e)?n=e:!e||typeof e!="object"||!("key"in e)?n=new _(e,e?.value):n=new _(e.key,e.value);let a=Me(this.items,n.key),r=this.schema?.sortMapEntries;if(a){if(!t)throw new Error(`Key ${n.key} already set`);D(a.value)&&cn(n.value)?a.value.value=n.value:a.value=n.value}else if(r){let s=this.items.findIndex(i=>r(n,i)<0);s===-1?this.items.push(n):this.items.splice(s,0,n)}else this.items.push(n)}delete(e){let t=Me(this.items,e);return t?this.items.splice(this.items.indexOf(t),1).length>0:!1}get(e,t){let a=Me(this.items,e)?.value;return(!t&&D(a)?a.value:a)??void 0}has(e){return!!Me(this.items,e)}set(e,t){this.add(new _(e,t),!0)}toJSON(e,t,n){let a=n?new n:t?.mapAsMap?new Map:{};t?.onCreate&&t.onCreate(a);for(let r of this.items)wn(t,a,r);return a}toString(e,t,n){if(!e)return JSON.stringify(this);for(let a of this.items)if(!R(a))throw new Error(`Map items must all be pairs; found ${JSON.stringify(a)} instead`);return!e.allNullValues&&this.hasAllNullValues(!1)&&(e=Object.assign({},e,{allNullValues:!0})),vn(this,e,{blockItemPrefix:"",flowChars:{start:"{",end:"}"},itemIndent:e.indent||"",onChompKeep:n,onComment:t})}}});var pe,tt=T(()=>{B();Oe();pe={collection:"map",default:!0,nodeClass:V,tag:"tag:yaml.org,2002:map",resolve(o,e){return ae(o)||e("Expected a mapping for this tag"),o},createNode:(o,e,t)=>V.from(o,e,t)}});function Sn(o){let e=D(o)?o.value:o;return e&&typeof e=="string"&&(e=Number(e)),typeof e=="number"&&Number.isInteger(e)&&e>=0?e:null}var z,Re=T(()=>{wt();Na();dn();B();K();Le();z=class extends Ye{static get tagName(){return"tag:yaml.org,2002:seq"}constructor(e){super(xe,e),this.items=[]}add(e){this.items.push(e)}delete(e){let t=Sn(e);return typeof t!="number"?!1:this.items.splice(t,1).length>0}get(e,t){let n=Sn(e);if(typeof n!="number")return;let a=this.items[n];return!t&&D(a)?a.value:a}has(e){let t=Sn(e);return typeof t=="number"&&t<this.items.length}set(e,t){let n=Sn(e);if(typeof n!="number")throw new Error(`Expected a valid index, not ${e}.`);let a=this.items[n];D(a)&&cn(t)?a.value=t:this.items[n]=t}toJSON(e,t){let n=[];t?.onCreate&&t.onCreate(n);let a=0;for(let r of this.items)n.push(W(r,String(a++),t));return n}toString(e,t,n){return e?vn(this,e,{blockItemPrefix:"- ",flowChars:{start:"[",end:"]"},itemIndent:(e.indent||"")+"  ",onChompKeep:n,onComment:t}):JSON.stringify(this)}static from(e,t,n){let{replacer:a}=n,r=new this(e);if(t&&Symbol.iterator in Object(t)){let s=0;for(let i of t){if(typeof a=="function"){let l=t instanceof Set?i:String(s++);i=a.call(t,l,i)}r.items.push(Te(i,void 0,n))}}return r}}});var ue,nt=T(()=>{B();Re();ue={collection:"seq",default:!0,nodeClass:z,tag:"tag:yaml.org,2002:seq",resolve(o,e){return oe(o)||e("Expected a sequence for this tag"),o},createNode:(o,e,t)=>z.from(o,e,t)}});var Ie,Et=T(()=>{Nt();Ie={identify:o=>typeof o=="string",default:!0,tag:"tag:yaml.org,2002:str",resolve:o=>o,stringify(o,e,t,n){return e=Object.assign({actualString:!0},e),Ne(o,e,t,n)}}});var _e,xn=T(()=>{K();_e={identify:o=>o==null,createNode:()=>new C(null),default:!0,tag:"tag:yaml.org,2002:null",test:/^(?:~|[Nn]ull|NULL)?$/,resolve:()=>new C(null),stringify:({source:o},e)=>typeof o=="string"&&_e.test.test(o)?o:e.options.nullStr}});var Ft,Ca=T(()=>{K();Ft={identify:o=>typeof o=="boolean",default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:[Tt]rue|TRUE|[Ff]alse|FALSE)$/,resolve:o=>new C(o[0]==="t"||o[0]==="T"),stringify({source:o,value:e},t){if(o&&Ft.test.test(o)){let n=o[0]==="t"||o[0]==="T";if(e===n)return o}return e?t.options.trueStr:t.options.falseStr}}});function X({format:o,minFractionDigits:e,tag:t,value:n}){if(typeof n=="bigint")return String(n);let a=typeof n=="number"?n:Number(n);if(!isFinite(a))return isNaN(a)?".nan":a<0?"-.inf":".inf";let r=Object.is(n,-0)?"-0":JSON.stringify(n);if(!o&&e&&(!t||t==="tag:yaml.org,2002:float")&&/^-?\d/.test(r)&&!r.includes("e")){let s=r.indexOf(".");s<0&&(s=r.length,r+=".");let i=e-(r.length-s-1);for(;i-- >0;)r+="0"}return r}var at=T(()=>{});var Tn,Nn,Cn,Ea=T(()=>{K();at();Tn={identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^(?:[-+]?\.(?:inf|Inf|INF)|\.nan|\.NaN|\.NAN)$/,resolve:o=>o.slice(-3).toLowerCase()==="nan"?NaN:o[0]==="-"?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY,stringify:X},Nn={identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"EXP",test:/^[-+]?(?:\.[0-9]+|[0-9]+(?:\.[0-9]*)?)[eE][-+]?[0-9]+$/,resolve:o=>parseFloat(o),stringify(o){let e=Number(o.value);return isFinite(e)?e.toExponential():X(o)}},Cn={identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^[-+]?(?:\.[0-9]+|[0-9]+\.[0-9]*)$/,resolve(o){let e=new C(parseFloat(o)),t=o.indexOf(".");return t!==-1&&o[o.length-1]==="0"&&(e.minFractionDigits=o.length-t-1),e},stringify:X}});function br(o,e,t){let{value:n}=o;return En(n)&&n>=0?t+n.toString(e):X(o)}var En,Fa,Fn,Ln,Dn,La=T(()=>{at();En=o=>typeof o=="bigint"||Number.isInteger(o),Fa=(o,e,t,{intAsBigInt:n})=>n?BigInt(o):parseInt(o.substring(e),t);Fn={identify:o=>En(o)&&o>=0,default:!0,tag:"tag:yaml.org,2002:int",format:"OCT",test:/^0o[0-7]+$/,resolve:(o,e,t)=>Fa(o,2,8,t),stringify:o=>br(o,8,"0o")},Ln={identify:En,default:!0,tag:"tag:yaml.org,2002:int",test:/^[-+]?[0-9]+$/,resolve:(o,e,t)=>Fa(o,0,10,t),stringify:X},Dn={identify:o=>En(o)&&o>=0,default:!0,tag:"tag:yaml.org,2002:int",format:"HEX",test:/^0x[0-9a-fA-F]+$/,resolve:(o,e,t)=>Fa(o,2,16,t),stringify:o=>br(o,16,"0x")}});var wr,kr=T(()=>{tt();xn();nt();Et();Ca();Ea();La();wr=[pe,ue,Ie,_e,Ft,Fn,Ln,Dn,Tn,Nn,Cn]});function vr(o){return typeof o=="bigint"||Number.isInteger(o)}var An,Pi,Ui,Sr,xr=T(()=>{K();tt();nt();An=({value:o})=>JSON.stringify(o),Pi=[{identify:o=>typeof o=="string",default:!0,tag:"tag:yaml.org,2002:str",resolve:o=>o,stringify:An},{identify:o=>o==null,createNode:()=>new C(null),default:!0,tag:"tag:yaml.org,2002:null",test:/^null$/,resolve:()=>null,stringify:An},{identify:o=>typeof o=="boolean",default:!0,tag:"tag:yaml.org,2002:bool",test:/^true$|^false$/,resolve:o=>o==="true",stringify:An},{identify:vr,default:!0,tag:"tag:yaml.org,2002:int",test:/^-?(?:0|[1-9][0-9]*)$/,resolve:(o,e,{intAsBigInt:t})=>t?BigInt(o):parseInt(o,10),stringify:({value:o})=>vr(o)?o.toString():JSON.stringify(o)},{identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^-?(?:0|[1-9][0-9]*)(?:\.[0-9]*)?(?:[eE][-+]?[0-9]+)?$/,resolve:o=>parseFloat(o),stringify:An}],Ui={default:!0,tag:"",test:/^/,resolve(o,e){return e(`Unresolved plain scalar ${JSON.stringify(o)}`),o}},Sr=[pe,ue].concat(Pi,Ui)});var Lt,Da=T(()=>{K();Nt();Lt={identify:o=>o instanceof Uint8Array,default:!1,tag:"tag:yaml.org,2002:binary",resolve(o,e){if(typeof atob=="function"){let t=atob(o.replace(/[\n\r]/g,"")),n=new Uint8Array(t.length);for(let a=0;a<t.length;++a)n[a]=t.charCodeAt(a);return n}else return e("This environment does not support reading binary tags; either Buffer or atob is required"),o},stringify({comment:o,type:e,value:t},n,a,r){if(!t)return"";let s=t,i;if(typeof btoa=="function"){let l="";for(let c=0;c<s.length;++c)l+=String.fromCharCode(s[c]);i=btoa(l)}else throw new Error("This environment does not support writing binary tags; either Buffer or btoa is required");if(e??(e=C.BLOCK_LITERAL),e!==C.QUOTE_DOUBLE){let l=Math.max(n.options.lineWidth-n.indent.length,n.options.minContentWidth),c=Math.ceil(i.length/l),f=new Array(c);for(let d=0,p=0;d<c;++d,p+=l)f[d]=i.substr(p,l);i=f.join(e===C.BLOCK_LITERAL?`
`:" ")}return Ne({comment:o,type:e,value:i},n,a,r)}}});function Aa(o,e){if(oe(o))for(let t=0;t<o.items.length;++t){let n=o.items[t];if(!R(n)){if(ae(n)){n.items.length>1&&e("Each pair must have its own sequence indicator");let a=n.items[0]||new _(new C(null));if(n.commentBefore&&(a.key.commentBefore=a.key.commentBefore?`${n.commentBefore}
${a.key.commentBefore}`:n.commentBefore),n.comment){let r=a.value??a.key;r.comment=r.comment?`${n.comment}
${r.comment}`:n.comment}n=a}o.items[t]=R(n)?n:new _(n)}}else e("Expected a sequence for this tag");return o}function Ma(o,e,t){let{replacer:n}=t,a=new z(o);a.tag="tag:yaml.org,2002:pairs";let r=0;if(e&&Symbol.iterator in Object(e))for(let s of e){typeof n=="function"&&(s=n.call(e,String(r++),s));let i,l;if(Array.isArray(s))if(s.length===2)i=s[0],l=s[1];else throw new TypeError(`Expected [key, value] tuple: ${s}`);else if(s&&s instanceof Object){let c=Object.keys(s);if(c.length===1)i=c[0],l=s[i];else throw new TypeError(`Expected tuple with one key, not ${c.length} keys`)}else i=s;a.items.push(et(i,l,t))}return a}var Dt,Mn=T(()=>{B();Ae();K();Re();Dt={collection:"seq",default:!1,tag:"tag:yaml.org,2002:pairs",resolve:Aa,createNode:Ma}});var ot,At,Oa=T(()=>{B();Le();Oe();Re();Mn();ot=class o extends z{constructor(){super(),this.add=V.prototype.add.bind(this),this.delete=V.prototype.delete.bind(this),this.get=V.prototype.get.bind(this),this.has=V.prototype.has.bind(this),this.set=V.prototype.set.bind(this),this.tag=o.tag}toJSON(e,t){if(!t)return super.toJSON(e);let n=new Map;t?.onCreate&&t.onCreate(n);for(let a of this.items){let r,s;if(R(a)?(r=W(a.key,"",t),s=W(a.value,r,t)):r=W(a,"",t),n.has(r))throw new Error("Ordered maps must not include duplicate keys");n.set(r,s)}return n}static from(e,t,n){let a=Ma(e,t,n),r=new this;return r.items=a.items,r}};ot.tag="tag:yaml.org,2002:omap";At={collection:"seq",identify:o=>o instanceof Map,nodeClass:ot,default:!1,tag:"tag:yaml.org,2002:omap",resolve(o,e){let t=Aa(o,e),n=[];for(let{key:a}of t.items)D(a)&&(n.includes(a.value)?e(`Ordered maps must not include duplicate keys: ${a.value}`):n.push(a.value));return Object.assign(new ot,t)},createNode:(o,e,t)=>ot.from(o,e,t)}});function Tr({value:o,source:e},t){return e&&(o?Ra:Ia).test.test(e)?e:o?t.options.trueStr:t.options.falseStr}var Ra,Ia,Nr=T(()=>{K();Ra={identify:o=>o===!0,default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:Y|y|[Yy]es|YES|[Tt]rue|TRUE|[Oo]n|ON)$/,resolve:()=>new C(!0),stringify:Tr},Ia={identify:o=>o===!1,default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:N|n|[Nn]o|NO|[Ff]alse|FALSE|[Oo]ff|OFF)$/,resolve:()=>new C(!1),stringify:Tr}});var Cr,Er,Fr,Lr=T(()=>{K();at();Cr={identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^(?:[-+]?\.(?:inf|Inf|INF)|\.nan|\.NaN|\.NAN)$/,resolve:o=>o.slice(-3).toLowerCase()==="nan"?NaN:o[0]==="-"?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY,stringify:X},Er={identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"EXP",test:/^[-+]?(?:[0-9][0-9_]*)?(?:\.[0-9_]*)?[eE][-+]?[0-9]+$/,resolve:o=>parseFloat(o.replace(/_/g,"")),stringify(o){let e=Number(o.value);return isFinite(e)?e.toExponential():X(o)}},Fr={identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^[-+]?(?:[0-9][0-9_]*)?\.[0-9_]*$/,resolve(o){let e=new C(parseFloat(o.replace(/_/g,""))),t=o.indexOf(".");if(t!==-1){let n=o.substring(t+1).replace(/_/g,"");n[n.length-1]==="0"&&(e.minFractionDigits=n.length)}return e},stringify:X}});function On(o,e,t,{intAsBigInt:n}){let a=o[0];if((a==="-"||a==="+")&&(e+=1),o=o.substring(e).replace(/_/g,""),n){switch(t){case 2:o=`0b${o}`;break;case 8:o=`0o${o}`;break;case 16:o=`0x${o}`;break}let s=BigInt(o);return a==="-"?BigInt(-1)*s:s}let r=parseInt(o,t);return a==="-"?-1*r:r}function Pa(o,e,t){let{value:n}=o;if(Mt(n)){let a=n.toString(e);return n<0?"-"+t+a.substr(1):t+a}return X(o)}var Mt,Dr,Ar,Mr,Or,Rr=T(()=>{at();Mt=o=>typeof o=="bigint"||Number.isInteger(o);Dr={identify:Mt,default:!0,tag:"tag:yaml.org,2002:int",format:"BIN",test:/^[-+]?0b[0-1_]+$/,resolve:(o,e,t)=>On(o,2,2,t),stringify:o=>Pa(o,2,"0b")},Ar={identify:Mt,default:!0,tag:"tag:yaml.org,2002:int",format:"OCT",test:/^[-+]?0[0-7_]+$/,resolve:(o,e,t)=>On(o,1,8,t),stringify:o=>Pa(o,8,"0")},Mr={identify:Mt,default:!0,tag:"tag:yaml.org,2002:int",test:/^[-+]?[0-9][0-9_]*$/,resolve:(o,e,t)=>On(o,0,10,t),stringify:X},Or={identify:Mt,default:!0,tag:"tag:yaml.org,2002:int",format:"HEX",test:/^[-+]?0x[0-9a-fA-F_]+$/,resolve:(o,e,t)=>On(o,2,16,t),stringify:o=>Pa(o,16,"0x")}});var rt,Ot,Ua=T(()=>{B();Ae();Oe();rt=class o extends V{constructor(e){super(e),this.tag=o.tag}add(e){let t;R(e)?t=e:e&&typeof e=="object"&&"key"in e&&"value"in e&&e.value===null?t=new _(e.key,null):t=new _(e,null),Me(this.items,t.key)||this.items.push(t)}get(e,t){let n=Me(this.items,e);return!t&&R(n)?D(n.key)?n.key.value:n.key:n}set(e,t){if(typeof t!="boolean")throw new Error(`Expected boolean value for set(key, value) in a YAML set, not ${typeof t}`);let n=Me(this.items,e);n&&!t?this.items.splice(this.items.indexOf(n),1):!n&&t&&this.items.push(new _(e))}toJSON(e,t){return super.toJSON(e,t,Set)}toString(e,t,n){if(!e)return JSON.stringify(this);if(this.hasAllNullValues(!0))return super.toString(Object.assign({},e,{allNullValues:!0}),t,n);throw new Error("Set items must all have null values")}static from(e,t,n){let{replacer:a}=n,r=new this(e);if(t&&Symbol.iterator in Object(t))for(let s of t)typeof a=="function"&&(s=a.call(t,s,s)),r.items.push(et(s,null,n));return r}};rt.tag="tag:yaml.org,2002:set";Ot={collection:"map",identify:o=>o instanceof Set,nodeClass:rt,default:!1,tag:"tag:yaml.org,2002:set",createNode:(o,e,t)=>rt.from(o,e,t),resolve(o,e){if(ae(o)){if(o.hasAllNullValues(!0))return Object.assign(new rt,o);e("Set items must all have null values")}else e("Expected a mapping for this tag");return o}}});function Ba(o,e){let t=o[0],n=t==="-"||t==="+"?o.substring(1):o,a=s=>e?BigInt(s):Number(s),r=n.replace(/_/g,"").split(":").reduce((s,i)=>s*a(60)+a(i),a(0));return t==="-"?a(-1)*r:r}function Ir(o){let{value:e}=o,t=s=>s;if(typeof e=="bigint")t=s=>BigInt(s);else if(isNaN(e)||!isFinite(e))return X(o);let n="";e<0&&(n="-",e*=t(-1));let a=t(60),r=[e%a];return e<60?r.unshift(0):(e=(e-r[0])/a,r.unshift(e%a),e>=60&&(e=(e-r[0])/a,r.unshift(e))),n+r.map(s=>String(s).padStart(2,"0")).join(":").replace(/000000\d*$/,"")}var Rn,In,st,qa=T(()=>{at();Rn={identify:o=>typeof o=="bigint"||Number.isInteger(o),default:!0,tag:"tag:yaml.org,2002:int",format:"TIME",test:/^[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+$/,resolve:(o,e,{intAsBigInt:t})=>Ba(o,t),stringify:Ir},In={identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"TIME",test:/^[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+\.[0-9_]*$/,resolve:o=>Ba(o,!1),stringify:Ir},st={identify:o=>o instanceof Date,default:!0,tag:"tag:yaml.org,2002:timestamp",test:RegExp("^([0-9]{4})-([0-9]{1,2})-([0-9]{1,2})(?:(?:t|T|[ \\t]+)([0-9]{1,2}):([0-9]{1,2}):([0-9]{1,2}(\\.[0-9]+)?)(?:[ \\t]*(Z|[-+][012]?[0-9](?::[0-9]{2})?))?)?$"),resolve(o){let e=o.match(st.test);if(!e)throw new Error("!!timestamp expects a date, starting with yyyy-mm-dd");let[,t,n,a,r,s,i]=e.map(Number),l=e[7]?Number((e[7]+"00").substr(1,3)):0,c=Date.UTC(t,n-1,a,r||0,s||0,i||0,l),f=e[8];if(f&&f!=="Z"){let d=Ba(f,!1);Math.abs(d)<30&&(d*=60),c-=6e4*d}return new Date(c)},stringify:({value:o})=>o?.toISOString().replace(/(T00:00:00)?\.000Z$/,"")??""}});var Ha,Pr=T(()=>{tt();xn();nt();Et();Da();Nr();Lr();Rr();bn();Oa();Mn();Ua();qa();Ha=[pe,ue,Ie,_e,Ra,Ia,Dr,Ar,Mr,Or,Cr,Er,Fr,Lt,fe,At,Dt,Ot,Rn,In,st]});function Pn(o,e,t){let n=Ur.get(e);if(n&&!o)return t&&!n.includes(fe)?n.concat(fe):n.slice();let a=n;if(!a)if(Array.isArray(o))a=[];else{let r=Array.from(Ur.keys()).filter(s=>s!=="yaml11").map(s=>JSON.stringify(s)).join(", ");throw new Error(`Unknown schema "${e}"; use one of ${r} or define customTags array`)}if(Array.isArray(o))for(let r of o)a=a.concat(r);else typeof o=="function"&&(a=o(a.slice()));return t&&(a=a.concat(fe)),a.reduce((r,s)=>{let i=typeof s=="string"?Br[s]:s;if(!i){let l=JSON.stringify(s),c=Object.keys(Br).map(f=>JSON.stringify(f)).join(", ");throw new Error(`Unknown custom tag ${l}; use one of ${c}`)}return r.includes(i)||r.push(i),r},[])}var Ur,Br,qr,Hr=T(()=>{tt();xn();nt();Et();Ca();Ea();La();kr();xr();Da();bn();Oa();Mn();Pr();Ua();qa();Ur=new Map([["core",wr],["failsafe",[pe,ue,Ie]],["json",Sr],["yaml11",Ha],["yaml-1.1",Ha]]),Br={binary:Lt,bool:Ft,float:Cn,floatExp:Nn,floatNaN:Tn,floatTime:In,int:Ln,intHex:Dn,intOct:Fn,intTime:Rn,map:pe,merge:fe,null:_e,omap:At,pairs:Dt,seq:ue,set:Ot,timestamp:st},qr={"tag:yaml.org,2002:binary":Lt,"tag:yaml.org,2002:merge":fe,"tag:yaml.org,2002:omap":At,"tag:yaml.org,2002:pairs":Dt,"tag:yaml.org,2002:set":Ot,"tag:yaml.org,2002:timestamp":st}});var Bi,Ve,ja=T(()=>{B();tt();nt();Et();Hr();Bi=(o,e)=>o.key<e.key?-1:o.key>e.key?1:0,Ve=class o{constructor({compat:e,customTags:t,merge:n,resolveKnownTags:a,schema:r,sortMapEntries:s,toStringDefaults:i}){this.compat=Array.isArray(e)?Pn(e,"compat"):e?Pn(null,e):null,this.name=typeof r=="string"&&r||"core",this.knownTags=a?qr:{},this.tags=Pn(t,this.name,n),this.toStringOptions=i??null,Object.defineProperty(this,ce,{value:pe}),Object.defineProperty(this,ee,{value:Ie}),Object.defineProperty(this,xe,{value:ue}),this.sortMapEntries=typeof s=="function"?s:s===!0?Bi:null}clone(){let e=Object.create(o.prototype,Object.getOwnPropertyDescriptors(this));return e.tags=this.tags.slice(),e}}});function jr(o,e){let t=[],n=e.directives===!0;if(e.directives!==!1&&o.directives){let l=o.directives.toString(o);l?(t.push(l),n=!0):o.directives.docStart&&(n=!0)}n&&t.push("---");let a=mn(o,e),{commentString:r}=a.options;if(o.commentBefore){t.length!==1&&t.unshift("");let l=r(o.commentBefore);t.unshift(se(l,""))}let s=!1,i=null;if(o.contents){if(I(o.contents)){if(o.contents.spaceBefore&&n&&t.push(""),o.contents.commentBefore){let f=r(o.contents.commentBefore);t.push(se(f,""))}a.forceBlockIndent=!!o.comment,i=o.contents.comment}let l=i?void 0:()=>s=!0,c=Ce(o.contents,a,()=>i=null,l);i&&(c+=we(c,"",r(i))),(c[0]==="|"||c[0]===">")&&t[t.length-1]==="---"?t[t.length-1]=`--- ${c}`:t.push(c)}else t.push(Ce(o.contents,a));if(o.directives?.docEnd)if(o.comment){let l=r(o.comment);l.includes(`
...
`)+`
`}var _r=T(()=>{B();Ct();vt()});function it(o){if(q(o))return!0;throw new Error("Expected a YAML collection as document contents")}var he,Rt=T(()=>{bt();dn();B();Ae();Le();ja();_r();rn();ya();wt();ha();he=class o{constructor(e,t,n){this.commentBefore=null,this.comment=null,this.errors=[],this.warnings=[],Object.defineProperty(this,Z,{value:nn});let a=null;typeof t=="function"||Array.isArray(t)?a=t:n===void 0&&t&&(n=t,t=void 0);let r=Object.assign({intAsBigInt:!1,keepSourceTokens:!1,logLevel:"warn",prettyErrors:!0,strict:!0,stringKeys:!1,uniqueKeys:!0,version:"1.2"},n);this.options=r;let{version:s}=r;n?._directives?(this.directives=n._directives.atDocument(),this.directives.yaml.explicit&&(s=this.directives.yaml.version)):this.directives=new be({version:s}),this.setSchema(s,n),this.contents=e===void 0?null:this.createNode(e,a,n)}clone(){let e=Object.create(o.prototype,{[Z]:{value:nn}});return e.commentBefore=this.commentBefore,e.comment=this.comment,e.errors=this.errors.slice(),e.warnings=this.warnings.slice(),e.options=Object.assign({},this.options),this.directives&&(e.directives=this.directives.clone()),e.schema=this.schema.clone(),e.contents=I(this.contents)?this.contents.clone(e.schema):this.contents,this.range&&(e.range=this.range.slice()),e}add(e){it(this.contents)&&this.contents.add(e)}addIn(e,t){it(this.contents)&&this.contents.addIn(e,t)}createAlias(e,t){if(!e.anchor){let n=ma(this);e.anchor=!t||n.has(t)?ga(t||"a",n):t}return new de(e.anchor)}createNode(e,t,n){let a;if(typeof t=="function")e=t.call({"":e},"",e),a=t;else if(Array.isArray(t)){let g=y=>typeof y=="number"||y instanceof String||y instanceof Number,b=t.filter(g).map(String);b.length>0&&(t=t.concat(b)),a=t}else n===void 0&&t&&(n=t,t=void 0);let{aliasDuplicateObjects:r,anchorPrefix:s,flow:i,keepUndefined:l,onTagObj:c,tag:f}=n??{},{onAnchor:d,setAnchors:p,sourceObjects:u}=dr(this,s||"a"),m={aliasDuplicateObjects:r??!0,keepUndefined:l??!1,onAnchor:d,onTagObj:c,replacer:a,schema:this.schema,sourceObjects:u},h=Te(e,f,m);return i&&q(h)&&(h.flow=!0),p(),h}createPair(e,t,n={}){let a=this.createNode(e,null,n),r=this.createNode(t,null,n);return new _(a,r)}delete(e){return it(this.contents)?this.contents.delete(e):!1}deleteIn(e){return Qe(e)?this.contents==null?!1:(this.contents=null,!0):it(this.contents)?this.contents.deleteIn(e):!1}get(e,t){return q(this.contents)?this.contents.get(e,t):void 0}getIn(e,t){return Qe(e)?!t&&D(this.contents)?this.contents.value:this.contents:q(this.contents)?this.contents.getIn(e,t):void 0}has(e){return q(this.contents)?this.contents.has(e):!1}hasIn(e){return Qe(e)?this.contents!==void 0:q(this.contents)?this.contents.hasIn(e):!1}set(e,t){this.contents==null?this.contents=kt(this.schema,[e],t):it(this.contents)&&this.contents.set(e,t)}setIn(e,t){Qe(e)?this.contents=t:this.contents==null?this.contents=kt(this.schema,Array.from(e),t):it(this.contents)&&this.contents.setIn(e,t)}setSchema(e,t={}){typeof e=="number"&&(e=String(e));let n;switch(e){case"1.1":this.directives?this.directives.yaml.version="1.1":this.directives=new be({version:"1.1"}),n={resolveKnownTags:!1,schema:"yaml-1.1"};break;case"1.2":case"next":this.directives?this.directives.yaml.version=e:this.directives=new be({version:e}),n={resolveKnownTags:!0,schema:"core"};break;case null:this.directives&&delete this.directives,n=null;break;default:{let a=JSON.stringify(e);throw new Error(`Expected '1.1', '1.2' or null as first argument, but found: ${a}`)}}if(t.schema instanceof Object)this.schema=t.schema;else if(n)this.schema=new Ve(Object.assign(n,t));else throw new Error("With a null YAML version, the { schema: Schema } option is required")}toJS({json:e,jsonArg:t,mapAsMap:n,maxAliasCount:a,onAnchor:r,reviver:s}={}){let i={anchors:new Map,doc:this,keep:!e,mapAsMap:n===!0,mapKeyWarned:!1,maxAliasCount:typeof a=="number"?a:100},l=W(this.contents,t??"",i);if(typeof r=="function")for(let{count:c,res:f}of i.anchors.values())r(f,c);return typeof s=="function"?Fe(s,{"":l},"",l):l}toJSON(e,t){return this.toJS({json:!0,jsonArg:e,mapAsMap:!1,onAnchor:t})}toString(e={}){if(this.errors.length>0)throw new Error("Document with errors cannot be stringified");if("indent"in e&&(!Number.isInteger(e.indent)||Number(e.indent)<=0)){let t=JSON.stringify(e.indent);throw new Error(`"indent" option must be a positive integer, not ${t}`)}return jr(this,e)}}});var Ke,Q,We,It,Pt=T(()=>{Ke=class extends Error{constructor(e,t,n,a){super(),this.name=e,this.code=n,this.message=a,this.pos=t}},Q=class extends Ke{constructor(e,t,n){super("YAMLParseError",e,t,n)}},We=class extends Ke{constructor(e,t,n){super("YAMLWarning",e,t,n)}},It=(o,e)=>t=>{if(t.pos[0]===-1)return;t.linePos=t.pos.map(i=>e.linePos(i));let{line:n,col:a}=t.linePos[0];t.message+=` at line ${n}, column ${a}`;let r=a-1,s=o.substring(e.lineStarts[n-1],e.lineStarts[n]).replace(/[\n\r]+$/,"");if(r>=60&&s.length>80){let i=Math.min(r-39,s.length-79);s="\u2026"+s.substring(i),r-=i-1}if(s.length>80&&(s=s.substring(0,79)+"\u2026"),n>1&&/^ *$/.test(s.substring(0,r))){let i=o.substring(e.lineStarts[n-2],e.lineStarts[n-1]);i.length>80&&(i=i.substring(0,79)+`\u2026
...
${s}
${c}
`}}});function ke(o,{flow:e,indicator:t,next:n,offset:a,onError:r,parentIndent:s,startOnNewline:i}){let l=!1,c=i,f=i,d="",p="",u=!1,m=!1,h=null,g=null,b=null,y=null,k=null,S=null,N=null;for(let w of o)switch(m&&(w.type!=="space"&&w.type!=="newline"&&w.type!=="comma"&&r(w.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),m=!1),h&&(c&&w.type!=="comment"&&w.type!=="newline"&&r(h,"TAB_AS_INDENT","Tabs are not allowed as indentation"),h=null),w.type){case"space":!e&&(t!=="doc-start"||n?.type!=="flow-collection")&&w.source.includes("	")&&(h=w),f=!0;break;case"comment":{f||r(w,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");let v=w.source.substring(1)||" ";d?d+=p+v:d=v,p="",c=!1;break}case"newline":c?d?d+=w.source:(!S||t!=="seq-item-ind")&&(l=!0):p+=w.source,c=!0,u=!0,(g||b)&&(y=w),f=!0;break;case"anchor":g&&r(w,"MULTIPLE_ANCHORS","A node can have at most one anchor"),w.source.endsWith(":")&&r(w.offset+w.source.length-1,"BAD_ALIAS","Anchor ending in : is ambiguous",!0),g=w,N??(N=w.offset),c=!1,f=!1,m=!0;break;case"tag":{b&&r(w,"MULTIPLE_TAGS","A node can have at most one tag"),b=w,N??(N=w.offset),c=!1,f=!1,m=!0;break}case t:(g||b)&&r(w,"BAD_PROP_ORDER",`Anchors and tags must be after the ${w.source} indicator`),S&&r(w,"UNEXPECTED_TOKEN",`Unexpected ${w.source} in ${e??"collection"}`),S=w,c=t==="seq-item-ind"||t==="explicit-key-ind",f=!1;break;case"comma":if(e){k&&r(w,"UNEXPECTED_TOKEN",`Unexpected , in ${e}`),k=w,c=!1,f=!1;break}default:r(w,"UNEXPECTED_TOKEN",`Unexpected ${w.type} token`),c=!1,f=!1}let x=o[o.length-1],L=x?x.offset+x.source.length:a;return m&&n&&n.type!=="space"&&n.type!=="newline"&&n.type!=="comma"&&(n.type!=="scalar"||n.source!=="")&&r(n.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),h&&(c&&h.indent<=s||n?.type==="block-map"||n?.type==="block-seq")&&r(h,"TAB_AS_INDENT","Tabs are not allowed as indentation"),{comma:k,found:S,spaceBefore:l,comment:d,hasNewline:u,anchor:g,tag:b,newlineAfterProp:y,end:L,start:N??L}}var Ut=T(()=>{});function Pe(o){if(!o)return null;switch(o.type){case"alias":case"scalar":case"double-quoted-scalar":case"single-quoted-scalar":if(o.source.includes(`
`))return!0;if(o.end){for(let e of o.end)if(e.type==="newline")return!0}return!1;case"flow-collection":for(let e of o.items){for(let t of e.start)if(t.type==="newline")return!0;if(e.sep){for(let t of e.sep)if(t.type==="newline")return!0}if(Pe(e.key)||Pe(e.value))return!0}return!1;default:return!0}}var Un=T(()=>{});function Bt(o,e,t){if(e?.type==="flow-collection"){let n=e.end[0];n.indent===o&&(n.source==="]"||n.source==="}")&&Pe(e)&&t(n,"BAD_INDENT","Flow end indicator should be more indented than parent",!0)}}var _a=T(()=>{Un()});function Bn(o,e,t){let{uniqueKeys:n}=o.options;if(n===!1)return!1;let a=typeof n=="function"?n:(r,s)=>r===s||D(r)&&D(s)&&r.value===s.value;return e.some(r=>a(r.key,t))}var Va=T(()=>{B()});function Kr({composeNode:o,composeEmptyNode:e},t,n,a,r){let s=r?.nodeClass??V,i=new s(t.schema);t.atRoot&&(t.atRoot=!1);let l=n.offset,c=null;for(let f of n.items){let{start:d,key:p,sep:u,value:m}=f,h=ke(d,{indicator:"explicit-key-ind",next:p??u?.[0],offset:l,onError:a,parentIndent:n.indent,startOnNewline:!0}),g=!h.found;if(g){if(p&&(p.type==="block-seq"?a(l,"BLOCK_AS_IMPLICIT_KEY","A block sequence may not be used as an implicit map key"):"indent"in p&&p.indent!==n.indent&&a(l,"BAD_INDENT",Vr)),!h.anchor&&!h.tag&&!u){c=h.end,h.comment&&(i.comment?i.comment+=`
`+h.comment:i.comment=h.comment);continue}(h.newlineAfterProp||Pe(p))&&a(p??d[d.length-1],"MULTILINE_IMPLICIT_KEY","Implicit keys need to be on a single line")}else h.found?.indent!==n.indent&&a(l,"BAD_INDENT",Vr);t.atKey=!0;let b=h.end,y=p?o(t,p,h,a):e(t,b,d,null,h,a);t.schema.compat&&Bt(n.indent,p,a),t.atKey=!1,Bn(t,i.items,y)&&a(b,"DUPLICATE_KEY","Map keys must be unique");let k=ke(u??[],{indicator:"map-value-ind",next:m,offset:y.range[2],onError:a,parentIndent:n.indent,startOnNewline:!p||p.type==="block-scalar"});if(l=k.end,k.found){g&&(m?.type==="block-map"&&!k.hasNewline&&a(l,"BLOCK_AS_IMPLICIT_KEY","Nested mappings are not allowed in compact mappings"),t.options.strict&&h.start<k.found.offset-1024&&a(y.range,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit block mapping key"));let S=m?o(t,m,k,a):e(t,l,u,null,k,a);t.schema.compat&&Bt(n.indent,m,a),l=S.range[2];let N=new _(y,S);t.options.keepSourceTokens&&(N.srcToken=f),i.items.push(N)}else{g&&a(y.range,"MISSING_CHAR","Implicit map keys need to be followed by map values"),k.comment&&(y.comment?y.comment+=`
`+k.comment:y.comment=k.comment);let S=new _(y);t.options.keepSourceTokens&&(S.srcToken=f),i.items.push(S)}}return c&&c<l&&a(c,"IMPOSSIBLE","Map comment with trailing content"),i.range=[n.offset,l,c??l],i}var Vr,Wr=T(()=>{Ae();Oe();Ut();Un();_a();Va();Vr="All mapping items must start at the same column"});function Gr({composeNode:o,composeEmptyNode:e},t,n,a,r){let s=r?.nodeClass??z,i=new s(t.schema);t.atRoot&&(t.atRoot=!1),t.atKey&&(t.atKey=!1);let l=n.offset,c=null;for(let{start:f,value:d}of n.items){let p=ke(f,{indicator:"seq-item-ind",next:d,offset:l,onError:a,parentIndent:n.indent,startOnNewline:!0});if(!p.found)if(p.anchor||p.tag||d)d?.type==="block-seq"?a(p.end,"BAD_INDENT","All sequence items must start at the same column"):a(l,"MISSING_CHAR","Sequence item without - indicator");else{c=p.end,p.comment&&(i.comment=p.comment);continue}let u=d?o(t,d,p,a):e(t,p.end,f,null,p,a);t.schema.compat&&Bt(n.indent,d,a),l=u.range[2],i.items.push(u)}return i.range=[n.offset,l,c??l],i}var zr=T(()=>{Re();Ut();_a()});function ve(o,e,t,n){let a="";if(o){let r=!1,s="";for(let i of o){let{source:l,type:c}=i;switch(c){case"space":r=!0;break;case"comment":{t&&!r&&n(i,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");let f=l.substring(1)||" ";a?a+=s+f:a=f,s="";break}case"newline":a&&(s+=l),r=!0;break;default:n(i,"UNEXPECTED_TOKEN",`Unexpected ${c} at node end`)}e+=l.length}}return{comment:a,offset:e}}var lt=T(()=>{});function Jr({composeNode:o,composeEmptyNode:e},t,n,a,r){let s=n.start.source==="{",i=s?"flow map":"flow sequence",l=r?.nodeClass??(s?V:z),c=new l(t.schema);c.flow=!0;let f=t.atRoot;f&&(t.atRoot=!1),t.atKey&&(t.atKey=!1);let d=n.offset+n.start.source.length;for(let g=0;g<n.items.length;++g){let b=n.items[g],{start:y,key:k,sep:S,value:N}=b,x=ke(y,{flow:i,indicator:"explicit-key-ind",next:k??S?.[0],offset:d,onError:a,parentIndent:n.indent,startOnNewline:!1});if(!x.found){if(!x.anchor&&!x.tag&&!S&&!N){g===0&&x.comma?a(x.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${i}`):g<n.items.length-1&&a(x.start,"UNEXPECTED_TOKEN",`Unexpected empty item in ${i}`),x.comment&&(c.comment?c.comment+=`
`+x.comment:c.comment=x.comment),d=x.end;continue}!s&&t.options.strict&&Pe(k)&&a(k,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line")}if(g===0)x.comma&&a(x.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${i}`);else if(x.comma||a(x.start,"MISSING_CHAR",`Missing , between ${i} items`),x.comment){let L="";e:for(let w of y)switch(w.type){case"comma":case"space":break;case"comment":L=w.source.substring(1);break e;default:break e}if(L){let w=c.items[c.items.length-1];R(w)&&(w=w.value??w.key),w.comment?w.comment+=`
`+L:w.comment=L,x.comment=x.comment.substring(L.length+1)}}if(!s&&!S&&!x.found){let L=N?o(t,N,x,a):e(t,x.end,S,null,x,a);c.items.push(L),d=L.range[2],Wa(N)&&a(L.range,"BLOCK_IN_FLOW",Ka)}else{t.atKey=!0;let L=x.end,w=k?o(t,k,x,a):e(t,L,y,null,x,a);Wa(k)&&a(w.range,"BLOCK_IN_FLOW",Ka),t.atKey=!1;let v=ke(S??[],{flow:i,indicator:"map-value-ind",next:N,offset:w.range[2],onError:a,parentIndent:n.indent,startOnNewline:!1});if(v.found){if(!s&&!x.found&&t.options.strict){if(S)for(let F of S){if(F===v.found)break;if(F.type==="newline"){a(F,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line");break}}x.start<v.found.offset-1024&&a(v.found,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit flow sequence key")}}else N&&("source"in N&&N.source?.[0]===":"?a(N,"MISSING_CHAR",`Missing space after : in ${i}`):a(v.start,"MISSING_CHAR",`Missing , or : between ${i} items`));let E=N?o(t,N,v,a):v.found?e(t,v.end,S,null,v,a):null;E?Wa(N)&&a(E.range,"BLOCK_IN_FLOW",Ka):v.comment&&(w.comment?w.comment+=`
`+v.comment:w.comment=v.comment);let M=new _(w,E);if(t.options.keepSourceTokens&&(M.srcToken=b),s){let F=c;Bn(t,F.items,w)&&a(L,"DUPLICATE_KEY","Map keys must be unique"),F.items.push(M)}else{let F=new V(t.schema);F.flow=!0,F.items.push(M);let P=(E??w).range;F.range=[w.range[0],P[1],P[2]],c.items.push(F)}d=E?E.range[2]:v.end}}let p=s?"}":"]",[u,...m]=n.end,h=d;if(u?.source===p)h=u.offset+u.source.length;else{let g=i[0].toUpperCase()+i.substring(1),b=f?`${g} must end with a ${p}`:`${g} in block collection must be sufficiently indented and end with a ${p}`;a(d,f?"MISSING_CHAR":"BAD_INDENT",b),u&&u.source.length!==1&&m.unshift(u)}if(m.length>0){let g=ve(m,h,t.options.strict,a);g.comment&&(c.comment?c.comment+=`
`+g.comment:c.comment=g.comment),c.range=[n.offset,h,g.offset]}else c.range=[n.offset,h,h];return c}var Ka,Wa,Xr=T(()=>{B();Ae();Oe();Re();lt();Ut();Un();Va();Ka="Block collections are not allowed within flow collections",Wa=o=>o&&(o.type==="block-map"||o.type==="block-seq")});function Ga(o,e,t,n,a,r){let s=t.type==="block-map"?Kr(o,e,t,n,r):t.type==="block-seq"?Gr(o,e,t,n,r):Jr(o,e,t,n,r),i=s.constructor;return a==="!"||a===i.tagName?(s.tag=i.tagName,s):(a&&(s.tag=a),s)}function Zr(o,e,t,n,a){let r=n.tag,s=r?e.directives.tagName(r.source,p=>a(r,"TAG_RESOLVE_FAILED",p)):null;if(t.type==="block-seq"){let{anchor:p,newlineAfterProp:u}=n,m=p&&r?p.offset>r.offset?p:r:p??r;m&&(!u||u.offset<m.offset)&&a(m,"MISSING_CHAR","Missing newline after block sequence props")}let i=t.type==="block-map"?"map":t.type==="block-seq"?"seq":t.start.source==="{"?"map":"seq";if(!r||!s||s==="!"||s===V.tagName&&i==="map"||s===z.tagName&&i==="seq")return Ga(o,e,t,a,s);let l=e.schema.tags.find(p=>p.tag===s&&p.collection===i);if(!l){let p=e.schema.knownTags[s];if(p?.collection===i)e.schema.tags.push(Object.assign({},p,{default:!1})),l=p;else return p?a(r,"BAD_COLLECTION_TYPE",`${p.tag} used for ${i} collection, but expects ${p.collection??"scalar"}`,!0):a(r,"TAG_RESOLVE_FAILED",`Unresolved tag: ${s}`,!0),Ga(o,e,t,a,s)}let c=Ga(o,e,t,a,s,l),f=l.resolve?.(c,p=>a(r,"TAG_RESOLVE_FAILED",p),e.options)??c,d=I(f)?f:new C(f);return d.range=c.range,d.tag=s,l?.format&&(d.format=l.format),d}var Yr=T(()=>{B();K();Oe();Re();Wr();zr();Xr()});function qn(o,e,t){let n=e.offset,a=qi(e,o.options.strict,t);if(!a)return{value:"",type:null,comment:"",range:[n,n,n]};let r=a.mode===">"?C.BLOCK_FOLDED:C.BLOCK_LITERAL,s=e.source?Hi(e.source):[],i=s.length;for(let h=s.length-1;h>=0;--h){let g=s[h][1];if(g===""||g==="\r")i=h;else break}if(i===0){let h=a.chomp==="+"&&s.length>0?`
`.repeat(Math.max(1,s.length-1)):"",g=n+a.length;return e.source&&(g+=e.source.length),{value:h,type:r,comment:a.comment,range:[n,g,g]}}let l=e.indent+a.indent,c=e.offset+a.length,f=0;for(let h=0;h<i;++h){let[g,b]=s[h];if(b===""||b==="\r")a.indent===0&&g.length>l&&(l=g.length);else{g.length<l&&t(c+g.length,"MISSING_CHAR","Block scalars with more-indented leading empty lines must use an explicit indentation indicator"),a.indent===0&&(l=g.length),f=h,l===0&&!o.atRoot&&t(c,"BAD_INDENT","Block scalar values in collections must be indented");break}c+=g.length+b.length+1}for(let h=s.length-1;h>=i;--h)s[h][0].length>l&&(i=h+1);let d="",p="",u=!1;for(let h=0;h<f;++h)d+=s[h][0].slice(l)+`
`;for(let h=f;h<i;++h){let[g,b]=s[h];c+=g.length+b.length+1;let y=b[b.length-1]==="\r";if(y&&(b=b.slice(0,-1)),b&&g.length<l){let S=`Block scalar lines must not be less indented than their ${a.indent?"explicit indentation indicator":"first line"}`;t(c-b.length-(y?2:1),"BAD_INDENT",S),g=""}r===C.BLOCK_LITERAL?(d+=p+g.slice(l)+b,p=`
`):g.length>l||b[0]==="	"?(p===" "?p=`
`:!u&&p===`
`&&(p=`
...
`?d+=`
`:p=`
`:(d+=p+b,p=" ",u=!1)}switch(a.chomp){case"-":break;case"+":for(let h=i;h<s.length;++h)d+=`
`+s[h][0].slice(l);d[d.length-1]!==`
`&&(d+=`
`);break;default:d+=`
`}let m=n+a.length+e.source.length;return{value:d,type:r,comment:a.comment,range:[n,m,m]}}function qi({offset:o,props:e},t,n){if(e[0].type!=="block-scalar-header")return n(e[0],"IMPOSSIBLE","Block scalar header not found"),null;let{source:a}=e[0],r=a[0],s=0,i="",l=-1;for(let p=1;p<a.length;++p){let u=a[p];if(!i&&(u==="-"||u==="+"))i=u;else{let m=Number(u);!s&&m?s=m:l===-1&&(l=o+p)}}l!==-1&&n(l,"UNEXPECTED_TOKEN",`Block scalar header includes extra characters: ${a}`);let c=!1,f="",d=a.length;for(let p=1;p<e.length;++p){let u=e[p];switch(u.type){case"space":c=!0;case"newline":d+=u.source.length;break;case"comment":t&&!c&&n(u,"MISSING_CHAR","Comments must be separated from other tokens by white space characters"),d+=u.source.length,f=u.source.substring(1);break;case"error":n(u,"UNEXPECTED_TOKEN",u.message),d+=u.source.length;break;default:{let m=`Unexpected token in block scalar header: ${u.type}`;n(u,"UNEXPECTED_TOKEN",m);let h=u.source;h&&typeof h=="string"&&(d+=h.length)}}}return{mode:r,indent:s,chomp:i,comment:f,length:d}}function Hi(o){let e=o.split(/\n( *)/),t=e[0],n=t.match(/^( *)/),r=[n?.[1]?[n[1],t.slice(n[1].length)]:["",t]];for(let s=1;s<e.length;s+=2)r.push([e[s],e[s+1]]);return r}var za=T(()=>{K()});function Hn(o,e,t){let{offset:n,type:a,source:r,end:s}=o,i,l,c=(p,u,m)=>t(n+p,u,m);switch(a){case"scalar":i=C.PLAIN,l=ji(r,c);break;case"single-quoted-scalar":i=C.QUOTE_SINGLE,l=_i(r,c);break;case"double-quoted-scalar":i=C.QUOTE_DOUBLE,l=Vi(r,c);break;default:return t(o,"UNEXPECTED_TOKEN",`Expected a flow scalar value, but found: ${a}`),{value:"",type:null,comment:"",range:[n,n+r.length,n+r.length]}}let f=n+r.length,d=ve(s,f,e,t);return{value:l,type:i,comment:d.comment,range:[n,f,d.offset]}}function ji(o,e){let t="";switch(o[0]){case"	":t="a tab character";break;case",":t="flow indicator character ,";break;case"%":t="directive indicator character %";break;case"|":case">":{t=`block scalar indicator ${o[0]}`;break}case"@":case"`":{t=`reserved character ${o[0]}`;break}}return t&&e(0,"BAD_SCALAR_START",`Plain value cannot start with ${t}`),Qr(o)}function _i(o,e){return(o[o.length-1]!=="'"||o.length===1)&&e(o.length,"MISSING_CHAR","Missing closing 'quote"),Qr(o.slice(1,-1)).replace(/''/g,"'")}function Qr(o){let e,t;try{e=new RegExp(`(.*?)(?<![ 	])[ 	]*\r?
`,"sy"),t=new RegExp(`[ 	]*(.*?)(?:(?<![ 	])[ 	]*)?\r?
`,"sy")}catch{e=/(.*?)[ \t]*\r?\n/sy,t=/[ \t]*(.*?)[ \t]*\r?\n/sy}let n=e.exec(o);if(!n)return o;let a=n[1],r=" ",s=e.lastIndex;for(t.lastIndex=s;n=t.exec(o);)n[1]===""?r===`
`?a+=r:r=`
`:(a+=r+n[1],r=" "),s=t.lastIndex;let i=/[ \t]*(.*)/sy;return i.lastIndex=s,n=i.exec(o),a+r+(n?.[1]??"")}function Vi(o,e){let t="";for(let n=1;n<o.length-1;++n){let a=o[n];if(!(a==="\r"&&o[n+1]===`
`))if(a===`
`){let{fold:r,offset:s}=Ki(o,n);t+=r,n=s}else if(a==="\\"){let r=o[++n],s=Wi[r];if(s)t+=s;else if(r===`
`)for(r=o[n+1];r===" "||r==="	";)r=o[++n+1];else if(r==="\r"&&o[n+1]===`
`)for(r=o[++n+1];r===" "||r==="	";)r=o[++n+1];else if(r==="x"||r==="u"||r==="U"){let i=r==="x"?2:r==="u"?4:8;t+=Gi(o,n+1,i,e),n+=i}else{let i=o.substr(n-1,2);e(n-1,"BAD_DQ_ESCAPE",`Invalid escape sequence ${i}`),t+=i}}else if(a===" "||a==="	"){let r=n,s=o[n+1];for(;s===" "||s==="	";)s=o[++n+1];s!==`
`&&!(s==="\r"&&o[n+2]===`
`)&&(t+=n>r?o.slice(r,n+1):a)}else t+=a}return(o[o.length-1]!=='"'||o.length===1)&&e(o.length,"MISSING_CHAR",'Missing closing "quote'),t}function Ki(o,e){let t="",n=o[e+1];for(;(n===" "||n==="	"||n===`
`||n==="\r")&&!(n==="\r"&&o[e+2]!==`
`);)n===`
`&&(t+=`
`),e+=1,n=o[e+1];return t||(t=" "),{fold:t,offset:e}}function Gi(o,e,t,n){let a=o.substr(e,t),s=a.length===t&&/^[0-9a-fA-F]+$/.test(a)?parseInt(a,16):NaN;try{return String.fromCodePoint(s)}catch{let i=o.substr(e-2,t+2);return n(e-2,"BAD_DQ_ESCAPE",`Invalid escape sequence ${i}`),i}}var Wi,Ja=T(()=>{K();lt();Wi={0:"\0",a:"\x07",b:"\b",e:"\x1B",f:"\f",n:`
`,r:"\r",t:"	",v:"\v",N:"\x85",_:"\xA0",L:"\u2028",P:"\u2029"," ":" ",'"':'"',"/":"/","\\":"\\","	":"	"}});function Xa(o,e,t,n){let{value:a,type:r,comment:s,range:i}=e.type==="block-scalar"?qn(o,e,n):Hn(e,o.options.strict,n),l=t?o.directives.tagName(t.source,d=>n(t,"TAG_RESOLVE_FAILED",d)):null,c;o.options.stringKeys&&o.atKey?c=o.schema[ee]:l?c=zi(o.schema,a,l,t,n):e.type==="scalar"?c=Ji(o,a,e,n):c=o.schema[ee];let f;try{let d=c.resolve(a,p=>n(t??e,"TAG_RESOLVE_FAILED",p),o.options);f=D(d)?d:new C(d)}catch(d){let p=d instanceof Error?d.message:String(d);n(t??e,"TAG_RESOLVE_FAILED",p),f=new C(a)}return f.range=i,f.source=a,r&&(f.type=r),l&&(f.tag=l),c.format&&(f.format=c.format),s&&(f.comment=s),f}function zi(o,e,t,n,a){if(t==="!")return o[ee];let r=[];for(let i of o.tags)if(!i.collection&&i.tag===t)if(i.default&&i.test)r.push(i);else return i;for(let i of r)if(i.test?.test(e))return i;let s=o.knownTags[t];return s&&!s.collection?(o.tags.push(Object.assign({},s,{default:!1,test:void 0})),s):(a(n,"TAG_RESOLVE_FAILED",`Unresolved tag: ${t}`,t!=="tag:yaml.org,2002:str"),o[ee])}function Ji({atKey:o,directives:e,schema:t},n,a,r){let s=t.tags.find(i=>(i.default===!0||o&&i.default==="key")&&i.test?.test(n))||t[ee];if(t.compat){let i=t.compat.find(l=>l.default&&l.test?.test(n))??t[ee];if(s.tag!==i.tag){let l=e.tagString(s.tag),c=e.tagString(i.tag),f=`Value may be parsed as either ${l} or ${c}`;r(a,"TAG_RESOLVE_FAILED",f,!0)}}return s}var $r=T(()=>{B();K();za();Ja()});function es(o,e,t){if(e){t??(t=e.length);for(let n=t-1;n>=0;--n){let a=e[n];switch(a.type){case"space":case"comment":case"newline":o-=a.source.length;continue}for(a=e[++n];a?.type==="space";)o+=a.source.length,a=e[++n];break}}return o}var ts=T(()=>{});function Za(o,e,t,n){let a=o.atKey,{spaceBefore:r,comment:s,anchor:i,tag:l}=t,c,f=!0;switch(e.type){case"alias":c=Zi(o,e,n),(i||l)&&n(e,"ALIAS_PROPS","An alias node must not specify any properties");break;case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":case"block-scalar":c=Xa(o,e,l,n),i&&(c.anchor=i.source.substring(1));break;case"block-map":case"block-seq":case"flow-collection":try{c=Zr(Xi,o,e,t,n),i&&(c.anchor=i.source.substring(1))}catch(d){let p=d instanceof Error?d.message:String(d);n(e,"RESOURCE_EXHAUSTION",p)}break;default:{let d=e.type==="error"?e.message:`Unsupported token (type: ${e.type})`;n(e,"UNEXPECTED_TOKEN",d),f=!1}}return c??(c=jn(o,e.offset,void 0,null,t,n)),i&&c.anchor===""&&n(i,"BAD_ALIAS","Anchor cannot be an empty string"),a&&o.options.stringKeys&&(!D(c)||typeof c.value!="string"||c.tag&&c.tag!=="tag:yaml.org,2002:str")&&n(l??e,"NON_STRING_KEY","With stringKeys, all keys must be strings"),r&&(c.spaceBefore=!0),s&&(e.type==="scalar"&&e.source===""?c.comment=s:c.commentBefore=s),o.options.keepSourceTokens&&f&&(c.srcToken=e),c}function jn(o,e,t,n,{spaceBefore:a,comment:r,anchor:s,tag:i,end:l},c){let f={type:"scalar",offset:es(e,t,n),indent:-1,source:""},d=Xa(o,f,i,c);return s&&(d.anchor=s.source.substring(1),d.anchor===""&&c(s,"BAD_ALIAS","Anchor cannot be an empty string")),a&&(d.spaceBefore=!0),r&&(d.comment=r,d.range[2]=l),d}function Zi({options:o},{offset:e,source:t,end:n},a){let r=new de(t.substring(1));r.source===""&&a(e,"BAD_ALIAS","Alias cannot be an empty string"),r.source.endsWith(":")&&a(e+t.length-1,"BAD_ALIAS","Alias ending in : is ambiguous",!0);let s=e+t.length,i=ve(n,s,o.strict,a);return r.range=[e,s,i.offset],i.comment&&(r.comment=i.comment),r}var Xi,ns=T(()=>{bt();B();Yr();$r();lt();ts();Xi={composeNode:Za,composeEmptyNode:jn}});function as(o,e,{offset:t,start:n,value:a,end:r},s){let i=Object.assign({_directives:e},o),l=new he(void 0,i),c={atKey:!1,atRoot:!0,directives:l.directives,options:l.options,schema:l.schema},f=ke(n,{indicator:"doc-start",next:a??r?.[0],offset:t,onError:s,parentIndent:0,startOnNewline:!0});f.found&&(l.directives.docStart=!0,a&&(a.type==="block-map"||a.type==="block-seq")&&!f.hasNewline&&s(f.end,"MISSING_CHAR","Block collection cannot start on same line with directives-end marker")),l.contents=a?Za(c,a,f,s):jn(c,f.end,n,null,f,s);let d=l.contents.range[2],p=ve(r,d,!1,s);return p.comment&&(l.comment=p.comment),l.range=[t,d,p.offset],l}var os=T(()=>{Rt();ns();lt();Ut()});function qt(o){if(typeof o=="number")return[o,o+1];if(Array.isArray(o))return o.length===2?o:[o[0],o[1]];let{offset:e,source:t}=o;return[e,e+(typeof t=="string"?t.length:1)]}function rs(o){let e="",t=!1,n=!1;for(let a=0;a<o.length;++a){let r=o[a];switch(r[0]){case"#":e+=(e===""?"":n?`

`:`
`)+(r.substring(1)||" "),t=!0,n=!1;break;case"%":o[a+1]?.[0]!=="#"&&(a+=1),t=!1;break;default:t||(n=!0),t=!1}}return{comment:e,afterEmptyLine:n}}var Ue,Ya=T(()=>{ha();Rt();Pt();B();os();lt();Ue=class{constructor(e={}){this.doc=null,this.atDirectives=!1,this.prelude=[],this.errors=[],this.warnings=[],this.onError=(t,n,a,r)=>{let s=qt(t);r?this.warnings.push(new We(s,n,a)):this.errors.push(new Q(s,n,a))},this.directives=new be({version:e.version||"1.2"}),this.options=e}decorate(e,t){let{comment:n,afterEmptyLine:a}=rs(this.prelude);if(n){let r=e.contents;if(t)e.comment=e.comment?`${e.comment}
${n}`:n;else if(a||e.directives.docStart||!r)e.commentBefore=n;else if(q(r)&&!r.flow&&r.items.length>0){let s=r.items[0];R(s)&&(s=s.key);let i=s.commentBefore;s.commentBefore=i?`${n}
...
`};delete o.items,Object.assign(o,{type:t,source:e,end:[a]});break}default:{let n="indent"in o?o.indent:-1,a="end"in o&&Array.isArray(o.end)?o.end.filter(r=>r.type==="space"||r.type==="comment"||r.type==="newline"):[];for(let r of Object.keys(o))r!=="type"&&r!=="offset"&&delete o[r];Object.assign(o,{type:t,indent:n,source:e,end:a})}}}var ds=T(()=>{za();Ja();Pt();Nt()});function Vn(o){switch(o.type){case"block-scalar":{let e="";for(let t of o.props)e+=Vn(t);return e+o.source}case"block-map":case"block-seq":{let e="";for(let t of o.items)e+=_n(t);return e}case"flow-collection":{let e=o.start.source;for(let t of o.items)e+=_n(t);for(let t of o.end)e+=t.source;return e}case"document":{let e=_n(o);if(o.end)for(let t of o.end)e+=t.source;return e}default:{let e=o.source;if("end"in o&&o.end)for(let t of o.end)e+=t.source;return e}}}function _n({start:o,key:e,sep:t,value:n}){let a="";for(let r of o)a+=r.source;if(e&&(a+=Vn(e)),t)for(let r of t)a+=r.source;return n&&(a+=Vn(n)),a}var fs,ps=T(()=>{fs=o=>"type"in o?Vn(o):_n(o)});function Be(o,e){"type"in o&&o.type==="document"&&(o={start:o.start,value:o.value}),hs(Object.freeze([]),o,e)}function hs(o,e,t){let n=t(e,o);if(typeof n=="symbol")return n;for(let a of["key","value"]){let r=e[a];if(r&&"items"in r){for(let s=0;s<r.items.length;++s){let i=hs(Object.freeze(o.concat([[a,s]])),r.items[s],t);if(typeof i=="number")s=i-1;else{if(i===$a)return $a;i===us&&(r.items.splice(s,1),s-=1)}}typeof n=="function"&&a==="key"&&(n=n(e,o))}}return typeof n=="function"?n(e,o):n}var $a,Qi,us,ms=T(()=>{$a=Symbol("break visit"),Qi=Symbol("skip children"),us=Symbol("remove item");Be.BREAK=$a;Be.SKIP=Qi;Be.REMOVE=us;Be.itemAtPath=(o,e)=>{let t=o;for(let[n,a]of e){let r=t?.[n];if(r&&"items"in r)t=r.items[a];else return}return t};Be.parentCollection=(o,e)=>{let t=Be.itemAtPath(o,e.slice(0,-1)),n=e[e.length-1][0],a=t?.[n];if(a&&"items"in a)return a;throw new Error("Parent collection not found")}});var Kn={};sa(Kn,{BOM:()=>Ht,DOCUMENT:()=>jt,FLOW_END:()=>_t,SCALAR:()=>ct,createScalarToken:()=>is,isCollection:()=>$i,isScalar:()=>el,prettyToken:()=>tl,resolveAsScalar:()=>ss,setScalarValue:()=>ls,stringify:()=>fs,tokenType:()=>eo,visit:()=>Be});function tl(o){switch(o){case Ht:return"<BOM>";case jt:return"<DOC>";case _t:return"<FLOW_END>";case ct:return"<SCALAR>";default:return JSON.stringify(o)}}function eo(o){switch(o){case Ht:return"byte-order-mark";case jt:return"doc-mode";case _t:return"flow-error-end";case ct:return"scalar";case"---":return"doc-start";case"...":return"doc-end";case"":case`
`:case`\r
`:return"newline";case"-":return"seq-item-ind";case"?":return"explicit-key-ind";case":":return"map-value-ind";case"{":return"flow-map-start";case"}":return"flow-map-end";case"[":return"flow-seq-start";case"]":return"flow-seq-end";case",":return"comma"}switch(o[0]){case" ":case"	":return"space";case"#":return"comment";case"%":return"directive-line";case"*":return"alias";case"&":return"anchor";case"!":return"tag";case"'":return"single-quoted-scalar";case'"':return"double-quoted-scalar";case"|":case">":return"block-scalar-header"}return null}var Ht,jt,_t,ct,$i,el,Wn=T(()=>{ds();ps();ms();Ht="\uFEFF",jt="",_t="",ct="",$i=o=>!!o&&"items"in o,el=o=>!!o&&(o.type==="scalar"||o.type==="single-quoted-scalar"||o.type==="double-quoted-scalar"||o.type==="block-scalar")});function me(o){switch(o){case void 0:case" ":case`
`:case"\r":case"	":return!0;default:return!1}}var gs,nl,Gn,al,to,Ge,no=T(()=>{Wn();gs=new Set("0123456789ABCDEFabcdef"),nl=new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),Gn=new Set(",[]{}"),al=new Set(` ,[]{}
\r	`),to=o=>!o||al.has(o),Ge=class{constructor(){this.atEnd=!1,this.blockScalarIndent=-1,this.blockScalarKeep=!1,this.buffer="",this.flowKey=!1,this.flowLevel=0,this.indentNext=0,this.indentValue=0,this.lineEndPos=null,this.next=null,this.pos=0}*lex(e,t=!1){if(e){if(typeof e!="string")throw TypeError("source is not a string");this.buffer=this.buffer?this.buffer+e:e,this.lineEndPos=null}this.atEnd=!t;let n=this.next??"stream";for(;n&&(t||this.hasChars(1));)n=yield*this.parseNext(n)}atLineEnd(){let e=this.pos,t=this.buffer[e];for(;t===" "||t==="	";)t=this.buffer[++e];return!t||t==="#"||t===`
