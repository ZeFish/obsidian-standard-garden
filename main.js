...
`&&h!=="	"){let x=o[u+1];x&&x!==" "&&x!==`
`&&x!=="	"&&(p=u)}if(u>=d)if(p)c.push(p),d=p+l,p=void 0;else if(t===St){for(;h===" "||h==="	";)h=w,w=o[u+=1],m=!0;let x=u>y+1?u-2:g-1;if(f[x])return o;c.push(x),f[x]=!0,d=x+l,p=void 0}else m=!0}h=w}if(m&&i&&i(),c.length===0)return o;r&&r();let b=o.slice(0,c[0]);for(let w=0;w<c.length;++w){let x=c[w],v=c[w+1]||o.length;x===0?b=`
${e}${o.slice(0,v)}`:(t===St&&f[x]&&(b+=`${o[x]}\\`),b+=`
${e}${o.slice(x+1,v)}`)}return b}function gs(o,e,t){let n=e,a=e+1,s=o[a];for(;s===" "||s==="	";)if(e<a+t)s=o[++e];else{do s=o[++e];while(s&&s!==`
`);n=e,a=e+1,s=o[a]}return n}var ba,fn,St,ys=E(()=>{ba="flow",fn="block",St="quoted"});function Bi(o,e,t){if(!e||e<0)return!1;let n=e-t,a=o.length;if(a<=n)return!1;for(let s=0,r=0;s<a;++s)if(o[s]===`
...
`&&(h=h.slice(0,-1)),h=h.replace(ka,`$&${c}`));let u=!1,g,y=-1;for(g=0;g<t.length;++g){let v=t[g];if(v===" ")u=!0;else if(v===`
`)y=g;else break}let b=t.substring(0,y<g?y+1:g);b&&(t=t.substring(b.length),b=b.replace(/\n+/g,`$&${c}`));let x=(u?c?"2":"1":"")+d;if(o&&(x+=" "+i(o.replace(/ ?[\r\n]+/g," ")),a&&a()),!f){let v=t.replace(/\n+/g,`
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${c}`),S=!1,N=un(n,!0);r!=="folded"&&e!==C.BLOCK_FOLDED&&(N.onOverflow=()=>{S=!0});let k=xt(`${b}${v}${h}`,c,fn,N);if(!S)return`>${x}
...
${l}`);if(r){let p=u=>u.default&&u.tag!=="tag:yaml.org,2002:str"&&u.test?.test(d),{compat:h,tags:m}=e.doc.schema;if(m.some(p)||h?.some(p))return $e(s,e)}return i?d:xt(d,l,ba,un(e,!1))}function Ne(o,e,t,n){let{implicitKey:a,inFlow:s}=e,r=typeof o.value=="string"?o:Object.assign({},o,{value:String(o.value)}),{type:i}=o;i!==C.QUOTE_DOUBLE&&/[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(r.value)&&(i=C.QUOTE_DOUBLE);let l=f=>{switch(f){case C.BLOCK_FOLDED:case C.BLOCK_LITERAL:return a||s?$e(r.value,e):pn(r,e,t,n);case C.QUOTE_DOUBLE:return Tt(r.value,e);case C.QUOTE_SINGLE:return wa(r.value,e);case C.PLAIN:return qi(r,e,t,n);default:return null}},c=l(i);if(c===null){let{defaultKeyType:f,defaultStringType:d}=e.options,p=a&&f||d;if(c=l(p),c===null)throw new Error(`Unsupported default string type ${p}`)}return c}var un,hn,ka,Nt=E(()=>{K();ys();un=(o,e)=>({indentAtStart:e?o.indent.length:o.indentAtStart,lineWidth:o.options.lineWidth,minContentWidth:o.options.minContentWidth}),hn=o=>/^(%|---|\.\.\.)/m.test(o);try{ka=new RegExp(`(^|(?<!
))
+(?!
...
${r}
${c}
`}}});function ke(o,{flow:e,indicator:t,next:n,offset:a,onError:s,parentIndent:r,startOnNewline:i}){let l=!1,c=i,f=i,d="",p="",h=!1,m=!1,u=null,g=null,y=null,b=null,w=null,x=null,v=null;for(let k of o)switch(m&&(k.type!=="space"&&k.type!=="newline"&&k.type!=="comma"&&s(k.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),m=!1),u&&(c&&k.type!=="comment"&&k.type!=="newline"&&s(u,"TAB_AS_INDENT","Tabs are not allowed as indentation"),u=null),k.type){case"space":!e&&(t!=="doc-start"||n?.type!=="flow-collection")&&k.source.includes("	")&&(u=k),f=!0;break;case"comment":{f||s(k,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");let T=k.source.substring(1)||" ";d?d+=p+T:d=T,p="",c=!1;break}case"newline":c?d?d+=k.source:(!x||t!=="seq-item-ind")&&(l=!0):p+=k.source,c=!0,h=!0,(g||y)&&(b=k),f=!0;break;case"anchor":g&&s(k,"MULTIPLE_ANCHORS","A node can have at most one anchor"),k.source.endsWith(":")&&s(k.offset+k.source.length-1,"BAD_ALIAS","Anchor ending in : is ambiguous",!0),g=k,v??(v=k.offset),c=!1,f=!1,m=!0;break;case"tag":{y&&s(k,"MULTIPLE_TAGS","A node can have at most one tag"),y=k,v??(v=k.offset),c=!1,f=!1,m=!0;break}case t:(g||y)&&s(k,"BAD_PROP_ORDER",`Anchors and tags must be after the ${k.source} indicator`),x&&s(k,"UNEXPECTED_TOKEN",`Unexpected ${k.source} in ${e??"collection"}`),x=k,c=t==="seq-item-ind"||t==="explicit-key-ind",f=!1;break;case"comma":if(e){w&&s(k,"UNEXPECTED_TOKEN",`Unexpected , in ${e}`),w=k,c=!1,f=!1;break}default:s(k,"UNEXPECTED_TOKEN",`Unexpected ${k.type} token`),c=!1,f=!1}let S=o[o.length-1],N=S?S.offset+S.source.length:a;return m&&n&&n.type!=="space"&&n.type!=="newline"&&n.type!=="comma"&&(n.type!=="scalar"||n.source!=="")&&s(n.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),u&&(c&&u.indent<=r||n?.type==="block-map"||n?.type==="block-seq")&&s(u,"TAB_AS_INDENT","Tabs are not allowed as indentation"),{comma:w,found:x,spaceBefore:l,comment:d,hasNewline:h,anchor:g,tag:y,newlineAfterProp:b,end:N,start:v??N}}var Ut=E(()=>{});function Pe(o){if(!o)return null;switch(o.type){case"alias":case"scalar":case"double-quoted-scalar":case"single-quoted-scalar":if(o.source.includes(`
`))return!0;if(o.end){for(let e of o.end)if(e.type==="newline")return!0}return!1;case"flow-collection":for(let e of o.items){for(let t of e.start)if(t.type==="newline")return!0;if(e.sep){for(let t of e.sep)if(t.type==="newline")return!0}if(Pe(e.key)||Pe(e.value))return!0}return!1;default:return!0}}var Un=E(()=>{});function Bt(o,e,t){if(e?.type==="flow-collection"){let n=e.end[0];n.indent===o&&(n.source==="]"||n.source==="}")&&Pe(e)&&t(n,"BAD_INDENT","Flow end indicator should be more indented than parent",!0)}}var ja=E(()=>{Un()});function Bn(o,e,t){let{uniqueKeys:n}=o.options;if(n===!1)return!1;let a=typeof n=="function"?n:(s,r)=>s===r||D(s)&&D(r)&&s.value===r.value;return e.some(s=>a(s.key,t))}var Va=E(()=>{q()});function Js({composeNode:o,composeEmptyNode:e},t,n,a,s){let r=s?.nodeClass??V,i=new r(t.schema);t.atRoot&&(t.atRoot=!1);let l=n.offset,c=null;for(let f of n.items){let{start:d,key:p,sep:h,value:m}=f,u=ke(d,{indicator:"explicit-key-ind",next:p??h?.[0],offset:l,onError:a,parentIndent:n.indent,startOnNewline:!0}),g=!u.found;if(g){if(p&&(p.type==="block-seq"?a(l,"BLOCK_AS_IMPLICIT_KEY","A block sequence may not be used as an implicit map key"):"indent"in p&&p.indent!==n.indent&&a(l,"BAD_INDENT",zs)),!u.anchor&&!u.tag&&!h){c=u.end,u.comment&&(i.comment?i.comment+=`
`+u.comment:i.comment=u.comment);continue}(u.newlineAfterProp||Pe(p))&&a(p??d[d.length-1],"MULTILINE_IMPLICIT_KEY","Implicit keys need to be on a single line")}else u.found?.indent!==n.indent&&a(l,"BAD_INDENT",zs);t.atKey=!0;let y=u.end,b=p?o(t,p,u,a):e(t,y,d,null,u,a);t.schema.compat&&Bt(n.indent,p,a),t.atKey=!1,Bn(t,i.items,b)&&a(y,"DUPLICATE_KEY","Map keys must be unique");let w=ke(h??[],{indicator:"map-value-ind",next:m,offset:b.range[2],onError:a,parentIndent:n.indent,startOnNewline:!p||p.type==="block-scalar"});if(l=w.end,w.found){g&&(m?.type==="block-map"&&!w.hasNewline&&a(l,"BLOCK_AS_IMPLICIT_KEY","Nested mappings are not allowed in compact mappings"),t.options.strict&&u.start<w.found.offset-1024&&a(b.range,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit block mapping key"));let x=m?o(t,m,w,a):e(t,l,h,null,w,a);t.schema.compat&&Bt(n.indent,m,a),l=x.range[2];let v=new j(b,x);t.options.keepSourceTokens&&(v.srcToken=f),i.items.push(v)}else{g&&a(b.range,"MISSING_CHAR","Implicit map keys need to be followed by map values"),w.comment&&(b.comment?b.comment+=`
`+w.comment:b.comment=w.comment);let x=new j(b);t.options.keepSourceTokens&&(x.srcToken=f),i.items.push(x)}}return c&&c<l&&a(c,"IMPOSSIBLE","Map comment with trailing content"),i.range=[n.offset,l,c??l],i}var zs,Xs=E(()=>{De();Oe();Ut();Un();ja();Va();zs="All mapping items must start at the same column"});function Zs({composeNode:o,composeEmptyNode:e},t,n,a,s){let r=s?.nodeClass??z,i=new r(t.schema);t.atRoot&&(t.atRoot=!1),t.atKey&&(t.atKey=!1);let l=n.offset,c=null;for(let{start:f,value:d}of n.items){let p=ke(f,{indicator:"seq-item-ind",next:d,offset:l,onError:a,parentIndent:n.indent,startOnNewline:!0});if(!p.found)if(p.anchor||p.tag||d)d?.type==="block-seq"?a(p.end,"BAD_INDENT","All sequence items must start at the same column"):a(l,"MISSING_CHAR","Sequence item without - indicator");else{c=p.end,p.comment&&(i.comment=p.comment);continue}let h=d?o(t,d,p,a):e(t,p.end,f,null,p,a);t.schema.compat&&Bt(n.indent,d,a),l=h.range[2],i.items.push(h)}return i.range=[n.offset,l,c??l],i}var Ys=E(()=>{Ie();Ut();ja()});function ve(o,e,t,n){let a="";if(o){let s=!1,r="";for(let i of o){let{source:l,type:c}=i;switch(c){case"space":s=!0;break;case"comment":{t&&!s&&n(i,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");let f=l.substring(1)||" ";a?a+=r+f:a=f,r="";break}case"newline":a&&(r+=l),s=!0;break;default:n(i,"UNEXPECTED_TOKEN",`Unexpected ${c} at node end`)}e+=l.length}}return{comment:a,offset:e}}var lt=E(()=>{});function Qs({composeNode:o,composeEmptyNode:e},t,n,a,s){let r=n.start.source==="{",i=r?"flow map":"flow sequence",l=s?.nodeClass??(r?V:z),c=new l(t.schema);c.flow=!0;let f=t.atRoot;f&&(t.atRoot=!1),t.atKey&&(t.atKey=!1);let d=n.offset+n.start.source.length;for(let g=0;g<n.items.length;++g){let y=n.items[g],{start:b,key:w,sep:x,value:v}=y,S=ke(b,{flow:i,indicator:"explicit-key-ind",next:w??x?.[0],offset:d,onError:a,parentIndent:n.indent,startOnNewline:!1});if(!S.found){if(!S.anchor&&!S.tag&&!x&&!v){g===0&&S.comma?a(S.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${i}`):g<n.items.length-1&&a(S.start,"UNEXPECTED_TOKEN",`Unexpected empty item in ${i}`),S.comment&&(c.comment?c.comment+=`
`+S.comment:c.comment=S.comment),d=S.end;continue}!r&&t.options.strict&&Pe(w)&&a(w,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line")}if(g===0)S.comma&&a(S.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${i}`);else if(S.comma||a(S.start,"MISSING_CHAR",`Missing , between ${i} items`),S.comment){let N="";e:for(let k of b)switch(k.type){case"comma":case"space":break;case"comment":N=k.source.substring(1);break e;default:break e}if(N){let k=c.items[c.items.length-1];R(k)&&(k=k.value??k.key),k.comment?k.comment+=`
`+N:k.comment=N,S.comment=S.comment.substring(N.length+1)}}if(!r&&!x&&!S.found){let N=v?o(t,v,S,a):e(t,S.end,x,null,S,a);c.items.push(N),d=N.range[2],Ga(v)&&a(N.range,"BLOCK_IN_FLOW",Ka)}else{t.atKey=!0;let N=S.end,k=w?o(t,w,S,a):e(t,N,b,null,S,a);Ga(w)&&a(k.range,"BLOCK_IN_FLOW",Ka),t.atKey=!1;let T=ke(x??[],{flow:i,indicator:"map-value-ind",next:v,offset:k.range[2],onError:a,parentIndent:n.indent,startOnNewline:!1});if(T.found){if(!r&&!S.found&&t.options.strict){if(x)for(let A of x){if(A===T.found)break;if(A.type==="newline"){a(A,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line");break}}S.start<T.found.offset-1024&&a(T.found,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit flow sequence key")}}else v&&("source"in v&&v.source?.[0]===":"?a(v,"MISSING_CHAR",`Missing space after : in ${i}`):a(T.start,"MISSING_CHAR",`Missing , or : between ${i} items`));let F=v?o(t,v,T,a):T.found?e(t,T.end,x,null,T,a):null;F?Ga(v)&&a(F.range,"BLOCK_IN_FLOW",Ka):T.comment&&(k.comment?k.comment+=`
`+T.comment:k.comment=T.comment);let M=new j(k,F);if(t.options.keepSourceTokens&&(M.srcToken=y),r){let A=c;Bn(t,A.items,k)&&a(N,"DUPLICATE_KEY","Map keys must be unique"),A.items.push(M)}else{let A=new V(t.schema);A.flow=!0,A.items.push(M);let U=(F??k).range;A.range=[k.range[0],U[1],U[2]],c.items.push(A)}d=F?F.range[2]:T.end}}let p=r?"}":"]",[h,...m]=n.end,u=d;if(h?.source===p)u=h.offset+h.source.length;else{let g=i[0].toUpperCase()+i.substring(1),y=f?`${g} must end with a ${p}`:`${g} in block collection must be sufficiently indented and end with a ${p}`;a(d,f?"MISSING_CHAR":"BAD_INDENT",y),h&&h.source.length!==1&&m.unshift(h)}if(m.length>0){let g=ve(m,u,t.options.strict,a);g.comment&&(c.comment?c.comment+=`
`+g.comment:c.comment=g.comment),c.range=[n.offset,u,g.offset]}else c.range=[n.offset,u,u];return c}var Ka,Ga,$s=E(()=>{q();De();Oe();Ie();lt();Ut();Un();Va();Ka="Block collections are not allowed within flow collections",Ga=o=>o&&(o.type==="block-map"||o.type==="block-seq")});function Wa(o,e,t,n,a,s){let r=t.type==="block-map"?Js(o,e,t,n,s):t.type==="block-seq"?Zs(o,e,t,n,s):Qs(o,e,t,n,s),i=r.constructor;return a==="!"||a===i.tagName?(r.tag=i.tagName,r):(a&&(r.tag=a),r)}function er(o,e,t,n,a){let s=n.tag,r=s?e.directives.tagName(s.source,p=>a(s,"TAG_RESOLVE_FAILED",p)):null;if(t.type==="block-seq"){let{anchor:p,newlineAfterProp:h}=n,m=p&&s?p.offset>s.offset?p:s:p??s;m&&(!h||h.offset<m.offset)&&a(m,"MISSING_CHAR","Missing newline after block sequence props")}let i=t.type==="block-map"?"map":t.type==="block-seq"?"seq":t.start.source==="{"?"map":"seq";if(!s||!r||r==="!"||r===V.tagName&&i==="map"||r===z.tagName&&i==="seq")return Wa(o,e,t,a,r);let l=e.schema.tags.find(p=>p.tag===r&&p.collection===i);if(!l){let p=e.schema.knownTags[r];if(p?.collection===i)e.schema.tags.push(Object.assign({},p,{default:!1})),l=p;else return p?a(s,"BAD_COLLECTION_TYPE",`${p.tag} used for ${i} collection, but expects ${p.collection??"scalar"}`,!0):a(s,"TAG_RESOLVE_FAILED",`Unresolved tag: ${r}`,!0),Wa(o,e,t,a,r)}let c=Wa(o,e,t,a,r,l),f=l.resolve?.(c,p=>a(s,"TAG_RESOLVE_FAILED",p),e.options)??c,d=P(f)?f:new C(f);return d.range=c.range,d.tag=r,l?.format&&(d.format=l.format),d}var tr=E(()=>{q();K();Oe();Ie();Xs();Ys();$s()});function qn(o,e,t){let n=e.offset,a=Ji(e,o.options.strict,t);if(!a)return{value:"",type:null,comment:"",range:[n,n,n]};let s=a.mode===">"?C.BLOCK_FOLDED:C.BLOCK_LITERAL,r=e.source?Xi(e.source):[],i=r.length;for(let u=r.length-1;u>=0;--u){let g=r[u][1];if(g===""||g==="\r")i=u;else break}if(i===0){let u=a.chomp==="+"&&r.length>0?`
...
`;for(let u=f;u<i;++u){let[g,y]=r[u];c+=g.length+y.length+1;let b=y[y.length-1]==="\r";if(b&&(y=y.slice(0,-1)),y&&g.length<l){let x=`Block scalar lines must not be less indented than their ${a.indent?"explicit indentation indicator":"first line"}`;t(c-y.length-(b?2:1),"BAD_INDENT",x),g=""}s===C.BLOCK_LITERAL?(d+=p+g.slice(l)+y,p=`
`):g.length>l||y[0]==="	"?(p===" "?p=`
`:!h&&p===`
`&&(p=`
...
`:case"\r":case"	":return!0;default:return!1}}var kr,fl,Wn,pl,to,We,no=E(()=>{Gn();kr=new Set("0123456789ABCDEFabcdef"),fl=new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),Wn=new Set(",[]{}"),pl=new Set(` ,[]{}
