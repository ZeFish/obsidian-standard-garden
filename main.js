...
`)y=g;else break}let b=t.substring(0,y<g?y+1:g);b&&(t=t.substring(b.length),b=b.replace(/\n+/g,`$&${c}`));let T=(u?c?"2":"1":"")+d;if(o&&(T+=" "+i(o.replace(/ ?[\r\n]+/g," ")),a&&a()),!f){let v=t.replace(/\n+/g,`
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${c}`),S=!1,N=un(n,!0);r!=="folded"&&e!==C.BLOCK_FOLDED&&(N.onOverflow=()=>{S=!0});let w=xt(`${b}${v}${h}`,c,fn,N);if(!S)return`>${T}
...
${r}
${c}
`}}});function ke(o,{flow:e,indicator:t,next:n,offset:a,onError:s,parentIndent:r,startOnNewline:i}){let l=!1,c=i,f=i,d="",p="",h=!1,m=!1,u=null,g=null,y=null,b=null,k=null,T=null,v=null;for(let w of o)switch(m&&(w.type!=="space"&&w.type!=="newline"&&w.type!=="comma"&&s(w.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),m=!1),u&&(c&&w.type!=="comment"&&w.type!=="newline"&&s(u,"TAB_AS_INDENT","Tabs are not allowed as indentation"),u=null),w.type){case"space":!e&&(t!=="doc-start"||n?.type!=="flow-collection")&&w.source.includes("	")&&(u=w),f=!0;break;case"comment":{f||s(w,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");let x=w.source.substring(1)||" ";d?d+=p+x:d=x,p="",c=!1;break}case"newline":c?d?d+=w.source:(!T||t!=="seq-item-ind")&&(l=!0):p+=w.source,c=!0,h=!0,(g||y)&&(b=w),f=!0;break;case"anchor":g&&s(w,"MULTIPLE_ANCHORS","A node can have at most one anchor"),w.source.endsWith(":")&&s(w.offset+w.source.length-1,"BAD_ALIAS","Anchor ending in : is ambiguous",!0),g=w,v??(v=w.offset),c=!1,f=!1,m=!0;break;case"tag":{y&&s(w,"MULTIPLE_TAGS","A node can have at most one tag"),y=w,v??(v=w.offset),c=!1,f=!1,m=!0;break}case t:(g||y)&&s(w,"BAD_PROP_ORDER",`Anchors and tags must be after the ${w.source} indicator`),T&&s(w,"UNEXPECTED_TOKEN",`Unexpected ${w.source} in ${e??"collection"}`),T=w,c=t==="seq-item-ind"||t==="explicit-key-ind",f=!1;break;case"comma":if(e){k&&s(w,"UNEXPECTED_TOKEN",`Unexpected , in ${e}`),k=w,c=!1,f=!1;break}default:s(w,"UNEXPECTED_TOKEN",`Unexpected ${w.type} token`),c=!1,f=!1}let S=o[o.length-1],N=S?S.offset+S.source.length:a;return m&&n&&n.type!=="space"&&n.type!=="newline"&&n.type!=="comma"&&(n.type!=="scalar"||n.source!=="")&&s(n.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),u&&(c&&u.indent<=r||n?.type==="block-map"||n?.type==="block-seq")&&s(u,"TAB_AS_INDENT","Tabs are not allowed as indentation"),{comma:k,found:T,spaceBefore:l,comment:d,hasNewline:h,anchor:g,tag:y,newlineAfterProp:b,end:N,start:v??N}}var Ut=E(()=>{});function Pe(o){if(!o)return null;switch(o.type){case"alias":case"scalar":case"double-quoted-scalar":case"single-quoted-scalar":if(o.source.includes(`
`))return!0;if(o.end){for(let e of o.end)if(e.type==="newline")return!0}return!1;case"flow-collection":for(let e of o.items){for(let t of e.start)if(t.type==="newline")return!0;if(e.sep){for(let t of e.sep)if(t.type==="newline")return!0}if(Pe(e.key)||Pe(e.value))return!0}return!1;default:return!0}}var Un=E(()=>{});function Bt(o,e,t){if(e?.type==="flow-collection"){let n=e.end[0];n.indent===o&&(n.source==="]"||n.source==="}")&&Pe(e)&&t(n,"BAD_INDENT","Flow end indicator should be more indented than parent",!0)}}var Va=E(()=>{Un()});function Bn(o,e,t){let{uniqueKeys:n}=o.options;if(n===!1)return!1;let a=typeof n=="function"?n:(s,r)=>s===r||D(s)&&D(r)&&s.value===r.value;return e.some(s=>a(s.key,t))}var Ka=E(()=>{q()});function Js({composeNode:o,composeEmptyNode:e},t,n,a,s){let r=s?.nodeClass??V,i=new r(t.schema);t.atRoot&&(t.atRoot=!1);let l=n.offset,c=null;for(let f of n.items){let{start:d,key:p,sep:h,value:m}=f,u=ke(d,{indicator:"explicit-key-ind",next:p??h?.[0],offset:l,onError:a,parentIndent:n.indent,startOnNewline:!0}),g=!u.found;if(g){if(p&&(p.type==="block-seq"?a(l,"BLOCK_AS_IMPLICIT_KEY","A block sequence may not be used as an implicit map key"):"indent"in p&&p.indent!==n.indent&&a(l,"BAD_INDENT",zs)),!u.anchor&&!u.tag&&!h){c=u.end,u.comment&&(i.comment?i.comment+=`
`+u.comment:i.comment=u.comment);continue}(u.newlineAfterProp||Pe(p))&&a(p??d[d.length-1],"MULTILINE_IMPLICIT_KEY","Implicit keys need to be on a single line")}else u.found?.indent!==n.indent&&a(l,"BAD_INDENT",zs);t.atKey=!0;let y=u.end,b=p?o(t,p,u,a):e(t,y,d,null,u,a);t.schema.compat&&Bt(n.indent,p,a),t.atKey=!1,Bn(t,i.items,b)&&a(y,"DUPLICATE_KEY","Map keys must be unique");let k=ke(h??[],{indicator:"map-value-ind",next:m,offset:b.range[2],onError:a,parentIndent:n.indent,startOnNewline:!p||p.type==="block-scalar"});if(l=k.end,k.found){g&&(m?.type==="block-map"&&!k.hasNewline&&a(l,"BLOCK_AS_IMPLICIT_KEY","Nested mappings are not allowed in compact mappings"),t.options.strict&&u.start<k.found.offset-1024&&a(b.range,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit block mapping key"));let T=m?o(t,m,k,a):e(t,l,h,null,k,a);t.schema.compat&&Bt(n.indent,m,a),l=T.range[2];let v=new j(b,T);t.options.keepSourceTokens&&(v.srcToken=f),i.items.push(v)}else{g&&a(b.range,"MISSING_CHAR","Implicit map keys need to be followed by map values"),k.comment&&(b.comment?b.comment+=`
`+k.comment:b.comment=k.comment);let T=new j(b);t.options.keepSourceTokens&&(T.srcToken=f),i.items.push(T)}}return c&&c<l&&a(c,"IMPOSSIBLE","Map comment with trailing content"),i.range=[n.offset,l,c??l],i}var zs,Xs=E(()=>{De();Oe();Ut();Un();Va();Ka();zs="All mapping items must start at the same column"});function Zs({composeNode:o,composeEmptyNode:e},t,n,a,s){let r=s?.nodeClass??z,i=new r(t.schema);t.atRoot&&(t.atRoot=!1),t.atKey&&(t.atKey=!1);let l=n.offset,c=null;for(let{start:f,value:d}of n.items){let p=ke(f,{indicator:"seq-item-ind",next:d,offset:l,onError:a,parentIndent:n.indent,startOnNewline:!0});if(!p.found)if(p.anchor||p.tag||d)d?.type==="block-seq"?a(p.end,"BAD_INDENT","All sequence items must start at the same column"):a(l,"MISSING_CHAR","Sequence item without - indicator");else{c=p.end,p.comment&&(i.comment=p.comment);continue}let h=d?o(t,d,p,a):e(t,p.end,f,null,p,a);t.schema.compat&&Bt(n.indent,d,a),l=h.range[2],i.items.push(h)}return i.range=[n.offset,l,c??l],i}var Ys=E(()=>{Ie();Ut();Va()});function ve(o,e,t,n){let a="";if(o){let s=!1,r="";for(let i of o){let{source:l,type:c}=i;switch(c){case"space":s=!0;break;case"comment":{t&&!s&&n(i,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");let f=l.substring(1)||" ";a?a+=r+f:a=f,r="";break}case"newline":a&&(r+=l),s=!0;break;default:n(i,"UNEXPECTED_TOKEN",`Unexpected ${c} at node end`)}e+=l.length}}return{comment:a,offset:e}}var lt=E(()=>{});function Qs({composeNode:o,composeEmptyNode:e},t,n,a,s){let r=n.start.source==="{",i=r?"flow map":"flow sequence",l=s?.nodeClass??(r?V:z),c=new l(t.schema);c.flow=!0;let f=t.atRoot;f&&(t.atRoot=!1),t.atKey&&(t.atKey=!1);let d=n.offset+n.start.source.length;for(let g=0;g<n.items.length;++g){let y=n.items[g],{start:b,key:k,sep:T,value:v}=y,S=ke(b,{flow:i,indicator:"explicit-key-ind",next:k??T?.[0],offset:d,onError:a,parentIndent:n.indent,startOnNewline:!1});if(!S.found){if(!S.anchor&&!S.tag&&!T&&!v){g===0&&S.comma?a(S.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${i}`):g<n.items.length-1&&a(S.start,"UNEXPECTED_TOKEN",`Unexpected empty item in ${i}`),S.comment&&(c.comment?c.comment+=`
`+S.comment:c.comment=S.comment),d=S.end;continue}!r&&t.options.strict&&Pe(k)&&a(k,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line")}if(g===0)S.comma&&a(S.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${i}`);else if(S.comma||a(S.start,"MISSING_CHAR",`Missing , between ${i} items`),S.comment){let N="";e:for(let w of b)switch(w.type){case"comma":case"space":break;case"comment":N=w.source.substring(1);break e;default:break e}if(N){let w=c.items[c.items.length-1];R(w)&&(w=w.value??w.key),w.comment?w.comment+=`
`+N:w.comment=N,S.comment=S.comment.substring(N.length+1)}}if(!r&&!T&&!S.found){let N=v?o(t,v,S,a):e(t,S.end,T,null,S,a);c.items.push(N),d=N.range[2],Wa(v)&&a(N.range,"BLOCK_IN_FLOW",Ga)}else{t.atKey=!0;let N=S.end,w=k?o(t,k,S,a):e(t,N,b,null,S,a);Wa(k)&&a(w.range,"BLOCK_IN_FLOW",Ga),t.atKey=!1;let x=ke(T??[],{flow:i,indicator:"map-value-ind",next:v,offset:w.range[2],onError:a,parentIndent:n.indent,startOnNewline:!1});if(x.found){if(!r&&!S.found&&t.options.strict){if(T)for(let F of T){if(F===x.found)break;if(F.type==="newline"){a(F,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line");break}}S.start<x.found.offset-1024&&a(x.found,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit flow sequence key")}}else v&&("source"in v&&v.source?.[0]===":"?a(v,"MISSING_CHAR",`Missing space after : in ${i}`):a(x.start,"MISSING_CHAR",`Missing , or : between ${i} items`));let A=v?o(t,v,x,a):x.found?e(t,x.end,T,null,x,a):null;A?Wa(v)&&a(A.range,"BLOCK_IN_FLOW",Ga):x.comment&&(w.comment?w.comment+=`
`+x.comment:w.comment=x.comment);let O=new j(w,A);if(t.options.keepSourceTokens&&(O.srcToken=y),r){let F=c;Bn(t,F.items,w)&&a(N,"DUPLICATE_KEY","Map keys must be unique"),F.items.push(O)}else{let F=new V(t.schema);F.flow=!0,F.items.push(O);let U=(A??w).range;F.range=[w.range[0],U[1],U[2]],c.items.push(F)}d=A?A.range[2]:x.end}}let p=r?"}":"]",[h,...m]=n.end,u=d;if(h?.source===p)u=h.offset+h.source.length;else{let g=i[0].toUpperCase()+i.substring(1),y=f?`${g} must end with a ${p}`:`${g} in block collection must be sufficiently indented and end with a ${p}`;a(d,f?"MISSING_CHAR":"BAD_INDENT",y),h&&h.source.length!==1&&m.unshift(h)}if(m.length>0){let g=ve(m,u,t.options.strict,a);g.comment&&(c.comment?c.comment+=`
`+g.comment:c.comment=g.comment),c.range=[n.offset,u,g.offset]}else c.range=[n.offset,u,u];return c}var Ga,Wa,$s=E(()=>{q();De();Oe();Ie();lt();Ut();Un();Ka();Ga="Block collections are not allowed within flow collections",Wa=o=>o&&(o.type==="block-map"||o.type==="block-seq")});function za(o,e,t,n,a,s){let r=t.type==="block-map"?Js(o,e,t,n,s):t.type==="block-seq"?Zs(o,e,t,n,s):Qs(o,e,t,n,s),i=r.constructor;return a==="!"||a===i.tagName?(r.tag=i.tagName,r):(a&&(r.tag=a),r)}function er(o,e,t,n,a){let s=n.tag,r=s?e.directives.tagName(s.source,p=>a(s,"TAG_RESOLVE_FAILED",p)):null;if(t.type==="block-seq"){let{anchor:p,newlineAfterProp:h}=n,m=p&&s?p.offset>s.offset?p:s:p??s;m&&(!h||h.offset<m.offset)&&a(m,"MISSING_CHAR","Missing newline after block sequence props")}let i=t.type==="block-map"?"map":t.type==="block-seq"?"seq":t.start.source==="{"?"map":"seq";if(!s||!r||r==="!"||r===V.tagName&&i==="map"||r===z.tagName&&i==="seq")return za(o,e,t,a,r);let l=e.schema.tags.find(p=>p.tag===r&&p.collection===i);if(!l){let p=e.schema.knownTags[r];if(p?.collection===i)e.schema.tags.push(Object.assign({},p,{default:!1})),l=p;else return p?a(s,"BAD_COLLECTION_TYPE",`${p.tag} used for ${i} collection, but expects ${p.collection??"scalar"}`,!0):a(s,"TAG_RESOLVE_FAILED",`Unresolved tag: ${r}`,!0),za(o,e,t,a,r)}let c=za(o,e,t,a,r,l),f=l.resolve?.(c,p=>a(s,"TAG_RESOLVE_FAILED",p),e.options)??c,d=P(f)?f:new C(f);return d.range=c.range,d.tag=r,l?.format&&(d.format=l.format),d}var tr=E(()=>{q();K();Oe();Ie();Xs();Ys();$s()});function qn(o,e,t){let n=e.offset,a=Ji(e,o.options.strict,t);if(!a)return{value:"",type:null,comment:"",range:[n,n,n]};let s=a.mode===">"?C.BLOCK_FOLDED:C.BLOCK_LITERAL,r=e.source?Xi(e.source):[],i=r.length;for(let u=r.length-1;u>=0;--u){let g=r[u][1];if(g===""||g==="\r")i=u;else break}if(i===0){let u=a.chomp==="+"&&r.length>0?`
...
`;for(let u=f;u<i;++u){let[g,y]=r[u];c+=g.length+y.length+1;let b=y[y.length-1]==="\r";if(b&&(y=y.slice(0,-1)),y&&g.length<l){let T=`Block scalar lines must not be less indented than their ${a.indent?"explicit indentation indicator":"first line"}`;t(c-y.length-(b?2:1),"BAD_INDENT",T),g=""}s===C.BLOCK_LITERAL?(d+=p+g.slice(l)+y,p=`
`):g.length>l||y[0]==="	"?(p===" "?p=`
`:!h&&p===`
`&&(p=`
...
`);return S=S.replace(/!\[\[([^\]]+)\]\]/g,(N,w)=>{let x=w.split("|"),A=x[0].trim(),O=x[1]?x[1].trim():"";return O?`[IMAGE:${O.toLowerCase()}]`:`[IMAGE:${(A.substring(0,A.lastIndexOf("."))||A).toLowerCase()}]`}),S=S.replace(/!\[([^\]]*)\]\(([^)]+)\)/g,(N,w,x)=>{let A=w.trim();if(A)return`[IMAGE:${A.toLowerCase()}]`;let O=x.split("/").pop()||"";return`[IMAGE:${(O.substring(0,O.lastIndexOf("."))||O).toLowerCase()}]`}),S.trim()},m=h(p),u=h(c),g=new TextEncoder().encode(m),y=await crypto.subtle.digest("SHA-256",g),k=Array.from(new Uint8Array(y)).map(v=>v.toString(16).padStart(2,"0")).join("");if(f===k)return{status:"synced"};let T=e.stat.mtime;return d>T+5e3?{status:"outdated",remoteContent:c}:{status:"changed"}}catch(t){return console.error("Standard : Erreur lors de la v\xE9rification du statut de la note :",t),{status:"error"}}}async deleteOnlineVersion(e){return this.checkApiKeyAndShowModal()?new Promise(t=>{new go(this.app,`Remove "${e.basename}" from Standard Garden?
