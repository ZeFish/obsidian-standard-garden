...
`).forEach((s,r)=>{let i=e.createEl("p",{text:s,cls:r===0?"stnd-modal-message":"stnd-modal-detail"})});let t=e.createEl("div",{cls:"stnd-modal-btns"});t.createEl("button",{text:"Cancel",cls:"stnd-modal-btn-cancel"}).addEventListener("click",()=>{this.close(),this.onCancel()}),t.createEl("button",{text:this.confirmText,cls:"mod-cta"}).addEventListener("click",()=>{this.close(),this.onConfirm()})}onClose(){this.contentEl.empty()}};ss.exports={StndConfirmModal:ia}});var is=j((kc,rs)=>{"use strict";var gt=require("obsidian"),ca=class extends gt.Modal{constructor(e,t){super(e),this.plugin=t}onOpen(){let{contentEl:e}=this;e.addClass("stnd-modal"),e.addClass("stnd-ask-modal"),e.createEl("h2",{text:"\u2728 Ask Hyphe",cls:"stnd-modal-title"}),e.createEl("p",{text:"Ask Hyphe a question about your digital garden. Hyphe runs in the cloud on standard.garden and searches only across your published notes.",cls:"stnd-modal-detail"});let t=e.createEl("div",{cls:"stnd-ask-cloud-notice"});t.setText("\u{1F310} Online AI \xB7 Only searches notes published to standard.garden. Local drafts remain strictly private."),t.style.fontSize="11px",t.style.color="var(--text-muted)",t.style.marginBottom="14px",t.style.display="inline-flex",t.style.alignItems="center",t.style.gap="6px",t.style.padding="4px 8px",t.style.borderRadius="4px",t.style.background="var(--background-secondary)",t.style.border="1px solid var(--background-modifier-border)";let n=e.createEl("textarea",{cls:"stnd-modal-textarea",placeholder:"e.g., What did I learn about permaculture recently?"});n.style.width="100%",n.style.height="100px",n.style.marginBottom="15px",n.style.padding="10px",n.style.borderRadius="4px",n.style.border="1px solid var(--background-modifier-border)",n.style.background="var(--background-primary)",n.style.color="var(--text-normal)";let a=e.createEl("div",{cls:"stnd-modal-result-container"});a.style.display="none",a.style.marginTop="15px",a.style.padding="15px",a.style.borderRadius="4px",a.style.background="var(--background-secondary)",a.style.borderLeft="4px solid var(--interactive-accent)",a.style.maxHeight="300px",a.style.overflowY="auto";let s=a.createEl("div",{cls:"stnd-modal-result-text"});s.style.lineHeight="1.5",s.style.color="var(--text-normal)";let r=e.createEl("div",{cls:"stnd-modal-btns"});r.createEl("button",{text:"Close",cls:"stnd-modal-btn-cancel"}).addEventListener("click",()=>{this.close()});let l=r.createEl("button",{text:"Ask Hyphe",cls:"mod-cta"}),c=e.createEl("div",{cls:"stnd-ask-horizon"});c.setAttribute("aria-hidden","true"),c.innerHTML=`
    ...
    `;let f=async(d,p="garden")=>{let h=this.plugin.settings.apiKey;if(!h){new gt.Notice("Please connect your standard.garden account in Settings first."),a.style.display="block",s.empty(),s.style.fontStyle="normal",s.setText("Please connect your standard.garden account in Settings first to query Hyphe.");return}a.querySelectorAll(".stnd-modal-mycelium-prompt").forEach(m=>m.remove()),l.disabled=!0,n.disabled=!0,l.text=p==="mycelium"?"Searching Mycelium...":"Hyphe is searching...",a.style.display="block",s.empty(),s.setText(p==="mycelium"?"Hyphe is exploring the public Mycelium and weaving an answer...":"Hyphe is searching your published notes and generating an answer..."),s.style.fontStyle="italic";try{let m=await gt.requestUrl({url:`${this.plugin.settings.apiUrl}/ai/ask`,method:"POST",headers:{"Content-Type":"application/json","x-api-key":h},body:JSON.stringify({question:d,scope:p}),throw:!1});if(m.status<200||m.status>=300){let g=m.text;try{let y=JSON.parse(m.text||"{}");y.error&&(g=y.error)}catch{}throw new Error(g||`Server error (${m.status})`)}let u=m.json;if(s.style.fontStyle="normal",u.answer){if(s.empty(),await gt.MarkdownRenderer.renderMarkdown(u.answer,s,"",this),s.querySelectorAll("a").forEach(g=>{g.addEventListener("click",y=>{let b=g.getAttribute("href");if(b&&b.startsWith("/")){y.preventDefault();let k=b.replace(/^\/+|\/+$/g,""),S=this.plugin.garden?.bySlug?.get(k)||this.plugin.garden?.byTitleSlug?.get(k)||this.plugin.garden?.byBasenameSlug?.get(k);S?(this.app.workspace.getLeaf(!1).openFile(S),this.close()):this.plugin.settings.apiUsername&&window.open(`https://standard.garden${b}`,"_blank")}})}),u.mycelium_hints?.count>0&&u.scope!=="mycelium"){let g=u.mycelium_hints.count,y=u.mycelium_hints.authors?.length?` (${u.mycelium_hints.authors.join(", ")})`:"",b=a.createEl("div",{cls:"stnd-modal-mycelium-prompt"});b.style.marginTop="14px",b.style.paddingTop="10px",b.style.borderTop="1px dashed var(--background-modifier-border)",b.style.display="flex",b.style.alignItems="center",b.style.justifyContent="space-between",b.style.gap="8px";let k=b.createEl("span",{text:`\u{1F344} Le Myc\xE9lium public a ${g} note${g>1?"s":""} connexe${g>1?"s":""}${y}`});k.style.fontSize="11px",k.style.color="var(--text-muted)";let S=b.createEl("button",{cls:"mod-cta",text:"Explorer le Myc\xE9lium \u2192"});S.style.fontSize="11px",S.style.padding="3px 8px",S.style.cursor="pointer",S.addEventListener("click",()=>{f(d,"mycelium")})}}else s.setText("No response was returned by Hyphe.")}catch(m){s.style.fontStyle="normal",s.setText(`Error: ${m.message}`),console.error("Error during Hyphe query:",m)}finally{l.disabled=!1,n.disabled=!1,l.text="Ask Hyphe"}};l.addEventListener("click",()=>{let d=n.value.trim();if(!d){new gt.Notice("Please enter a question.");return}f(d,"garden")})}onClose(){this.contentEl.empty()}};rs.exports={StndAskModal:ca}});var fa=j((vc,ls)=>{"use strict";var Oi=require("obsidian"),da=class extends Oi.Modal{constructor(e,t,n){super(e),this.noteTitle=t,this.liveUrl=n}onOpen(){let{contentEl:e}=this;e.addClass("stnd-modal"),e.style.cssText="max-width: 480px; padding: 20px;";let t=e.createEl("h3",{text:"Share Note"});t.style.cssText="margin-bottom: 16px; font-size: var(--font-ui-medium); font-weight: var(--font-semibold);";let n=(l,c)=>{let f=e.createEl("div");f.style.cssText="margin-bottom: 16px;";let d=f.createEl("div");d.style.cssText="display: flex; align-items: center; justify-content: space-between; margin-bottom: 6px;",d.createEl("span",{text:l,cls:"stnd-panel-meta"});let p=f.createEl("div");p.style.cssText="display: flex; gap: 8px; align-items: center;";let h=p.createEl("input",{cls:"stnd-panel-input",type:"text",value:c});h.readOnly=!0,h.style.cssText="flex: 1; width: 100%; text-align: left; font-size: var(--font-ui-smaller); font-family: var(--font-monospace);";let m=p.createEl("button",{text:"Copy",cls:"stnd-panel-btn stnd-panel-btn-secondary"});m.style.cssText="flex-shrink: 0; font-size: var(--font-ui-smaller);",m.addEventListener("click",()=>{navigator.clipboard.writeText(c),m.setText("Copied!"),setTimeout(()=>m.setText("Copy"),1500)})};n("Direct URL",this.liveUrl);let a=`[${this.noteTitle}](${this.liveUrl})`;n("Markdown Link",a);let s=`<iframe src="${this.liveUrl}" width="100%" height="600" frameborder="0"></iframe>`;n("Embed Iframe",s);let r=e.createEl("div");r.style.cssText="display: flex; justify-content: flex-end; margin-top: 12px;",r.createEl("button",{text:"Close",cls:"stnd-panel-btn"}).addEventListener("click",()=>this.close())}onClose(){this.contentEl.empty()}};ls.exports={StndShareModal:da}});function H(o){if(o&&typeof o=="object")switch(o[Z]){case ce:case xe:return!0}return!1}function U(o){if(o&&typeof o=="object")switch(o[Z]){case tn:case ce:case ee:case xe:return!0}return!1}var tn,nn,ce,pa,ee,xe,Z,te,ne,ae,P,M,oe,an,q=N(()=>{tn=Symbol.for("yaml.alias"),nn=Symbol.for("yaml.document"),ce=Symbol.for("yaml.map"),pa=Symbol.for("yaml.pair"),ee=Symbol.for("yaml.scalar"),xe=Symbol.for("yaml.seq"),Z=Symbol.for("yaml.node.type"),te=o=>!!o&&typeof o=="object"&&o[Z]===tn,ne=o=>!!o&&typeof o=="object"&&o[Z]===nn,ae=o=>!!o&&typeof o=="object"&&o[Z]===ce,P=o=>!!o&&typeof o=="object"&&o[Z]===pa,M=o=>!!o&&typeof o=="object"&&o[Z]===ee,oe=o=>!!o&&typeof o=="object"&&o[Z]===xe;an=o=>(M(o)||H(o))&&!!o.anchor});function se(o,e){let t=ds(e);ne(o)?Je(null,o.contents,t,Object.freeze([o]))===ye&&(o.contents=null):Je(null,o,t,Object.freeze([]))}function Je(o,e,t,n){let a=fs(o,e,t,n);if(U(a)||P(a))return ps(o,n,a),Je(o,a,t,n);if(typeof a!="symbol"){if(H(e)){n=Object.freeze(n.concat(e));for(let s=0;s<e.items.length;++s){let r=Je(s,e.items[s],t,n);if(typeof r=="number")s=r-1;else{if(r===Y)return Y;r===ye&&(e.items.splice(s,1),s-=1)}}}else if(P(e)){n=Object.freeze(n.concat(e));let s=Je("key",e.key,t,n);if(s===Y)return Y;s===ye&&(e.key=null);let r=Je("value",e.value,t,n);if(r===Y)return Y;r===ye&&(e.value=null)}}return a}async function Ze(o,e){let t=ds(e);ne(o)?await Xe(null,o.contents,t,Object.freeze([o]))===ye&&(o.contents=null):await Xe(null,o,t,Object.freeze([]))}async function Xe(o,e,t,n){let a=await fs(o,e,t,n);if(U(a)||P(a))return ps(o,n,a),Xe(o,a,t,n);if(typeof a!="symbol"){if(H(e)){n=Object.freeze(n.concat(e));for(let s=0;s<e.items.length;++s){let r=await Xe(s,e.items[s],t,n);if(typeof r=="number")s=r-1;else{if(r===Y)return Y;r===ye&&(e.items.splice(s,1),s-=1)}}}else if(P(e)){n=Object.freeze(n.concat(e));let s=await Xe("key",e.key,t,n);if(s===Y)return Y;s===ye&&(e.key=null);let r=await Xe("value",e.value,t,n);if(r===Y)return Y;r===ye&&(e.value=null)}}return a}function ds(o){return typeof o=="object"&&(o.Collection||o.Node||o.Value)?Object.assign({Alias:o.Node,Map:o.Node,Scalar:o.Node,Seq:o.Node},o.Value&&{Map:o.Value,Scalar:o.Value,Seq:o.Value},o.Collection&&{Map:o.Collection,Seq:o.Collection},o):o}function fs(o,e,t,n){if(typeof t=="function")return t(o,e,n);if(ae(e))return t.Map?.(o,e,n);if(oe(e))return t.Seq?.(o,e,n);if(P(e))return t.Pair?.(o,e,n);if(M(e))return t.Scalar?.(o,e,n);if(te(e))return t.Alias?.(o,e,n)}function ps(o,e,t){let n=e[e.length-1];if(H(n))n.items[o]=t;else if(P(n))o==="key"?n.key=t:n.value=t;else if(ne(n))n.contents=t;else{let a=te(n)?"alias":"scalar";throw new Error(`Cannot replace node with ${a} parent`)}}var Y,cs,ye,yt=N(()=>{q();Y=Symbol("break visit"),cs=Symbol("skip children"),ye=Symbol("remove node");se.BREAK=Y;se.SKIP=cs;se.REMOVE=ye;Ze.BREAK=Y;Ze.SKIP=cs;Ze.REMOVE=ye});var Ri,Ii,be,ua=N(()=>{q();yt();Ri={"!":"%21",",":"%2C","[":"%5B","]":"%5D","{":"%7B","}":"%7D"},Ii=o=>o.replace(/[!,[\]{}]/g,e=>Ri[e]),be=class o{constructor(e,t){this.docStart=null,this.docEnd=!1,this.yaml=Object.assign({},o.defaultYaml,e),this.tags=Object.assign({},o.defaultTags,t)}clone(){let e=new o(this.yaml,this.tags);return e.docStart=this.docStart,e}atDocument(){let e=new o(this.yaml,this.tags);switch(this.yaml.version){case"1.1":this.atNextDocument=!0;break;case"1.2":this.atNextDocument=!1,this.yaml={explicit:o.defaultYaml.explicit,version:"1.2"},this.tags=Object.assign({},o.defaultTags);break}return e}add(e,t){this.atNextDocument&&(this.yaml={explicit:o.defaultYaml.explicit,version:"1.1"},this.tags=Object.assign({},o.defaultTags),this.atNextDocument=!1);let n=e.trim().split(/[ \t]+/),a=n.shift();switch(a){case"%TAG":{if(n.length!==2&&(t(0,"%TAG directive should contain exactly two parts"),n.length<2))return!1;let[s,r]=n;return this.tags[s]=r,!0}case"%YAML":{if(this.yaml.explicit=!0,n.length!==1)return t(0,"%YAML directive should contain exactly one part"),!1;let[s]=n;if(s==="1.1"||s==="1.2")return this.yaml.version=s,!0;{let r=/^\d+\.\d+$/.test(s);return t(6,`Unsupported YAML version ${s}`,r),!1}}default:return t(0,`Unknown directive ${a}`,!0),!1}}tagName(e,t){if(e==="!")return"!";if(e[0]!=="!")return t(`Not a valid tag: ${e}`),null;if(e[1]==="<"){let r=e.slice(2,-1);return r==="!"||r==="!!"?(t(`Verbatim tags aren't resolved, so ${e} is invalid.`),null):(e[e.length-1]!==">"&&t("Verbatim tags must end with a >"),r)}let[,n,a]=e.match(/^(.*!)([^!]*)$/s);a||t(`The ${e} tag has no suffix`);let s=this.tags[n];if(s)try{return s+decodeURIComponent(a)}catch(r){return t(String(r)),null}return n==="!"?e:(t(`Could not resolve tag: ${e}`),null)}tagString(e){for(let[t,n]of Object.entries(this.tags))if(e.startsWith(n))return t+Ii(e.substring(n.length));return e[0]==="!"?e:`!<${e}>`}toString(e){let t=this.yaml.explicit?[`%YAML ${this.yaml.version||"1.2"}`]:[],n=Object.entries(this.tags),a;if(e&&n.length>0&&U(e.contents)){let s={};se(e.contents,(r,i)=>{U(i)&&i.tag&&(s[i.tag]=!0)}),a=Object.keys(s)}else a=[];for(let[s,r]of n)s==="!!"&&r==="tag:yaml.org,2002:"||(!e||a.some(i=>i.startsWith(r)))&&t.push(`%TAG ${s} ${r}`);return t.join(`
`)}};be.defaultYaml={explicit:!1,version:"1.2"};be.defaultTags={"!!":"tag:yaml.org,2002:"}});function on(o){if(/[\x00-\x19\s,[\]{}]/.test(o)){let t=`Anchor must not contain whitespace or control characters: ${JSON.stringify(o)}`;throw new Error(t)}return!0}function ha(o){let e=new Set;return se(o,{Value(t,n){n.anchor&&e.add(n.anchor)}}),e}function ma(o,e){for(let t=1;;++t){let n=`${o}${t}`;if(!e.has(n))return n}}function us(o,e){let t=[],n=new Map,a=null;return{onAnchor:s=>{t.push(s),a??(a=ha(o));let r=ma(e,a);return a.add(r),r},setAnchors:()=>{for(let s of t){let r=n.get(s);if(typeof r=="object"&&r.anchor&&(M(r.node)||H(r.node)))r.node.anchor=r.anchor;else{let i=new Error("Failed to resolve repeated object (this should not happen)");throw i.source=s,i}}},sourceObjects:n}}var sn=N(()=>{q();yt()});function Le(o,e,t,n){if(n&&typeof n=="object")if(Array.isArray(n))for(let a=0,s=n.length;a<s;++a){let r=n[a],i=Le(o,n,String(a),r);i===void 0?delete n[a]:i!==r&&(n[a]=i)}else if(n instanceof Map)for(let a of Array.from(n.keys())){let s=n.get(a),r=Le(o,n,a,s);r===void 0?n.delete(a):r!==s&&n.set(a,r)}else if(n instanceof Set)for(let a of Array.from(n)){let s=Le(o,n,a,a);s===void 0?n.delete(a):s!==a&&(n.delete(a),n.add(s))}else for(let[a,s]of Object.entries(n)){let r=Le(o,n,a,s);r===void 0?delete n[a]:r!==s&&(n[a]=r)}return o.call(e,t,n)}var ga=N(()=>{});function G(o,e,t){if(Array.isArray(o))return o.map((n,a)=>G(n,String(a),t));if(o&&typeof o.toJSON=="function"){if(!t||!an(o))return o.toJSON(e,t);let n={aliasCount:0,count:1,res:void 0};t.anchors.set(o,n),t.onCreate=s=>{n.res=s,delete t.onCreate};let a=o.toJSON(e,t);return t.onCreate&&t.onCreate(a),a}return typeof o=="bigint"&&!t?.keep?Number(o):o}var Fe=N(()=>{q()});var Ae,rn=N(()=>{ga();q();Fe();Ae=class{constructor(e){Object.defineProperty(this,Z,{value:e})}clone(){let e=Object.create(Object.getPrototypeOf(this),Object.getOwnPropertyDescriptors(this));return this.range&&(e.range=this.range.slice()),e}toJS(e,{mapAsMap:t,maxAliasCount:n,onAnchor:a,reviver:s}={}){if(!ne(e))throw new TypeError("A document argument is required");let r={anchors:new Map,doc:e,keep:!0,mapAsMap:t===!0,mapKeyWarned:!1,maxAliasCount:typeof n=="number"?n:100},i=G(this,"",r);if(typeof a=="function")for(let{count:l,res:c}of r.anchors.values())a(c,l);return typeof s=="function"?Le(s,{"":i},"",i):i}}});function ln(o,e,t){if(te(e)){let n=e.resolve(o),a=t&&n&&t.get(n);return a?a.count*a.aliasCount:0}else if(H(e)){let n=0;for(let a of e.items){let s=ln(o,a,t);s>n&&(n=s)}return n}else if(P(e)){let n=ln(o,e.key,t),a=ln(o,e.value,t);return Math.max(n,a)}return 1}var de,bt=N(()=>{sn();yt();q();rn();Fe();de=class extends Ae{constructor(e){super(tn),this.source=e,Object.defineProperty(this,"tag",{set(){throw new Error("Alias nodes cannot have tags")}})}resolve(e,t){if(t?.maxAliasCount===0)throw new ReferenceError("Alias resolution is disabled");let n;t?.aliasResolveCache?n=t.aliasResolveCache:(n=[],se(e,{Node:(s,r)=>{(te(r)||an(r))&&n.push(r)}}),t&&(t.aliasResolveCache=n));let a;for(let s of n){if(s===this)break;s.anchor===this.source&&(a=s)}return a}toJSON(e,t){if(!t)return{source:this.source};let{anchors:n,doc:a,maxAliasCount:s}=t,r=this.resolve(a,t);if(!r){let l=`Unresolved alias (the anchor must be set before the alias): ${this.source}`;throw new ReferenceError(l)}let i=n.get(r);if(i||(G(r,null,t),i=n.get(r)),i?.res===void 0){let l="This should not happen: Alias anchor was not resolved?";throw new ReferenceError(l)}if(s>=0&&(i.count+=1,i.aliasCount===0&&(i.aliasCount=ln(a,r,n)),i.count*i.aliasCount>s)){let l="Excessive alias count indicates a resource exhaustion attack";throw new ReferenceError(l)}return i.res}toString(e,t,n){let a=`*${this.source}`;if(e){if(on(this.source),e.options.verifyAliasOrder&&!e.anchors.has(this.source)){let s=`Unresolved alias (the anchor must be set before the alias): ${this.source}`;throw new Error(s)}if(e.implicitKey)return`${a} `}return a}}});var cn,E,K=N(()=>{q();rn();Fe();cn=o=>!o||typeof o!="function"&&typeof o!="object",E=class extends Ae{constructor(e){super(ee),this.value=e}toJSON(e,t){return t?.keep?this.value:G(this.value,e,t)}toString(){return String(this.value)}};E.BLOCK_FOLDED="BLOCK_FOLDED";E.BLOCK_LITERAL="BLOCK_LITERAL";E.PLAIN="PLAIN";E.QUOTE_DOUBLE="QUOTE_DOUBLE";E.QUOTE_SINGLE="QUOTE_SINGLE"});function Ui(o,e,t){if(e){let n=t.filter(s=>s.tag===e),a=n.find(s=>!s.format)??n[0];if(!a)throw new Error(`Tag ${e} not found`);return a}return t.find(n=>n.identify?.(o)&&!n.format)}function Te(o,e,t){if(ne(o)&&(o=o.contents),U(o))return o;if(P(o)){let d=t.schema[ce].createNode?.(t.schema,null,t);return d.items.push(o),d}(o instanceof String||o instanceof Number||o instanceof Boolean||typeof BigInt<"u"&&o instanceof BigInt)&&(o=o.valueOf());let{aliasDuplicateObjects:n,onAnchor:a,onTagObj:s,schema:r,sourceObjects:i}=t,l;if(n&&o&&typeof o=="object"){if(l=i.get(o),l)return l.anchor??(l.anchor=a(o)),new de(l.anchor);l={anchor:null,node:null},i.set(o,l)}e?.startsWith("!!")&&(e=Pi+e.slice(2));let c=Ui(o,e,r.tags);if(!c){if(o&&typeof o.toJSON=="function"&&(o=o.toJSON()),!o||typeof o!="object"){let d=new E(o);return l&&(l.node=d),d}c=o instanceof Map?r[ce]:Symbol.iterator in Object(o)?r[xe]:r[ce]}s&&(s(c),delete t.onTagObj);let f=c?.createNode?c.createNode(t.schema,o,t):typeof c?.nodeClass?.from=="function"?c.nodeClass.from(t.schema,o,t):new E(o);return e?f.tag=e:c.default||(f.tag=c.tag),l&&(l.node=f),f}var Pi,wt=N(()=>{bt();q();K();Pi="tag:yaml.org,2002:"});function kt(o,e,t){let n=t;for(let a=e.length-1;a>=0;--a){let s=e[a];if(typeof s=="number"&&Number.isInteger(s)&&s>=0){let r=[];r[s]=n,n=r}else n=new Map([[s,n]])}return Te(n,void 0,{aliasDuplicateObjects:!1,keepUndefined:!1,onAnchor:()=>{throw new Error("This should not happen, please report a bug.")},schema:o,sourceObjects:new Map})}var Qe,Ye,dn=N(()=>{wt();q();rn();Qe=o=>o==null||typeof o=="object"&&!!o[Symbol.iterator]().next().done,Ye=class extends Ae{constructor(e,t){super(e),Object.defineProperty(this,"schema",{value:t,configurable:!0,enumerable:!1,writable:!0})}clone(e){let t=Object.create(Object.getPrototypeOf(this),Object.getOwnPropertyDescriptors(this));return e&&(t.schema=e),t.items=t.items.map(n=>U(n)||P(n)?n.clone(e):n),this.range&&(t.range=this.range.slice()),t}addIn(e,t){if(Qe(e))this.add(t);else{let[n,...a]=e,s=this.get(n,!0);if(H(s))s.addIn(a,t);else if(s===void 0&&this.schema)this.set(n,kt(this.schema,a,t));else throw new Error(`Expected YAML collection at ${n}. Remaining path: ${a}`)}}deleteIn(e){let[t,...n]=e;if(n.length===0)return this.delete(t);let a=this.get(t,!0);if(H(a))return a.deleteIn(n);throw new Error(`Expected YAML collection at ${t}. Remaining path: ${n}`)}getIn(e,t){let[n,...a]=e,s=this.get(n,!0);return a.length===0?!t&&M(s)?s.value:s:H(s)?s.getIn(a,t):void 0}hasAllNullValues(e){return this.items.every(t=>{if(!P(t))return!1;let n=t.value;return n==null||e&&M(n)&&n.value==null&&!n.commentBefore&&!n.comment&&!n.tag})}hasIn(e){let[t,...n]=e;if(n.length===0)return this.has(t);let a=this.get(t,!0);return H(a)?a.hasIn(n):!1}setIn(e,t){let[n,...a]=e;if(a.length===0)this.set(n,t);else{let s=this.get(n,!0);if(H(s))s.setIn(a,t);else if(s===void 0&&this.schema)this.set(n,kt(this.schema,a,t));else throw new Error(`Expected YAML collection at ${n}. Remaining path: ${a}`)}}}});function re(o,e){return/^\n+$/.test(o)?o.substring(1):e?o.replace(/^(?! *$)/gm,e):o}var hs,we,vt=N(()=>{hs=o=>o.replace(/^(?!$)(?: $)?/gm,"#");we=(o,e,t)=>o.endsWith(`
`)?re(t,e):t.includes(`
`)?`
`+re(t,e):(o.endsWith(" ")?"":" ")+t});function xt(o,e,t="flow",{indentAtStart:n,lineWidth:a=80,minContentWidth:s=20,onFold:r,onOverflow:i}={}){if(!a||a<0)return o;a<s&&(s=0);let l=Math.max(1+s,1+a-e.length);if(o.length<=l)return o;let c=[],f={},d=a-e.length;typeof n=="number"&&(n>a-Math.max(2,s)?c.push(0):d=a-n);let p,h,m=!1,u=-1,g=-1,y=-1;t===fn&&(u=ms(o,u,e.length),u!==-1&&(d=u+l));for(let k;k=o[u+=1];){if(t===St&&k==="\\"){switch(g=u,o[u+1]){case"x":u+=3;break;case"u":u+=5;break;case"U":u+=9;break;default:u+=1}y=u}if(k===`
`)t===fn&&(u=ms(o,u,e.length)),d=u+e.length+l,p=void 0;else{if(k===" "&&h&&h!==" "&&h!==`
`&&h!=="	"){let S=o[u+1];S&&S!==" "&&S!==`
`&&S!=="	"&&(p=u)}if(u>=d)if(p)c.push(p),d=p+l,p=void 0;else if(t===St){for(;h===" "||h==="	";)h=k,k=o[u+=1],m=!0;let S=u>y+1?u-2:g-1;if(f[S])return o;c.push(S),f[S]=!0,d=S+l,p=void 0}else m=!0}h=k}if(m&&i&&i(),c.length===0)return o;r&&r();let b=o.slice(0,c[0]);for(let k=0;k<c.length;++k){let S=c[k],T=c[k+1]||o.length;S===0?b=`
${e}${o.slice(0,T)}`:(t===St&&f[S]&&(b+=`${o[S]}\\`),b+=`
${e}${o.slice(S+1,T)}`)}return b}function ms(o,e,t){let n=e,a=e+1,s=o[a];for(;s===" "||s==="	";)if(e<a+t)s=o[++e];else{do s=o[++e];while(s&&s!==`
`);n=e,a=e+1,s=o[a]}return n}var ya,fn,St,gs=N(()=>{ya="flow",fn="block",St="quoted"});function Bi(o,e,t){if(!e||e<0)return!1;let n=e-t,a=o.length;if(a<=n)return!1;for(let s=0,r=0;s<a;++s)if(o[s]===`
...
`,l+=2;r+=s,t[l+2]===" "&&(r+="\\"),l+=1,i=l+1}break;default:l+=1}return r=i?r+t.slice(i):t,n?r:xt(r,s,St,un(e,!1))}function ba(o,e){if(e.options.singleQuote===!1||e.implicitKey&&o.includes(`
`)||/[ \t]\n|\n[ \t]/.test(o))return Tt(o,e);let t=e.indent||(hn(o)?"  ":""),n="'"+o.replace(/'/g,"''").replace(/\n+/g,`$&
${t}`)+"'";return e.implicitKey?n:xt(n,t,ya,un(e,!1))}function $e(o,e){let{singleQuote:t}=e.options,n;if(t===!1)n=Tt;else{let a=o.includes('"'),s=o.includes("'");a&&!s?n=ba:s&&!a?n=Tt:n=t?ba:Tt}return n(o,e)}function pn({comment:o,type:e,value:t},n,a,s){let{blockQuote:r,commentString:i,lineWidth:l}=n.options;if(!r||/\n[\t ]+$/.test(t))return $e(t,n);let c=n.indent||(n.forceBlockIndent||hn(t)?"  ":""),f=r==="literal"?!0:r==="folded"||e===E.BLOCK_FOLDED?!1:e===E.BLOCK_LITERAL?!0:!Bi(t,l,c.length);if(!t)return f?`|
`:`>
...
`&&(h=h.slice(0,-1)),h=h.replace(wa,`$&${c}`));let u=!1,g,y=-1;for(g=0;g<t.length;++g){let T=t[g];if(T===" ")u=!0;else if(T===`
...
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${c}`),x=!1,L=un(n,!0);r!=="folded"&&e!==E.BLOCK_FOLDED&&(L.onOverflow=()=>{x=!0});let w=xt(`${b}${T}${h}`,c,fn,L);if(!x)return`>${S}
...
`)?$e(s,e):pn(o,e,t,n);if(!i&&!f&&a!==E.PLAIN&&s.includes(`
`))return pn(o,e,t,n);if(hn(s)){if(l==="")return e.forceBlockIndent=!0,pn(o,e,t,n);if(i&&l===c)return $e(s,e)}let d=s.replace(/\n+/g,`$&
${l}`);if(r){let p=u=>u.default&&u.tag!=="tag:yaml.org,2002:str"&&u.test?.test(d),{compat:h,tags:m}=e.doc.schema;if(m.some(p)||h?.some(p))return $e(s,e)}return i?d:xt(d,l,ya,un(e,!1))}function Ne(o,e,t,n){let{implicitKey:a,inFlow:s}=e,r=typeof o.value=="string"?o:Object.assign({},o,{value:String(o.value)}),{type:i}=o;i!==E.QUOTE_DOUBLE&&/[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(r.value)&&(i=E.QUOTE_DOUBLE);let l=f=>{switch(f){case E.BLOCK_FOLDED:case E.BLOCK_LITERAL:return a||s?$e(r.value,e):pn(r,e,t,n);case E.QUOTE_DOUBLE:return Tt(r.value,e);case E.QUOTE_SINGLE:return ba(r.value,e);case E.PLAIN:return qi(r,e,t,n);default:return null}},c=l(i);if(c===null){let{defaultKeyType:f,defaultStringType:d}=e.options,p=a&&f||d;if(c=l(p),c===null)throw new Error(`Unsupported default string type ${p}`)}return c}var un,hn,wa,Nt=N(()=>{K();gs();un=(o,e)=>({indentAtStart:e?o.indent.length:o.indentAtStart,lineWidth:o.options.lineWidth,minContentWidth:o.options.minContentWidth}),hn=o=>/^(%|---|\.\.\.)/m.test(o);try{wa=new RegExp(`(^|(?<!
))
+(?!
|$)`,"g")}catch{wa=/\n+(?!\n|$)/g}});function mn(o,e){let t=Object.assign({blockQuote:!0,commentString:hs,defaultKeyType:null,defaultStringType:"PLAIN",directives:null,doubleQuotedAsJSON:!1,doubleQuotedMinMultiLineLength:40,falseStr:"false",flowCollectionPadding:!0,indentSeq:!0,lineWidth:80,minContentWidth:20,nullStr:"null",simpleKeys:!1,singleQuote:null,trailingComma:!1,trueStr:"true",verifyAliasOrder:!0},o.schema.toStringOptions,e),n;switch(t.collectionStyle){case"block":n=!1;break;case"flow":n=!0;break;default:n=null}return{anchors:new Set,doc:o,flowCollectionPadding:t.flowCollectionPadding?" ":"",indent:"",indentStep:typeof t.indent=="number"?" ".repeat(t.indent):"  ",inFlow:n,options:t}}function Hi(o,e){if(e.tag){let a=o.filter(s=>s.tag===e.tag);if(a.length>0)return a.find(s=>s.format===e.format)??a[0]}let t,n;if(M(e)){n=e.value;let a=o.filter(s=>s.identify?.(n));if(a.length>1){let s=a.filter(r=>r.test);s.length>0&&(a=s)}t=a.find(s=>s.format===e.format)??a.find(s=>!s.format)}else n=e,t=o.find(a=>a.nodeClass&&n instanceof a.nodeClass);if(!t){let a=n?.constructor?.name??(n===null?"null":typeof n);throw new Error(`Tag not resolved for ${a} value`)}return t}function ji(o,e,{anchors:t,doc:n}){if(!n.directives)return"";let a=[],s=(M(o)||H(o))&&o.anchor;s&&on(s)&&(t.add(s),a.push(`&${s}`));let r=o.tag??(e.default?null:e.tag);return r&&a.push(n.directives.tagString(r)),a.join(" ")}function Ee(o,e,t,n){if(P(o))return o.toString(e,t,n);if(te(o)){if(e.doc.directives)return o.toString(e);if(e.resolvedAliases?.has(o))throw new TypeError("Cannot stringify circular structure without alias nodes");e.resolvedAliases?e.resolvedAliases.add(o):e.resolvedAliases=new Set([o]),o=o.resolve(e.doc)}let a,s=U(o)?o:e.doc.createNode(o,{onTagObj:l=>a=l});a??(a=Hi(e.doc.schema.tags,s));let r=ji(s,a,e);r.length>0&&(e.indentAtStart=(e.indentAtStart??0)+r.length+1);let i=typeof a.stringify=="function"?a.stringify(s,e,t,n):M(s)?Ne(s,e,t,n):s.toString(e,t,n);return r?M(s)||i[0]==="{"||i[0]==="["?`${r} ${i}`:`${r}
${e.indent}${i}`:i}var Et=N(()=>{sn();q();vt();Nt()});function ys({key:o,value:e},t,n,a){let{allNullValues:s,doc:r,indent:i,indentStep:l,options:{commentString:c,indentSeq:f,simpleKeys:d}}=t,p=U(o)&&o.comment||null;if(d){if(p)throw new Error("With simple keys, key nodes cannot have comments");if(H(o)||!U(o)&&typeof o=="object"){let L="With simple keys, collection cannot be used as a key value";throw new Error(L)}}let h=!d&&(!o||p&&e==null&&!t.inFlow||H(o)||(M(o)?o.type===E.BLOCK_FOLDED||o.type===E.BLOCK_LITERAL:typeof o=="object"));t=Object.assign({},t,{allNullValues:!1,implicitKey:!h&&(d||!s),indent:i+l});let m=!1,u=!1,g=Ee(o,t,()=>m=!0,()=>u=!0);if(!h&&!t.inFlow&&g.length>1024){if(d)throw new Error("With simple keys, single line scalar must not span more than 1024 characters");h=!0}if(t.inFlow){if(s||e==null)return m&&n&&n(),g===""?"?":h?`? ${g}`:g}else if(s&&!d||e==null&&h)return g=`? ${g}`,p&&!m?g+=we(g,t.indent,c(p)):u&&a&&a(),g;m&&(p=null),h?(p&&(g+=we(g,t.indent,c(p))),g=`? ${g}
${i}:`):(g=`${g}:`,p&&(g+=we(g,t.indent,c(p))));let y,b,k;U(e)?(y=!!e.spaceBefore,b=e.commentBefore,k=e.comment):(y=!1,b=null,k=null,e&&typeof e=="object"&&(e=r.createNode(e))),t.implicitKey=!1,!h&&!p&&M(e)&&(t.indentAtStart=g.length+1),u=!1,!f&&l.length>=2&&!t.inFlow&&!h&&oe(e)&&!e.flow&&!e.tag&&!e.anchor&&(t.indent=t.indent.substring(2));let S=!1,T=Ee(e,t,()=>S=!0,()=>u=!0),x=" ";if(p||y||b){if(x=y?`
`:"",b){let L=c(b);x+=`
${re(L,t.indent)}`}T===""&&!t.inFlow?x===`
`&&k&&(x=`

`):x+=`
${t.indent}`}else if(!h&&H(e)){let L=T[0],w=T.indexOf(`
`),v=w!==-1,C=t.inFlow??e.flow??e.items.length===0;if(v||!C){let D=!1;if(v&&(L==="&"||L==="!")){let F=T.indexOf(" ");L==="&"&&F!==-1&&F<w&&T[F+1]==="!"&&(F=T.indexOf(" ",F+1)),(F===-1||w<F)&&(D=!0)}D||(x=`
${t.indent}`)}}else(T===""||T[0]===`
`)&&(x="");return g+=x+T,t.inFlow?S&&n&&n():k&&!S?g+=we(g,t.indent,c(k)):u&&a&&a(),g}var bs=N(()=>{q();K();Et();vt()});function gn(o,e){(o==="debug"||o==="warn")&&console.warn(e)}var ka=N(()=>{});function Sa(o,e,t){let n=ks(o,t);if(oe(n))for(let a of n.items)va(o,e,a);else if(Array.isArray(n))for(let a of n)va(o,e,a);else va(o,e,n)}function va(o,e,t){let n=ks(o,t);if(!ae(n))throw new Error("Merge sources must be maps or map aliases");let a=n.toJSON(null,o,Map);for(let[s,r]of a)e instanceof Map?e.has(s)||e.set(s,r):e instanceof Set?e.add(s):Object.prototype.hasOwnProperty.call(e,s)||Object.defineProperty(e,s,{value:r,writable:!0,enumerable:!0,configurable:!0});return e}function ks(o,e){return o&&te(e)?e.resolve(o.doc,o):e}var yn,fe,ws,bn=N(()=>{q();K();yn="<<",fe={identify:o=>o===yn||typeof o=="symbol"&&o.description===yn,default:"key",tag:"tag:yaml.org,2002:merge",test:/^<<$/,resolve:()=>Object.assign(new E(Symbol(yn)),{addToJSMap:Sa}),stringify:()=>yn},ws=(o,e)=>(fe.identify(e)||M(e)&&(!e.type||e.type===E.PLAIN)&&fe.identify(e.value))&&o?.doc.schema.tags.some(t=>t.tag===fe.tag&&t.default)});function wn(o,e,{key:t,value:n}){if(U(t)&&t.addToJSMap)t.addToJSMap(o,e,n);else if(ws(o,t))Sa(o,e,n);else{let a=G(t,"",o);if(e instanceof Map)e.set(a,G(n,a,o));else if(e instanceof Set)e.add(a);else{let s=Vi(t,a,o),r=G(n,s,o);s in e?Object.defineProperty(e,s,{value:r,writable:!0,enumerable:!0,configurable:!0}):e[s]=r}}return e}function Vi(o,e,t){if(e===null)return"";if(typeof e!="object")return String(e);if(U(o)&&t?.doc){let n=mn(t.doc,{});n.anchors=new Set;for(let s of t.anchors.keys())n.anchors.add(s.anchor);n.inFlow=!0,n.inStringifyKey=!0;let a=o.toString(n);if(!t.mapKeyWarned){let s=JSON.stringify(a);s.length>40&&(s=s.substring(0,36)+'..."'),gn(t.doc.options.logLevel,`Keys with collection values will be stringified due to JS Object restrictions: ${s}. Set mapAsMap: true to use object keys.`),t.mapKeyWarned=!0}return a}return JSON.stringify(e)}var xa=N(()=>{ka();bn();Et();q();Fe()});function et(o,e,t){let n=Te(o,void 0,t),a=Te(e,void 0,t);return new V(n,a)}var V,De=N(()=>{wt();bs();xa();q();V=class o{constructor(e,t=null){Object.defineProperty(this,Z,{value:pa}),this.key=e,this.value=t}clone(e){let{key:t,value:n}=this;return U(t)&&(t=t.clone(e)),U(n)&&(n=n.clone(e)),new o(t,n)}toJSON(e,t){let n=t?.mapAsMap?new Map:{};return wn(t,n,this)}toString(e,t,n){return e?.doc?ys(this,e,t,n):JSON.stringify(this)}}});function vn(o,e,t){return(e.inFlow??o.flow?Ki:_i)(o,e,t)}function _i({comment:o,items:e},t,{blockItemPrefix:n,flowChars:a,itemIndent:s,onChompKeep:r,onComment:i}){let{indent:l,options:{commentString:c}}=t,f=Object.assign({},t,{indent:s,type:null}),d=!1,p=[];for(let m=0;m<e.length;++m){let u=e[m],g=null;if(U(u))!d&&u.spaceBefore&&p.push(""),kn(t,p,u.commentBefore,d),u.comment&&(g=u.comment);else if(P(u)){let b=U(u.key)?u.key:null;b&&(!d&&b.spaceBefore&&p.push(""),kn(t,p,b.commentBefore,d))}d=!1;let y=Ee(u,f,()=>g=null,()=>d=!0);g&&(y+=we(y,s,c(g))),d&&g&&(d=!1),p.push(n+y)}let h;if(p.length===0)h=a.start+a.end;else{h=p[0];for(let m=1;m<p.length;++m){let u=p[m];h+=u?`
${l}${u}`:`
`}}return o?(h+=`
`+re(c(o),l),i&&i()):d&&r&&r(),h}function Ki({items:o},e,{flowChars:t,itemIndent:n}){let{indent:a,indentStep:s,flowCollectionPadding:r,options:{commentString:i}}=e;n+=s;let l=Object.assign({},e,{indent:n,inFlow:!0,type:null}),c=!1,f=0,d=[];for(let m=0;m<o.length;++m){let u=o[m],g=null;if(U(u))u.spaceBefore&&d.push(""),kn(e,d,u.commentBefore,!1),u.comment&&(g=u.comment);else if(P(u)){let b=U(u.key)?u.key:null;b&&(b.spaceBefore&&d.push(""),kn(e,d,b.commentBefore,!1),b.comment&&(c=!0));let k=U(u.value)?u.value:null;k?(k.comment&&(g=k.comment),k.commentBefore&&(c=!0)):u.value==null&&b?.comment&&(g=b.comment)}g&&(c=!0);let y=Ee(u,l,()=>g=null);c||(c=d.length>f||y.includes(`
`)),m<o.length-1?y+=",":e.options.trailingComma&&(e.options.lineWidth>0&&(c||(c=d.reduce((b,k)=>b+k.length+2,2)+(y.length+2)>e.options.lineWidth)),c&&(y+=",")),g&&(y+=we(y,n,i(g))),d.push(y),f=d.length}let{start:p,end:h}=t;if(d.length===0)return p+h;if(!c){let m=d.reduce((u,g)=>u+g.length+2,2);c=e.options.lineWidth>0&&m>e.options.lineWidth}if(c){let m=p;for(let u of d)m+=u?`
${s}${a}${u}`:`
`;return`${m}
${a}${h}`}else return`${p}${r}${d.join(" ")}${r}${h}`}function kn({indent:o,options:{commentString:e}},t,n,a){if(n&&a&&(n=n.replace(/^\n+/,"")),n){let s=re(e(n),o);t.push(s.trimStart())}}var Ta=N(()=>{q();Et();vt()});function Me(o,e){let t=M(e)?e.value:e;for(let n of o)if(P(n)&&(n.key===e||n.key===t||M(n.key)&&n.key.value===t))return n}var _,Oe=N(()=>{Ta();xa();dn();q();De();K();_=class extends Ye{static get tagName(){return"tag:yaml.org,2002:map"}constructor(e){super(ce,e),this.items=[]}static from(e,t,n){let{keepUndefined:a,replacer:s}=n,r=new this(e),i=(l,c)=>{if(typeof s=="function")c=s.call(t,l,c);else if(Array.isArray(s)&&!s.includes(l))return;(c!==void 0||a)&&r.items.push(et(l,c,n))};if(t instanceof Map)for(let[l,c]of t)i(l,c);else if(t&&typeof t=="object")for(let l of Object.keys(t))i(l,t[l]);return typeof e.sortMapEntries=="function"&&r.items.sort(e.sortMapEntries),r}add(e,t){let n;P(e)?n=e:!e||typeof e!="object"||!("key"in e)?n=new V(e,e?.value):n=new V(e.key,e.value);let a=Me(this.items,n.key),s=this.schema?.sortMapEntries;if(a){if(!t)throw new Error(`Key ${n.key} already set`);M(a.value)&&cn(n.value)?a.value.value=n.value:a.value=n.value}else if(s){let r=this.items.findIndex(i=>s(n,i)<0);r===-1?this.items.push(n):this.items.splice(r,0,n)}else this.items.push(n)}delete(e){let t=Me(this.items,e);return t?this.items.splice(this.items.indexOf(t),1).length>0:!1}get(e,t){let a=Me(this.items,e)?.value;return(!t&&M(a)?a.value:a)??void 0}has(e){return!!Me(this.items,e)}set(e,t){this.add(new V(e,t),!0)}toJSON(e,t,n){let a=n?new n:t?.mapAsMap?new Map:{};t?.onCreate&&t.onCreate(a);for(let s of this.items)wn(t,a,s);return a}toString(e,t,n){if(!e)return JSON.stringify(this);for(let a of this.items)if(!P(a))throw new Error(`Map items must all be pairs; found ${JSON.stringify(a)} instead`);return!e.allNullValues&&this.hasAllNullValues(!1)&&(e=Object.assign({},e,{allNullValues:!0})),vn(this,e,{blockItemPrefix:"",flowChars:{start:"{",end:"}"},itemIndent:e.indent||"",onChompKeep:n,onComment:t})}}});var pe,tt=N(()=>{q();Oe();pe={collection:"map",default:!0,nodeClass:_,tag:"tag:yaml.org,2002:map",resolve(o,e){return ae(o)||e("Expected a mapping for this tag"),o},createNode:(o,e,t)=>_.from(o,e,t)}});function Sn(o){let e=M(o)?o.value:o;return e&&typeof e=="string"&&(e=Number(e)),typeof e=="number"&&Number.isInteger(e)&&e>=0?e:null}var z,Re=N(()=>{wt();Ta();dn();q();K();Fe();z=class extends Ye{static get tagName(){return"tag:yaml.org,2002:seq"}constructor(e){super(xe,e),this.items=[]}add(e){this.items.push(e)}delete(e){let t=Sn(e);return typeof t!="number"?!1:this.items.splice(t,1).length>0}get(e,t){let n=Sn(e);if(typeof n!="number")return;let a=this.items[n];return!t&&M(a)?a.value:a}has(e){let t=Sn(e);return typeof t=="number"&&t<this.items.length}set(e,t){let n=Sn(e);if(typeof n!="number")throw new Error(`Expected a valid index, not ${e}.`);let a=this.items[n];M(a)&&cn(t)?a.value=t:this.items[n]=t}toJSON(e,t){let n=[];t?.onCreate&&t.onCreate(n);let a=0;for(let s of this.items)n.push(G(s,String(a++),t));return n}toString(e,t,n){return e?vn(this,e,{blockItemPrefix:"- ",flowChars:{start:"[",end:"]"},itemIndent:(e.indent||"")+"  ",onChompKeep:n,onComment:t}):JSON.stringify(this)}static from(e,t,n){let{replacer:a}=n,s=new this(e);if(t&&Symbol.iterator in Object(t)){let r=0;for(let i of t){if(typeof a=="function"){let l=t instanceof Set?i:String(r++);i=a.call(t,l,i)}s.items.push(Te(i,void 0,n))}}return s}}});var ue,nt=N(()=>{q();Re();ue={collection:"seq",default:!0,nodeClass:z,tag:"tag:yaml.org,2002:seq",resolve(o,e){return oe(o)||e("Expected a sequence for this tag"),o},createNode:(o,e,t)=>z.from(o,e,t)}});var Ie,Ct=N(()=>{Nt();Ie={identify:o=>typeof o=="string",default:!0,tag:"tag:yaml.org,2002:str",resolve:o=>o,stringify(o,e,t,n){return e=Object.assign({actualString:!0},e),Ne(o,e,t,n)}}});var Ve,xn=N(()=>{K();Ve={identify:o=>o==null,createNode:()=>new E(null),default:!0,tag:"tag:yaml.org,2002:null",test:/^(?:~|[Nn]ull|NULL)?$/,resolve:()=>new E(null),stringify:({source:o},e)=>typeof o=="string"&&Ve.test.test(o)?o:e.options.nullStr}});var Lt,Na=N(()=>{K();Lt={identify:o=>typeof o=="boolean",default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:[Tt]rue|TRUE|[Ff]alse|FALSE)$/,resolve:o=>new E(o[0]==="t"||o[0]==="T"),stringify({source:o,value:e},t){if(o&&Lt.test.test(o)){let n=o[0]==="t"||o[0]==="T";if(e===n)return o}return e?t.options.trueStr:t.options.falseStr}}});function X({format:o,minFractionDigits:e,tag:t,value:n}){if(typeof n=="bigint")return String(n);let a=typeof n=="number"?n:Number(n);if(!isFinite(a))return isNaN(a)?".nan":a<0?"-.inf":".inf";let s=Object.is(n,-0)?"-0":JSON.stringify(n);if(!o&&e&&(!t||t==="tag:yaml.org,2002:float")&&/^-?\d/.test(s)&&!s.includes("e")){let r=s.indexOf(".");r<0&&(r=s.length,s+=".");let i=e-(s.length-r-1);for(;i-- >0;)s+="0"}return s}var at=N(()=>{});var Tn,Nn,En,Ea=N(()=>{K();at();Tn={identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^(?:[-+]?\.(?:inf|Inf|INF)|\.nan|\.NaN|\.NAN)$/,resolve:o=>o.slice(-3).toLowerCase()==="nan"?NaN:o[0]==="-"?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY,stringify:X},Nn={identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"EXP",test:/^[-+]?(?:\.[0-9]+|[0-9]+(?:\.[0-9]*)?)[eE][-+]?[0-9]+$/,resolve:o=>parseFloat(o),stringify(o){let e=Number(o.value);return isFinite(e)?e.toExponential():X(o)}},En={identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^[-+]?(?:\.[0-9]+|[0-9]+\.[0-9]*)$/,resolve(o){let e=new E(parseFloat(o)),t=o.indexOf(".");return t!==-1&&o[o.length-1]==="0"&&(e.minFractionDigits=o.length-t-1),e},stringify:X}});function vs(o,e,t){let{value:n}=o;return Cn(n)&&n>=0?t+n.toString(e):X(o)}var Cn,Ca,Ln,Fn,An,La=N(()=>{at();Cn=o=>typeof o=="bigint"||Number.isInteger(o),Ca=(o,e,t,{intAsBigInt:n})=>n?BigInt(o):parseInt(o.substring(e),t);Ln={identify:o=>Cn(o)&&o>=0,default:!0,tag:"tag:yaml.org,2002:int",format:"OCT",test:/^0o[0-7]+$/,resolve:(o,e,t)=>Ca(o,2,8,t),stringify:o=>vs(o,8,"0o")},Fn={identify:Cn,default:!0,tag:"tag:yaml.org,2002:int",test:/^[-+]?[0-9]+$/,resolve:(o,e,t)=>Ca(o,0,10,t),stringify:X},An={identify:o=>Cn(o)&&o>=0,default:!0,tag:"tag:yaml.org,2002:int",format:"HEX",test:/^0x[0-9a-fA-F]+$/,resolve:(o,e,t)=>Ca(o,2,16,t),stringify:o=>vs(o,16,"0x")}});var Ss,xs=N(()=>{tt();xn();nt();Ct();Na();Ea();La();Ss=[pe,ue,Ie,Ve,Lt,Ln,Fn,An,Tn,Nn,En]});function Ts(o){return typeof o=="bigint"||Number.isInteger(o)}var Dn,Gi,Wi,Ns,Es=N(()=>{K();tt();nt();Dn=({value:o})=>JSON.stringify(o),Gi=[{identify:o=>typeof o=="string",default:!0,tag:"tag:yaml.org,2002:str",resolve:o=>o,stringify:Dn},{identify:o=>o==null,createNode:()=>new E(null),default:!0,tag:"tag:yaml.org,2002:null",test:/^null$/,resolve:()=>null,stringify:Dn},{identify:o=>typeof o=="boolean",default:!0,tag:"tag:yaml.org,2002:bool",test:/^true$|^false$/,resolve:o=>o==="true",stringify:Dn},{identify:Ts,default:!0,tag:"tag:yaml.org,2002:int",test:/^-?(?:0|[1-9][0-9]*)$/,resolve:(o,e,{intAsBigInt:t})=>t?BigInt(o):parseInt(o,10),stringify:({value:o})=>Ts(o)?o.toString():JSON.stringify(o)},{identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^-?(?:0|[1-9][0-9]*)(?:\.[0-9]*)?(?:[eE][-+]?[0-9]+)?$/,resolve:o=>parseFloat(o),stringify:Dn}],Wi={default:!0,tag:"",test:/^/,resolve(o,e){return e(`Unresolved plain scalar ${JSON.stringify(o)}`),o}},Ns=[pe,ue].concat(Gi,Wi)});var Ft,Fa=N(()=>{K();Nt();Ft={identify:o=>o instanceof Uint8Array,default:!1,tag:"tag:yaml.org,2002:binary",resolve(o,e){if(typeof atob=="function"){let t=atob(o.replace(/[\n\r]/g,"")),n=new Uint8Array(t.length);for(let a=0;a<t.length;++a)n[a]=t.charCodeAt(a);return n}else return e("This environment does not support reading binary tags; either Buffer or atob is required"),o},stringify({comment:o,type:e,value:t},n,a,s){if(!t)return"";let r=t,i;if(typeof btoa=="function"){let l="";for(let c=0;c<r.length;++c)l+=String.fromCharCode(r[c]);i=btoa(l)}else throw new Error("This environment does not support writing binary tags; either Buffer or btoa is required");if(e??(e=E.BLOCK_LITERAL),e!==E.QUOTE_DOUBLE){let l=Math.max(n.options.lineWidth-n.indent.length,n.options.minContentWidth),c=Math.ceil(i.length/l),f=new Array(c);for(let d=0,p=0;d<c;++d,p+=l)f[d]=i.substr(p,l);i=f.join(e===E.BLOCK_LITERAL?`
`:" ")}return Ne({comment:o,type:e,value:i},n,a,s)}}});function Aa(o,e){if(oe(o))for(let t=0;t<o.items.length;++t){let n=o.items[t];if(!P(n)){if(ae(n)){n.items.length>1&&e("Each pair must have its own sequence indicator");let a=n.items[0]||new V(new E(null));if(n.commentBefore&&(a.key.commentBefore=a.key.commentBefore?`${n.commentBefore}
${a.key.commentBefore}`:n.commentBefore),n.comment){let s=a.value??a.key;s.comment=s.comment?`${n.comment}
${s.comment}`:n.comment}n=a}o.items[t]=P(n)?n:new V(n)}}else e("Expected a sequence for this tag");return o}function Da(o,e,t){let{replacer:n}=t,a=new z(o);a.tag="tag:yaml.org,2002:pairs";let s=0;if(e&&Symbol.iterator in Object(e))for(let r of e){typeof n=="function"&&(r=n.call(e,String(s++),r));let i,l;if(Array.isArray(r))if(r.length===2)i=r[0],l=r[1];else throw new TypeError(`Expected [key, value] tuple: ${r}`);else if(r&&r instanceof Object){let c=Object.keys(r);if(c.length===1)i=c[0],l=r[i];else throw new TypeError(`Expected tuple with one key, not ${c.length} keys`)}else i=r;a.items.push(et(i,l,t))}return a}var At,Mn=N(()=>{q();De();K();Re();At={collection:"seq",default:!1,tag:"tag:yaml.org,2002:pairs",resolve:Aa,createNode:Da}});var ot,Dt,Ma=N(()=>{q();Fe();Oe();Re();Mn();ot=class o extends z{constructor(){super(),this.add=_.prototype.add.bind(this),this.delete=_.prototype.delete.bind(this),this.get=_.prototype.get.bind(this),this.has=_.prototype.has.bind(this),this.set=_.prototype.set.bind(this),this.tag=o.tag}toJSON(e,t){if(!t)return super.toJSON(e);let n=new Map;t?.onCreate&&t.onCreate(n);for(let a of this.items){let s,r;if(P(a)?(s=G(a.key,"",t),r=G(a.value,s,t)):s=G(a,"",t),n.has(s))throw new Error("Ordered maps must not include duplicate keys");n.set(s,r)}return n}static from(e,t,n){let a=Da(e,t,n),s=new this;return s.items=a.items,s}};ot.tag="tag:yaml.org,2002:omap";Dt={collection:"seq",identify:o=>o instanceof Map,nodeClass:ot,default:!1,tag:"tag:yaml.org,2002:omap",resolve(o,e){let t=Aa(o,e),n=[];for(let{key:a}of t.items)M(a)&&(n.includes(a.value)?e(`Ordered maps must not include duplicate keys: ${a.value}`):n.push(a.value));return Object.assign(new ot,t)},createNode:(o,e,t)=>ot.from(o,e,t)}});function Cs({value:o,source:e},t){return e&&(o?Oa:Ra).test.test(e)?e:o?t.options.trueStr:t.options.falseStr}var Oa,Ra,Ls=N(()=>{K();Oa={identify:o=>o===!0,default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:Y|y|[Yy]es|YES|[Tt]rue|TRUE|[Oo]n|ON)$/,resolve:()=>new E(!0),stringify:Cs},Ra={identify:o=>o===!1,default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:N|n|[Nn]o|NO|[Ff]alse|FALSE|[Oo]ff|OFF)$/,resolve:()=>new E(!1),stringify:Cs}});var Fs,As,Ds,Ms=N(()=>{K();at();Fs={identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^(?:[-+]?\.(?:inf|Inf|INF)|\.nan|\.NaN|\.NAN)$/,resolve:o=>o.slice(-3).toLowerCase()==="nan"?NaN:o[0]==="-"?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY,stringify:X},As={identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"EXP",test:/^[-+]?(?:[0-9][0-9_]*)?(?:\.[0-9_]*)?[eE][-+]?[0-9]+$/,resolve:o=>parseFloat(o.replace(/_/g,"")),stringify(o){let e=Number(o.value);return isFinite(e)?e.toExponential():X(o)}},Ds={identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^[-+]?(?:[0-9][0-9_]*)?\.[0-9_]*$/,resolve(o){let e=new E(parseFloat(o.replace(/_/g,""))),t=o.indexOf(".");if(t!==-1){let n=o.substring(t+1).replace(/_/g,"");n[n.length-1]==="0"&&(e.minFractionDigits=n.length)}return e},stringify:X}});function On(o,e,t,{intAsBigInt:n}){let a=o[0];if((a==="-"||a==="+")&&(e+=1),o=o.substring(e).replace(/_/g,""),n){switch(t){case 2:o=`0b${o}`;break;case 8:o=`0o${o}`;break;case 16:o=`0x${o}`;break}let r=BigInt(o);return a==="-"?BigInt(-1)*r:r}let s=parseInt(o,t);return a==="-"?-1*s:s}function Ia(o,e,t){let{value:n}=o;if(Mt(n)){let a=n.toString(e);return n<0?"-"+t+a.substr(1):t+a}return X(o)}var Mt,Os,Rs,Is,Ps,Us=N(()=>{at();Mt=o=>typeof o=="bigint"||Number.isInteger(o);Os={identify:Mt,default:!0,tag:"tag:yaml.org,2002:int",format:"BIN",test:/^[-+]?0b[0-1_]+$/,resolve:(o,e,t)=>On(o,2,2,t),stringify:o=>Ia(o,2,"0b")},Rs={identify:Mt,default:!0,tag:"tag:yaml.org,2002:int",format:"OCT",test:/^[-+]?0[0-7_]+$/,resolve:(o,e,t)=>On(o,1,8,t),stringify:o=>Ia(o,8,"0")},Is={identify:Mt,default:!0,tag:"tag:yaml.org,2002:int",test:/^[-+]?[0-9][0-9_]*$/,resolve:(o,e,t)=>On(o,0,10,t),stringify:X},Ps={identify:Mt,default:!0,tag:"tag:yaml.org,2002:int",format:"HEX",test:/^[-+]?0x[0-9a-fA-F_]+$/,resolve:(o,e,t)=>On(o,2,16,t),stringify:o=>Ia(o,16,"0x")}});var st,Ot,Pa=N(()=>{q();De();Oe();st=class o extends _{constructor(e){super(e),this.tag=o.tag}add(e){let t;P(e)?t=e:e&&typeof e=="object"&&"key"in e&&"value"in e&&e.value===null?t=new V(e.key,null):t=new V(e,null),Me(this.items,t.key)||this.items.push(t)}get(e,t){let n=Me(this.items,e);return!t&&P(n)?M(n.key)?n.key.value:n.key:n}set(e,t){if(typeof t!="boolean")throw new Error(`Expected boolean value for set(key, value) in a YAML set, not ${typeof t}`);let n=Me(this.items,e);n&&!t?this.items.splice(this.items.indexOf(n),1):!n&&t&&this.items.push(new V(e))}toJSON(e,t){return super.toJSON(e,t,Set)}toString(e,t,n){if(!e)return JSON.stringify(this);if(this.hasAllNullValues(!0))return super.toString(Object.assign({},e,{allNullValues:!0}),t,n);throw new Error("Set items must all have null values")}static from(e,t,n){let{replacer:a}=n,s=new this(e);if(t&&Symbol.iterator in Object(t))for(let r of t)typeof a=="function"&&(r=a.call(t,r,r)),s.items.push(et(r,null,n));return s}};st.tag="tag:yaml.org,2002:set";Ot={collection:"map",identify:o=>o instanceof Set,nodeClass:st,default:!1,tag:"tag:yaml.org,2002:set",createNode:(o,e,t)=>st.from(o,e,t),resolve(o,e){if(ae(o)){if(o.hasAllNullValues(!0))return Object.assign(new st,o);e("Set items must all have null values")}else e("Expected a mapping for this tag");return o}}});function Ua(o,e){let t=o[0],n=t==="-"||t==="+"?o.substring(1):o,a=r=>e?BigInt(r):Number(r),s=n.replace(/_/g,"").split(":").reduce((r,i)=>r*a(60)+a(i),a(0));return t==="-"?a(-1)*s:s}function Bs(o){let{value:e}=o,t=r=>r;if(typeof e=="bigint")t=r=>BigInt(r);else if(isNaN(e)||!isFinite(e))return X(o);let n="";e<0&&(n="-",e*=t(-1));let a=t(60),s=[e%a];return e<60?s.unshift(0):(e=(e-s[0])/a,s.unshift(e%a),e>=60&&(e=(e-s[0])/a,s.unshift(e))),n+s.map(r=>String(r).padStart(2,"0")).join(":").replace(/000000\d*$/,"")}var Rn,In,rt,Ba=N(()=>{at();Rn={identify:o=>typeof o=="bigint"||Number.isInteger(o),default:!0,tag:"tag:yaml.org,2002:int",format:"TIME",test:/^[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+$/,resolve:(o,e,{intAsBigInt:t})=>Ua(o,t),stringify:Bs},In={identify:o=>typeof o=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"TIME",test:/^[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+\.[0-9_]*$/,resolve:o=>Ua(o,!1),stringify:Bs},rt={identify:o=>o instanceof Date,default:!0,tag:"tag:yaml.org,2002:timestamp",test:RegExp("^([0-9]{4})-([0-9]{1,2})-([0-9]{1,2})(?:(?:t|T|[ \\t]+)([0-9]{1,2}):([0-9]{1,2}):([0-9]{1,2}(\\.[0-9]+)?)(?:[ \\t]*(Z|[-+][012]?[0-9](?::[0-9]{2})?))?)?$"),resolve(o){let e=o.match(rt.test);if(!e)throw new Error("!!timestamp expects a date, starting with yyyy-mm-dd");let[,t,n,a,s,r,i]=e.map(Number),l=e[7]?Number((e[7]+"00").substr(1,3)):0,c=Date.UTC(t,n-1,a,s||0,r||0,i||0,l),f=e[8];if(f&&f!=="Z"){let d=Ua(f,!1);Math.abs(d)<30&&(d*=60),c-=6e4*d}return new Date(c)},stringify:({value:o})=>o?.toISOString().replace(/(T00:00:00)?\.000Z$/,"")??""}});var qa,qs=N(()=>{tt();xn();nt();Ct();Fa();Ls();Ms();Us();bn();Ma();Mn();Pa();Ba();qa=[pe,ue,Ie,Ve,Oa,Ra,Os,Rs,Is,Ps,Fs,As,Ds,Ft,fe,Dt,At,Ot,Rn,In,rt]});function Pn(o,e,t){let n=Hs.get(e);if(n&&!o)return t&&!n.includes(fe)?n.concat(fe):n.slice();let a=n;if(!a)if(Array.isArray(o))a=[];else{let s=Array.from(Hs.keys()).filter(r=>r!=="yaml11").map(r=>JSON.stringify(r)).join(", ");throw new Error(`Unknown schema "${e}"; use one of ${s} or define customTags array`)}if(Array.isArray(o))for(let s of o)a=a.concat(s);else typeof o=="function"&&(a=o(a.slice()));return t&&(a=a.concat(fe)),a.reduce((s,r)=>{let i=typeof r=="string"?js[r]:r;if(!i){let l=JSON.stringify(r),c=Object.keys(js).map(f=>JSON.stringify(f)).join(", ");throw new Error(`Unknown custom tag ${l}; use one of ${c}`)}return s.includes(i)||s.push(i),s},[])}var Hs,js,Vs,_s=N(()=>{tt();xn();nt();Ct();Na();Ea();La();xs();Es();Fa();bn();Ma();Mn();qs();Pa();Ba();Hs=new Map([["core",Ss],["failsafe",[pe,ue,Ie]],["json",Ns],["yaml11",qa],["yaml-1.1",qa]]),js={binary:Ft,bool:Lt,float:En,floatExp:Nn,floatNaN:Tn,floatTime:In,int:Fn,intHex:An,intOct:Ln,intTime:Rn,map:pe,merge:fe,null:Ve,omap:Dt,pairs:At,seq:ue,set:Ot,timestamp:rt},Vs={"tag:yaml.org,2002:binary":Ft,"tag:yaml.org,2002:merge":fe,"tag:yaml.org,2002:omap":Dt,"tag:yaml.org,2002:pairs":At,"tag:yaml.org,2002:set":Ot,"tag:yaml.org,2002:timestamp":rt}});var zi,_e,Ha=N(()=>{q();tt();nt();Ct();_s();zi=(o,e)=>o.key<e.key?-1:o.key>e.key?1:0,_e=class o{constructor({compat:e,customTags:t,merge:n,resolveKnownTags:a,schema:s,sortMapEntries:r,toStringDefaults:i}){this.compat=Array.isArray(e)?Pn(e,"compat"):e?Pn(null,e):null,this.name=typeof s=="string"&&s||"core",this.knownTags=a?Vs:{},this.tags=Pn(t,this.name,n),this.toStringOptions=i??null,Object.defineProperty(this,ce,{value:pe}),Object.defineProperty(this,ee,{value:Ie}),Object.defineProperty(this,xe,{value:ue}),this.sortMapEntries=typeof r=="function"?r:r===!0?zi:null}clone(){let e=Object.create(o.prototype,Object.getOwnPropertyDescriptors(this));return e.tags=this.tags.slice(),e}}});function Ks(o,e){let t=[],n=e.directives===!0;if(e.directives!==!1&&o.directives){let l=o.directives.toString(o);l?(t.push(l),n=!0):o.directives.docStart&&(n=!0)}n&&t.push("---");let a=mn(o,e),{commentString:s}=a.options;if(o.commentBefore){t.length!==1&&t.unshift("");let l=s(o.commentBefore);t.unshift(re(l,""))}let r=!1,i=null;if(o.contents){if(U(o.contents)){if(o.contents.spaceBefore&&n&&t.push(""),o.contents.commentBefore){let f=s(o.contents.commentBefore);t.push(re(f,""))}a.forceBlockIndent=!!o.comment,i=o.contents.comment}let l=i?void 0:()=>r=!0,c=Ee(o.contents,a,()=>i=null,l);i&&(c+=we(c,"",s(i))),(c[0]==="|"||c[0]===">")&&t[t.length-1]==="---"?t[t.length-1]=`--- ${c}`:t.push(c)}else t.push(Ee(o.contents,a));if(o.directives?.docEnd)if(o.comment){let l=s(o.comment);l.includes(`
...
${r}
${c}
`}}});function ke(o,{flow:e,indicator:t,next:n,offset:a,onError:s,parentIndent:r,startOnNewline:i}){let l=!1,c=i,f=i,d="",p="",h=!1,m=!1,u=null,g=null,y=null,b=null,k=null,S=null,T=null;for(let w of o)switch(m&&(w.type!=="space"&&w.type!=="newline"&&w.type!=="comma"&&s(w.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),m=!1),u&&(c&&w.type!=="comment"&&w.type!=="newline"&&s(u,"TAB_AS_INDENT","Tabs are not allowed as indentation"),u=null),w.type){case"space":!e&&(t!=="doc-start"||n?.type!=="flow-collection")&&w.source.includes("	")&&(u=w),f=!0;break;case"comment":{f||s(w,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");let v=w.source.substring(1)||" ";d?d+=p+v:d=v,p="",c=!1;break}case"newline":c?d?d+=w.source:(!S||t!=="seq-item-ind")&&(l=!0):p+=w.source,c=!0,h=!0,(g||y)&&(b=w),f=!0;break;case"anchor":g&&s(w,"MULTIPLE_ANCHORS","A node can have at most one anchor"),w.source.endsWith(":")&&s(w.offset+w.source.length-1,"BAD_ALIAS","Anchor ending in : is ambiguous",!0),g=w,T??(T=w.offset),c=!1,f=!1,m=!0;break;case"tag":{y&&s(w,"MULTIPLE_TAGS","A node can have at most one tag"),y=w,T??(T=w.offset),c=!1,f=!1,m=!0;break}case t:(g||y)&&s(w,"BAD_PROP_ORDER",`Anchors and tags must be after the ${w.source} indicator`),S&&s(w,"UNEXPECTED_TOKEN",`Unexpected ${w.source} in ${e??"collection"}`),S=w,c=t==="seq-item-ind"||t==="explicit-key-ind",f=!1;break;case"comma":if(e){k&&s(w,"UNEXPECTED_TOKEN",`Unexpected , in ${e}`),k=w,c=!1,f=!1;break}default:s(w,"UNEXPECTED_TOKEN",`Unexpected ${w.type} token`),c=!1,f=!1}let x=o[o.length-1],L=x?x.offset+x.source.length:a;return m&&n&&n.type!=="space"&&n.type!=="newline"&&n.type!=="comma"&&(n.type!=="scalar"||n.source!=="")&&s(n.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),u&&(c&&u.indent<=r||n?.type==="block-map"||n?.type==="block-seq")&&s(u,"TAB_AS_INDENT","Tabs are not allowed as indentation"),{comma:k,found:S,spaceBefore:l,comment:d,hasNewline:h,anchor:g,tag:y,newlineAfterProp:b,end:L,start:T??L}}var Ut=N(()=>{});function Pe(o){if(!o)return null;switch(o.type){case"alias":case"scalar":case"double-quoted-scalar":case"single-quoted-scalar":if(o.source.includes(`
`))return!0;if(o.end){for(let e of o.end)if(e.type==="newline")return!0}return!1;case"flow-collection":for(let e of o.items){for(let t of e.start)if(t.type==="newline")return!0;if(e.sep){for(let t of e.sep)if(t.type==="newline")return!0}if(Pe(e.key)||Pe(e.value))return!0}return!1;default:return!0}}var Un=N(()=>{});function Bt(o,e,t){if(e?.type==="flow-collection"){let n=e.end[0];n.indent===o&&(n.source==="]"||n.source==="}")&&Pe(e)&&t(n,"BAD_INDENT","Flow end indicator should be more indented than parent",!0)}}var ja=N(()=>{Un()});function Bn(o,e,t){let{uniqueKeys:n}=o.options;if(n===!1)return!1;let a=typeof n=="function"?n:(s,r)=>s===r||M(s)&&M(r)&&s.value===r.value;return e.some(s=>a(s.key,t))}var Va=N(()=>{q()});function zs({composeNode:o,composeEmptyNode:e},t,n,a,s){let r=s?.nodeClass??_,i=new r(t.schema);t.atRoot&&(t.atRoot=!1);let l=n.offset,c=null;for(let f of n.items){let{start:d,key:p,sep:h,value:m}=f,u=ke(d,{indicator:"explicit-key-ind",next:p??h?.[0],offset:l,onError:a,parentIndent:n.indent,startOnNewline:!0}),g=!u.found;if(g){if(p&&(p.type==="block-seq"?a(l,"BLOCK_AS_IMPLICIT_KEY","A block sequence may not be used as an implicit map key"):"indent"in p&&p.indent!==n.indent&&a(l,"BAD_INDENT",Ws)),!u.anchor&&!u.tag&&!h){c=u.end,u.comment&&(i.comment?i.comment+=`
`+u.comment:i.comment=u.comment);continue}(u.newlineAfterProp||Pe(p))&&a(p??d[d.length-1],"MULTILINE_IMPLICIT_KEY","Implicit keys need to be on a single line")}else u.found?.indent!==n.indent&&a(l,"BAD_INDENT",Ws);t.atKey=!0;let y=u.end,b=p?o(t,p,u,a):e(t,y,d,null,u,a);t.schema.compat&&Bt(n.indent,p,a),t.atKey=!1,Bn(t,i.items,b)&&a(y,"DUPLICATE_KEY","Map keys must be unique");let k=ke(h??[],{indicator:"map-value-ind",next:m,offset:b.range[2],onError:a,parentIndent:n.indent,startOnNewline:!p||p.type==="block-scalar"});if(l=k.end,k.found){g&&(m?.type==="block-map"&&!k.hasNewline&&a(l,"BLOCK_AS_IMPLICIT_KEY","Nested mappings are not allowed in compact mappings"),t.options.strict&&u.start<k.found.offset-1024&&a(b.range,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit block mapping key"));let S=m?o(t,m,k,a):e(t,l,h,null,k,a);t.schema.compat&&Bt(n.indent,m,a),l=S.range[2];let T=new V(b,S);t.options.keepSourceTokens&&(T.srcToken=f),i.items.push(T)}else{g&&a(b.range,"MISSING_CHAR","Implicit map keys need to be followed by map values"),k.comment&&(b.comment?b.comment+=`
`+k.comment:b.comment=k.comment);let S=new V(b);t.options.keepSourceTokens&&(S.srcToken=f),i.items.push(S)}}return c&&c<l&&a(c,"IMPOSSIBLE","Map comment with trailing content"),i.range=[n.offset,l,c??l],i}var Ws,Js=N(()=>{De();Oe();Ut();Un();ja();Va();Ws="All mapping items must start at the same column"});function Xs({composeNode:o,composeEmptyNode:e},t,n,a,s){let r=s?.nodeClass??z,i=new r(t.schema);t.atRoot&&(t.atRoot=!1),t.atKey&&(t.atKey=!1);let l=n.offset,c=null;for(let{start:f,value:d}of n.items){let p=ke(f,{indicator:"seq-item-ind",next:d,offset:l,onError:a,parentIndent:n.indent,startOnNewline:!0});if(!p.found)if(p.anchor||p.tag||d)d?.type==="block-seq"?a(p.end,"BAD_INDENT","All sequence items must start at the same column"):a(l,"MISSING_CHAR","Sequence item without - indicator");else{c=p.end,p.comment&&(i.comment=p.comment);continue}let h=d?o(t,d,p,a):e(t,p.end,f,null,p,a);t.schema.compat&&Bt(n.indent,d,a),l=h.range[2],i.items.push(h)}return i.range=[n.offset,l,c??l],i}var Zs=N(()=>{Re();Ut();ja()});function ve(o,e,t,n){let a="";if(o){let s=!1,r="";for(let i of o){let{source:l,type:c}=i;switch(c){case"space":s=!0;break;case"comment":{t&&!s&&n(i,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");let f=l.substring(1)||" ";a?a+=r+f:a=f,r="";break}case"newline":a&&(r+=l),s=!0;break;default:n(i,"UNEXPECTED_TOKEN",`Unexpected ${c} at node end`)}e+=l.length}}return{comment:a,offset:e}}var lt=N(()=>{});function Ys({composeNode:o,composeEmptyNode:e},t,n,a,s){let r=n.start.source==="{",i=r?"flow map":"flow sequence",l=s?.nodeClass??(r?_:z),c=new l(t.schema);c.flow=!0;let f=t.atRoot;f&&(t.atRoot=!1),t.atKey&&(t.atKey=!1);let d=n.offset+n.start.source.length;for(let g=0;g<n.items.length;++g){let y=n.items[g],{start:b,key:k,sep:S,value:T}=y,x=ke(b,{flow:i,indicator:"explicit-key-ind",next:k??S?.[0],offset:d,onError:a,parentIndent:n.indent,startOnNewline:!1});if(!x.found){if(!x.anchor&&!x.tag&&!S&&!T){g===0&&x.comma?a(x.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${i}`):g<n.items.length-1&&a(x.start,"UNEXPECTED_TOKEN",`Unexpected empty item in ${i}`),x.comment&&(c.comment?c.comment+=`
`+x.comment:c.comment=x.comment),d=x.end;continue}!r&&t.options.strict&&Pe(k)&&a(k,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line")}if(g===0)x.comma&&a(x.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${i}`);else if(x.comma||a(x.start,"MISSING_CHAR",`Missing , between ${i} items`),x.comment){let L="";e:for(let w of b)switch(w.type){case"comma":case"space":break;case"comment":L=w.source.substring(1);break e;default:break e}if(L){let w=c.items[c.items.length-1];P(w)&&(w=w.value??w.key),w.comment?w.comment+=`
`+L:w.comment=L,x.comment=x.comment.substring(L.length+1)}}if(!r&&!S&&!x.found){let L=T?o(t,T,x,a):e(t,x.end,S,null,x,a);c.items.push(L),d=L.range[2],Ka(T)&&a(L.range,"BLOCK_IN_FLOW",_a)}else{t.atKey=!0;let L=x.end,w=k?o(t,k,x,a):e(t,L,b,null,x,a);Ka(k)&&a(w.range,"BLOCK_IN_FLOW",_a),t.atKey=!1;let v=ke(S??[],{flow:i,indicator:"map-value-ind",next:T,offset:w.range[2],onError:a,parentIndent:n.indent,startOnNewline:!1});if(v.found){if(!r&&!x.found&&t.options.strict){if(S)for(let F of S){if(F===v.found)break;if(F.type==="newline"){a(F,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line");break}}x.start<v.found.offset-1024&&a(v.found,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit flow sequence key")}}else T&&("source"in T&&T.source?.[0]===":"?a(T,"MISSING_CHAR",`Missing space after : in ${i}`):a(v.start,"MISSING_CHAR",`Missing , or : between ${i} items`));let C=T?o(t,T,v,a):v.found?e(t,v.end,S,null,v,a):null;C?Ka(T)&&a(C.range,"BLOCK_IN_FLOW",_a):v.comment&&(w.comment?w.comment+=`
`+v.comment:w.comment=v.comment);let D=new V(w,C);if(t.options.keepSourceTokens&&(D.srcToken=y),r){let F=c;Bn(t,F.items,w)&&a(L,"DUPLICATE_KEY","Map keys must be unique"),F.items.push(D)}else{let F=new _(t.schema);F.flow=!0,F.items.push(D);let R=(C??w).range;F.range=[w.range[0],R[1],R[2]],c.items.push(F)}d=C?C.range[2]:v.end}}let p=r?"}":"]",[h,...m]=n.end,u=d;if(h?.source===p)u=h.offset+h.source.length;else{let g=i[0].toUpperCase()+i.substring(1),y=f?`${g} must end with a ${p}`:`${g} in block collection must be sufficiently indented and end with a ${p}`;a(d,f?"MISSING_CHAR":"BAD_INDENT",y),h&&h.source.length!==1&&m.unshift(h)}if(m.length>0){let g=ve(m,u,t.options.strict,a);g.comment&&(c.comment?c.comment+=`
`+g.comment:c.comment=g.comment),c.range=[n.offset,u,g.offset]}else c.range=[n.offset,u,u];return c}var _a,Ka,Qs=N(()=>{q();De();Oe();Re();lt();Ut();Un();Va();_a="Block collections are not allowed within flow collections",Ka=o=>o&&(o.type==="block-map"||o.type==="block-seq")});function Ga(o,e,t,n,a,s){let r=t.type==="block-map"?zs(o,e,t,n,s):t.type==="block-seq"?Xs(o,e,t,n,s):Ys(o,e,t,n,s),i=r.constructor;return a==="!"||a===i.tagName?(r.tag=i.tagName,r):(a&&(r.tag=a),r)}function $s(o,e,t,n,a){let s=n.tag,r=s?e.directives.tagName(s.source,p=>a(s,"TAG_RESOLVE_FAILED",p)):null;if(t.type==="block-seq"){let{anchor:p,newlineAfterProp:h}=n,m=p&&s?p.offset>s.offset?p:s:p??s;m&&(!h||h.offset<m.offset)&&a(m,"MISSING_CHAR","Missing newline after block sequence props")}let i=t.type==="block-map"?"map":t.type==="block-seq"?"seq":t.start.source==="{"?"map":"seq";if(!s||!r||r==="!"||r===_.tagName&&i==="map"||r===z.tagName&&i==="seq")return Ga(o,e,t,a,r);let l=e.schema.tags.find(p=>p.tag===r&&p.collection===i);if(!l){let p=e.schema.knownTags[r];if(p?.collection===i)e.schema.tags.push(Object.assign({},p,{default:!1})),l=p;else return p?a(s,"BAD_COLLECTION_TYPE",`${p.tag} used for ${i} collection, but expects ${p.collection??"scalar"}`,!0):a(s,"TAG_RESOLVE_FAILED",`Unresolved tag: ${r}`,!0),Ga(o,e,t,a,r)}let c=Ga(o,e,t,a,r,l),f=l.resolve?.(c,p=>a(s,"TAG_RESOLVE_FAILED",p),e.options)??c,d=U(f)?f:new E(f);return d.range=c.range,d.tag=r,l?.format&&(d.format=l.format),d}var er=N(()=>{q();K();Oe();Re();Js();Zs();Qs()});function qn(o,e,t){let n=e.offset,a=Ji(e,o.options.strict,t);if(!a)return{value:"",type:null,comment:"",range:[n,n,n]};let s=a.mode===">"?E.BLOCK_FOLDED:E.BLOCK_LITERAL,r=e.source?Xi(e.source):[],i=r.length;for(let u=r.length-1;u>=0;--u){let g=r[u][1];if(g===""||g==="\r")i=u;else break}if(i===0){let u=a.chomp==="+"&&r.length>0?`
...
`;for(let u=f;u<i;++u){let[g,y]=r[u];c+=g.length+y.length+1;let b=y[y.length-1]==="\r";if(b&&(y=y.slice(0,-1)),y&&g.length<l){let S=`Block scalar lines must not be less indented than their ${a.indent?"explicit indentation indicator":"first line"}`;t(c-y.length-(b?2:1),"BAD_INDENT",S),g=""}s===E.BLOCK_LITERAL?(d+=p+g.slice(l)+y,p=`
`):g.length>l||y[0]==="	"?(p===" "?p=`
`:!h&&p===`
`&&(p=`
...
`);)n===`
`&&(t+=`
`),e+=1,n=o[e+1];return t||(t=" "),{fold:t,offset:e}}function tl(o,e,t,n){let a=o.substr(e,t),r=a.length===t&&/^[0-9a-fA-F]+$/.test(a)?parseInt(a,16):NaN;try{return String.fromCodePoint(r)}catch{let i=o.substr(e-2,t+2);return n(e-2,"BAD_DQ_ESCAPE",`Invalid escape sequence ${i}`),i}}var el,za=N(()=>{K();lt();el={0:"\0",a:"\x07",b:"\b",e:"\x1B",f:"\f",n:`
`,r:"\r",t:"	",v:"\v",N:"\x85",_:"\xA0",L:"\u2028",P:"\u2029"," ":" ",'"':'"',"/":"/","\\":"\\","	":"	"}});function Ja(o,e,t,n){let{value:a,type:s,comment:r,range:i}=e.type==="block-scalar"?qn(o,e,n):Hn(e,o.options.strict,n),l=t?o.directives.tagName(t.source,d=>n(t,"TAG_RESOLVE_FAILED",d)):null,c;o.options.stringKeys&&o.atKey?c=o.schema[ee]:l?c=nl(o.schema,a,l,t,n):e.type==="scalar"?c=al(o,a,e,n):c=o.schema[ee];let f;try{let d=c.resolve(a,p=>n(t??e,"TAG_RESOLVE_FAILED",p),o.options);f=M(d)?d:new E(d)}catch(d){let p=d instanceof Error?d.message:String(d);n(t??e,"TAG_RESOLVE_FAILED",p),f=new E(a)}return f.range=i,f.source=a,s&&(f.type=s),l&&(f.tag=l),c.format&&(f.format=c.format),r&&(f.comment=r),f}function nl(o,e,t,n,a){if(t==="!")return o[ee];let s=[];for(let i of o.tags)if(!i.collection&&i.tag===t)if(i.default&&i.test)s.push(i);else return i;for(let i of s)if(i.test?.test(e))return i;let r=o.knownTags[t];return r&&!r.collection?(o.tags.push(Object.assign({},r,{default:!1,test:void 0})),r):(a(n,"TAG_RESOLVE_FAILED",`Unresolved tag: ${t}`,t!=="tag:yaml.org,2002:str"),o[ee])}function al({atKey:o,directives:e,schema:t},n,a,s){let r=t.tags.find(i=>(i.default===!0||o&&i.default==="key")&&i.test?.test(n))||t[ee];if(t.compat){let i=t.compat.find(l=>l.default&&l.test?.test(n))??t[ee];if(r.tag!==i.tag){let l=e.tagString(r.tag),c=e.tagString(i.tag),f=`Value may be parsed as either ${l} or ${c}`;s(a,"TAG_RESOLVE_FAILED",f,!0)}}return r}var nr=N(()=>{q();K();Wa();za()});function ar(o,e,t){if(e){t??(t=e.length);for(let n=t-1;n>=0;--n){let a=e[n];switch(a.type){case"space":case"comment":case"newline":o-=a.source.length;continue}for(a=e[++n];a?.type==="space";)o+=a.source.length,a=e[++n];break}}return o}var or=N(()=>{});function Xa(o,e,t,n){let a=o.atKey,{spaceBefore:s,comment:r,anchor:i,tag:l}=t,c,f=!0;switch(e.type){case"alias":c=sl(o,e,n),(i||l)&&n(e,"ALIAS_PROPS","An alias node must not specify any properties");break;case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":case"block-scalar":c=Ja(o,e,l,n),i&&(c.anchor=i.source.substring(1));break;case"block-map":case"block-seq":case"flow-collection":try{c=$s(ol,o,e,t,n),i&&(c.anchor=i.source.substring(1))}catch(d){let p=d instanceof Error?d.message:String(d);n(e,"RESOURCE_EXHAUSTION",p)}break;default:{let d=e.type==="error"?e.message:`Unsupported token (type: ${e.type})`;n(e,"UNEXPECTED_TOKEN",d),f=!1}}return c??(c=jn(o,e.offset,void 0,null,t,n)),i&&c.anchor===""&&n(i,"BAD_ALIAS","Anchor cannot be an empty string"),a&&o.options.stringKeys&&(!M(c)||typeof c.value!="string"||c.tag&&c.tag!=="tag:yaml.org,2002:str")&&n(l??e,"NON_STRING_KEY","With stringKeys, all keys must be strings"),s&&(c.spaceBefore=!0),r&&(e.type==="scalar"&&e.source===""?c.comment=r:c.commentBefore=r),o.options.keepSourceTokens&&f&&(c.srcToken=e),c}function jn(o,e,t,n,{spaceBefore:a,comment:s,anchor:r,tag:i,end:l},c){let f={type:"scalar",offset:ar(e,t,n),indent:-1,source:""},d=Ja(o,f,i,c);return r&&(d.anchor=r.source.substring(1),d.anchor===""&&c(r,"BAD_ALIAS","Anchor cannot be an empty string")),a&&(d.spaceBefore=!0),s&&(d.comment=s,d.range[2]=l),d}function sl({options:o},{offset:e,source:t,end:n},a){let s=new de(t.substring(1));s.source===""&&a(e,"BAD_ALIAS","Alias cannot be an empty string"),s.source.endsWith(":")&&a(e+t.length-1,"BAD_ALIAS","Alias ending in : is ambiguous",!0);let r=e+t.length,i=ve(n,r,o.strict,a);return s.range=[e,r,i.offset],i.comment&&(s.comment=i.comment),s}var ol,sr=N(()=>{bt();q();er();nr();lt();or();ol={composeNode:Xa,composeEmptyNode:jn}});function rr(o,e,{offset:t,start:n,value:a,end:s},r){let i=Object.assign({_directives:e},o),l=new he(void 0,i),c={atKey:!1,atRoot:!0,directives:l.directives,options:l.options,schema:l.schema},f=ke(n,{indicator:"doc-start",next:a??s?.[0],offset:t,onError:r,parentIndent:0,startOnNewline:!0});f.found&&(l.directives.docStart=!0,a&&(a.type==="block-map"||a.type==="block-seq")&&!f.hasNewline&&r(f.end,"MISSING_CHAR","Block collection cannot start on same line with directives-end marker")),l.contents=a?Xa(c,a,f,r):jn(c,f.end,n,null,f,r);let d=l.contents.range[2],p=ve(s,d,!1,r);return p.comment&&(l.comment=p.comment),l.range=[t,d,p.offset],l}var ir=N(()=>{Rt();sr();lt();Ut()});function qt(o){if(typeof o=="number")return[o,o+1];if(Array.isArray(o))return o.length===2?o:[o[0],o[1]];let{offset:e,source:t}=o;return[e,e+(typeof t=="string"?t.length:1)]}function lr(o){let e="",t=!1,n=!1;for(let a=0;a<o.length;++a){let s=o[a];switch(s[0]){case"#":e+=(e===""?"":n?`

`:`
`)+(s.substring(1)||" "),t=!0,n=!1;break;case"%":o[a+1]?.[0]!=="#"&&(a+=1),t=!1;break;default:t||(n=!0),t=!1}}return{comment:e,afterEmptyLine:n}}var Ue,Za=N(()=>{ua();Rt();Pt();q();ir();lt();Ue=class{constructor(e={}){this.doc=null,this.atDirectives=!1,this.prelude=[],this.errors=[],this.warnings=[],this.onError=(t,n,a,s)=>{let r=qt(t);s?this.warnings.push(new Ge(r,n,a)):this.errors.push(new Q(r,n,a))},this.directives=new be({version:e.version||"1.2"}),this.options=e}decorate(e,t){let{comment:n,afterEmptyLine:a}=lr(this.prelude);if(n){let s=e.contents;if(t)e.comment=e.comment?`${e.comment}
${n}`:n;else if(a||e.directives.docStart||!s)e.commentBefore=n;else if(H(s)&&!s.flow&&s.items.length>0){let r=s.items[0];P(r)&&(r=r.key);let i=r.commentBefore;r.commentBefore=i?`${n}
${i}`:n}else{let r=s.commentBefore;s.commentBefore=r?`${n}
${r}`:n}}if(t){for(let s=0;s<this.errors.length;++s)e.errors.push(this.errors[s]);for(let s=0;s<this.warnings.length;++s)e.warnings.push(this.warnings[s])}else e.errors=this.errors,e.warnings=this.warnings;this.prelude=[],this.errors=[],this.warnings=[]}streamInfo(){return{comment:lr(this.prelude).comment,directives:this.directives,errors:this.errors,warnings:this.warnings}}*compose(e,t=!1,n=-1){for(let a of e)yield*this.next(a);yield*this.end(t,n)}*next(e){switch(e.type){case"directive":this.directives.add(e.source,(t,n,a)=>{let s=qt(e);s[0]+=t,this.onError(s,"BAD_DIRECTIVE",n,a)}),this.prelude.push(e.source),this.atDirectives=!0;break;case"document":{let t=rr(this.options,this.directives,e,this.onError);this.atDirectives&&!t.directives.docStart&&this.onError(e,"MISSING_CHAR","Missing directives-end/doc-start indicator line"),this.decorate(t,!1),this.doc&&(yield this.doc),this.doc=t,this.atDirectives=!1;break}case"byte-order-mark":case"space":break;case"comment":case"newline":this.prelude.push(e.source);break;case"error":{let t=e.source?`${e.message}: ${JSON.stringify(e.source)}`:e.message,n=new Q(qt(e),"UNEXPECTED_TOKEN",t);this.atDirectives||!this.doc?this.errors.push(n):this.doc.errors.push(n);break}case"doc-end":{if(!this.doc){let n="Unexpected doc-end without preceding document";this.errors.push(new Q(qt(e),"UNEXPECTED_TOKEN",n));break}this.doc.directives.docEnd=!0;let t=ve(e.end,e.offset+e.source.length,this.doc.options.strict,this.onError);if(this.decorate(this.doc,!0),t.comment){let n=this.doc.comment;this.doc.comment=n?`${n}
${t.comment}`:t.comment}this.doc.range[2]=t.offset;break}default:this.errors.push(new Q(qt(e),"UNEXPECTED_TOKEN",`Unsupported token ${e.type}`))}}*end(e=!1,t=-1){if(this.doc)this.decorate(this.doc,!0),yield this.doc,this.doc=null;else if(e){let n=Object.assign({_directives:this.directives},this.options),a=new he(void 0,n);this.atDirectives&&this.onError(t,"MISSING_CHAR","Missing directives-end indicator line"),a.range=[0,t,t],this.decorate(a,!1),yield a}}}});function cr(o,e=!0,t){if(o){let n=(a,s,r)=>{let i=typeof a=="number"?a:Array.isArray(a)?a[0]:a.offset;if(t)t(i,s,r);else throw new Q([i,i+1],s,r)};switch(o.type){case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":return Hn(o,e,n);case"block-scalar":return qn({options:{strict:e}},o,n)}}return null}function dr(o,e){let{implicitKey:t=!1,indent:n,inFlow:a=!1,offset:s=-1,type:r="PLAIN"}=e,i=Ne({type:r,value:o},{implicitKey:t,indent:n>0?" ".repeat(n):"",inFlow:a,options:{blockQuote:!0,lineWidth:-1}}),l=e.end??[{type:"newline",offset:-1,indent:n,source:`
`}];switch(i[0]){case"|":case">":{let c=i.indexOf(`
`),f=i.substring(0,c),d=i.substring(c+1)+`
`,p=[{type:"block-scalar-header",offset:s,indent:n,source:f}];return pr(p,l)||p.push({type:"newline",offset:-1,indent:n,source:`
`}),{type:"block-scalar",offset:s,indent:n,props:p,source:d}}case'"':return{type:"double-quoted-scalar",offset:s,indent:n,source:i,end:l};case"'":return{type:"single-quoted-scalar",offset:s,indent:n,source:i,end:l};default:return{type:"scalar",offset:s,indent:n,source:i,end:l}}}function fr(o,e,t={}){let{afterKey:n=!1,implicitKey:a=!1,inFlow:s=!1,type:r}=t,i="indent"in o?o.indent:null;if(n&&typeof i=="number"&&(i+=2),!r)switch(o.type){case"single-quoted-scalar":r="QUOTE_SINGLE";break;case"double-quoted-scalar":r="QUOTE_DOUBLE";break;case"block-scalar":{let c=o.props[0];if(c.type!=="block-scalar-header")throw new Error("Invalid block scalar header");r=c.source[0]===">"?"BLOCK_FOLDED":"BLOCK_LITERAL";break}default:r="PLAIN"}let l=Ne({type:r,value:e},{implicitKey:a||i===null,indent:i!==null&&i>0?" ".repeat(i):"",inFlow:s,options:{blockQuote:!0,lineWidth:-1}});switch(l[0]){case"|":case">":rl(o,l);break;case'"':Ya(o,l,"double-quoted-scalar");break;case"'":Ya(o,l,"single-quoted-scalar");break;default:Ya(o,l,"scalar")}}function rl(o,e){let t=e.indexOf(`
`),n=e.substring(0,t),a=e.substring(t+1)+`
`;if(o.type==="block-scalar"){let s=o.props[0];if(s.type!=="block-scalar-header")throw new Error("Invalid block scalar header");s.source=n,o.source=a}else{let{offset:s}=o,r="indent"in o?o.indent:-1,i=[{type:"block-scalar-header",offset:s,indent:r,source:n}];pr(i,"end"in o?o.end:void 0)||i.push({type:"newline",offset:-1,indent:r,source:`
`});for(let l of Object.keys(o))l!=="type"&&l!=="offset"&&delete o[l];Object.assign(o,{type:"block-scalar",indent:r,props:i,source:a})}}function pr(o,e){if(e)for(let t of e)switch(t.type){case"space":case"comment":o.push(t);break;case"newline":return o.push(t),!0}return!1}function Ya(o,e,t){switch(o.type){case"scalar":case"double-quoted-scalar":case"single-quoted-scalar":o.type=t,o.source=e;break;case"block-scalar":{let n=o.props.slice(1),a=e.length;o.props[0].type==="block-scalar-header"&&(a-=o.props[0].source.length);for(let s of n)s.offset+=a;delete o.props,Object.assign(o,{type:t,source:e,end:n});break}case"block-map":case"block-seq":{let a={type:"newline",offset:o.offset+e.length,indent:o.indent,source:`
`};delete o.items,Object.assign(o,{type:t,source:e,end:[a]});break}default:{let n="indent"in o?o.indent:-1,a="end"in o&&Array.isArray(o.end)?o.end.filter(s=>s.type==="space"||s.type==="comment"||s.type==="newline"):[];for(let s of Object.keys(o))s!=="type"&&s!=="offset"&&delete o[s];Object.assign(o,{type:t,indent:n,source:e,end:a})}}}var ur=N(()=>{Wa();za();Pt();Nt()});function _n(o){switch(o.type){case"block-scalar":{let e="";for(let t of o.props)e+=_n(t);return e+o.source}case"block-map":case"block-seq":{let e="";for(let t of o.items)e+=Vn(t);return e}case"flow-collection":{let e=o.start.source;for(let t of o.items)e+=Vn(t);for(let t of o.end)e+=t.source;return e}case"document":{let e=Vn(o);if(o.end)for(let t of o.end)e+=t.source;return e}default:{let e=o.source;if("end"in o&&o.end)for(let t of o.end)e+=t.source;return e}}}function Vn({start:o,key:e,sep:t,value:n}){let a="";for(let s of o)a+=s.source;if(e&&(a+=_n(e)),t)for(let s of t)a+=s.source;return n&&(a+=_n(n)),a}var hr,mr=N(()=>{hr=o=>"type"in o?_n(o):Vn(o)});function Be(o,e){"type"in o&&o.type==="document"&&(o={start:o.start,value:o.value}),yr(Object.freeze([]),o,e)}function yr(o,e,t){let n=t(e,o);if(typeof n=="symbol")return n;for(let a of["key","value"]){let s=e[a];if(s&&"items"in s){for(let r=0;r<s.items.length;++r){let i=yr(Object.freeze(o.concat([[a,r]])),s.items[r],t);if(typeof i=="number")r=i-1;else{if(i===Qa)return Qa;i===gr&&(s.items.splice(r,1),r-=1)}}typeof n=="function"&&a==="key"&&(n=n(e,o))}}return typeof n=="function"?n(e,o):n}var Qa,il,gr,br=N(()=>{Qa=Symbol("break visit"),il=Symbol("skip children"),gr=Symbol("remove item");Be.BREAK=Qa;Be.SKIP=il;Be.REMOVE=gr;Be.itemAtPath=(o,e)=>{let t=o;for(let[n,a]of e){let s=t?.[n];if(s&&"items"in s)t=s.items[a];else return}return t};Be.parentCollection=(o,e)=>{let t=Be.itemAtPath(o,e.slice(0,-1)),n=e[e.length-1][0],a=t?.[n];if(a&&"items"in a)return a;throw new Error("Parent collection not found")}});var Kn={};sa(Kn,{BOM:()=>Ht,DOCUMENT:()=>jt,FLOW_END:()=>Vt,SCALAR:()=>ct,createScalarToken:()=>dr,isCollection:()=>ll,isScalar:()=>cl,prettyToken:()=>dl,resolveAsScalar:()=>cr,setScalarValue:()=>fr,stringify:()=>hr,tokenType:()=>$a,visit:()=>Be});function dl(o){switch(o){case Ht:return"<BOM>";case jt:return"<DOC>";case Vt:return"<FLOW_END>";case ct:return"<SCALAR>";default:return JSON.stringify(o)}}function $a(o){switch(o){case Ht:return"byte-order-mark";case jt:return"doc-mode";case Vt:return"flow-error-end";case ct:return"scalar";case"---":return"doc-start";case"...":return"doc-end";case"":case`
`:case`\r
`:return"newline";case"-":return"seq-item-ind";case"?":return"explicit-key-ind";case":":return"map-value-ind";case"{":return"flow-map-start";case"}":return"flow-map-end";case"[":return"flow-seq-start";case"]":return"flow-seq-end";case",":return"comma"}switch(o[0]){case" ":case"	":return"space";case"#":return"comment";case"%":return"directive-line";case"*":return"alias";case"&":return"anchor";case"!":return"tag";case"'":return"single-quoted-scalar";case'"':return"double-quoted-scalar";case"|":case">":return"block-scalar-header"}return null}var Ht,jt,Vt,ct,ll,cl,Gn=N(()=>{ur();mr();br();Ht="\uFEFF",jt="",Vt="",ct="",ll=o=>!!o&&"items"in o,cl=o=>!!o&&(o.type==="scalar"||o.type==="single-quoted-scalar"||o.type==="double-quoted-scalar"||o.type==="block-scalar")});function me(o){switch(o){case void 0:case" ":case`
`:case"\r":case"	":return!0;default:return!1}}var wr,fl,Wn,pl,eo,We,to=N(()=>{Gn();wr=new Set("0123456789ABCDEFabcdef"),fl=new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),Wn=new Set(",[]{}"),pl=new Set(` ,[]{}
\r	`),eo=o=>!o||pl.has(o),We=class{constructor(){this.atEnd=!1,this.blockScalarIndent=-1,this.blockScalarKeep=!1,this.buffer="",this.flowKey=!1,this.flowLevel=0,this.indentNext=0,this.indentValue=0,this.lineEndPos=null,this.next=null,this.pos=0}*lex(e,t=!1){if(e){if(typeof e!="string")throw TypeError("source is not a string");this.buffer=this.buffer?this.buffer+e:e,this.lineEndPos=null}this.atEnd=!t;let n=this.next??"stream";for(;n&&(t||this.hasChars(1));)n=yield*this.parseNext(n)}atLineEnd(){let e=this.pos,t=this.buffer[e];for(;t===" "||t==="	";)t=this.buffer[++e];return!t||t==="#"||t===`
...
`).trim():e}async resolveNoteTransclusions(e,t,n=0,a=new Set){if(!e||n>5)return e;let s=t?t.path:"",r=new Set(a);s&&r.add(s);let i=/!\[\[([^\]]+)\]\]/g,l=[...e.matchAll(i)];if(l.length===0)return e;let c=e;for(let f of l){let d=f[0],p=f[1],[h]=p.split("|"),m=h.trim();if(uo(m)||Qn(m)||Or(m))continue;let u=m.indexOf("#"),g=u!==-1?m.slice(0,u).trim():m,y=u!==-1?m.slice(u+1).trim():null,b=null;if(g?b=this.app.metadataCache.getFirstLinkpathDest(g,s):t&&(b=t),!(!b||b.extension!=="md")){if(r.has(b.path)&&n>0&&!y){console.warn(`Standard: Circular transclusion detected for ${b.path}`),c=c.replace(d,"");continue}try{let k=await this.app.vault.read(b),S=this.stripFrontmatter(k);y&&(S=this.extractMarkdownSubpath(S,y));let T=new Set(r);T.add(b.path);let x=await this.resolveNoteTransclusions(S,b,n+1,T);c=c.replace(d,x.trim())}catch(k){console.warn(`Standard: Error resolving transclusion ${d}:`,k)}}}return c}async uploadContentImages(e,t,n=!1,a=null,s=null,r=null){if(!this.plugin.settings.apiKey)return e;let i=await this.resolveNoteTransclusions(e,t),l=new Map,c=async m=>{if(s&&s.cancelled)return null;if(l.has(m.path))return l.get(m.path);try{let u=m.stat?.mtime||0,g=m.stat?.size||0,y=m.name.split(".").pop()?.toLowerCase()||"bin",b="",k="",S=this.attachmentCache?.get(m.path);if(S&&S.mtime===u&&S.size===g&&S.contentHash)b=S.contentHash,k=S.cdnUrl;else{let J=await this.app.vault.readBinary(m),ie=await crypto.subtle.digest("SHA-256",J);b=Array.from(new Uint8Array(ie)).map(Qt=>Qt.toString(16).padStart(2,"0")).join("")}if(r&&r.has(b)&&k)return l.set(m.path,k),a&&(a.imagesChecked=(a.imagesChecked||0)+1,a.imagesReused=(a.imagesReused||0)+1),k;let T=`${this.plugin.settings.apiUrl}/publish/attachment?hash=${b}&ext=${y}`,x=await Ce(T,{method:"GET",headers:{"x-api-key":this.plugin.settings.apiKey}});if(x.status>=200&&x.status<300){let J=await x.json();if(J?.exists&&J.url)return k=new URL(J.url,this.plugin.settings.apiUrl).href,this.attachmentCache&&this.attachmentCache.set(m.path,{mtime:u,size:g,contentHash:b,cdnUrl:k}),r&&r.add(b),l.set(m.path,k),a&&(a.imagesChecked=(a.imagesChecked||0)+1,a.imagesReused=(a.imagesReused||0)+1),k}if(n){let J=Date.now()-this.lastAttachmentUploadTime;if(J<2e3&&await ft(2e3-J,s),s&&s.cancelled)return null}let L=await this.app.vault.readBinary(m),w="----ObsidianBoundary"+Math.random().toString(36).substring(2),v=[`--${w}`,`Content-Disposition: form-data; name="file"; filename="${m.name}"`,`Content-Type: ${bl(m.name)}`,"",""].join(`\r
`),C=`\r
--${w}--`,D=new Uint8Array(L),F=new TextEncoder().encode(v),R=new TextEncoder().encode(C),I=new Uint8Array(F.length+D.byteLength+R.length);I.set(F,0),I.set(D,F.length),I.set(R,F.length+D.byteLength);let B=await Ce(`${this.plugin.settings.apiUrl}/publish/attachment`,{method:"POST",headers:{"x-api-key":this.plugin.settings.apiKey,"Content-Type":`multipart/form-data; boundary=${w}`},body:I.buffer});if(this.lastAttachmentUploadTime=Date.now(),B.status<200||B.status>=300){let J=`HTTP ${B.status}`;try{let ie=await B.json();ie?.error&&(J=ie.error)}catch{}return console.warn(`Standard: Failed to upload ${m.name}: ${J}`,B.status),a&&(a.imagesChecked=(a.imagesChecked||0)+1,a.imagesFailed=(a.imagesFailed||0)+1,a.failedImages&&a.failedImages.push({name:m.name,detail:J})),null}let W=await B.json();return W?.url?(k=new URL(W.url,this.plugin.settings.apiUrl).href,this.attachmentCache&&this.attachmentCache.set(m.path,{mtime:u,size:g,contentHash:b,cdnUrl:k}),r&&r.add(b),l.set(m.path,k),a&&(a.imagesChecked=(a.imagesChecked||0)+1,a.imagesUploaded=(a.imagesUploaded||0)+1),k):(console.warn(`Standard: ${m.name} accept\xE9 par le serveur sans URL en retour`,W),a&&(a.imagesChecked=(a.imagesChecked||0)+1,a.imagesFailed=(a.imagesFailed||0)+1,a.failedImages&&a.failedImages.push({name:m.name,detail:"R\xE9ponse serveur sans URL"})),null)}catch(u){return console.warn(`Standard: Error uploading ${m.name}`,u),a&&(a.imagesChecked=(a.imagesChecked||0)+1,a.imagesFailed=(a.imagesFailed||0)+1,a.failedImages&&a.failedImages.push({name:m.name,detail:u.message||String(u)})),null}},f=i,d=/!\[\[([^\]]+)\]\]/g;for(let m of[...f.matchAll(d)]){let u=m[1],g=u.split("|")[0].trim();if(!uo(g))continue;let y=this.app.metadataCache.getFirstLinkpathDest(g,t.path);if(!y)continue;let b=await c(y);if(!b)continue;let k=u.includes("|")?u.split("|")[1]:y.basename;if(Qn(g))f=f.replaceAll(m[0],`![${k}](${b})`);else if(Or(g))f=f.replaceAll(m[0],`[${k}](${b} "pdf-embed")`);else{let S=`${b}?download=${encodeURIComponent(y.name)}`;f=f.replaceAll(m[0],`[${k}](${S})`)}}let p=/(^|[^!])\[\[([^\]]+)\]\]/g;for(let m of[...f.matchAll(p)]){let u=m[2],g=u.split("|")[0].trim();if(!uo(g)||Qn(g))continue;let y=this.app.metadataCache.getFirstLinkpathDest(g,t.path);if(!y)continue;let b=await c(y);if(!b)continue;let k=u.includes("|")?u.split("|")[1]:y.name,S=`${b}?download=${encodeURIComponent(y.name)}`;f=f.replaceAll(m[0],`${m[1]}[${k}](${S})`)}let h=/!\[([^\]]*)\]\(([^)]+)\)/g;for(let m of[...f.matchAll(h)]){let u=m[2];if(/^https?:\/\//.test(u)||!Qn(u))continue;let g=decodeURIComponent(u),y=this.app.vault.getFileByPath(g)||this.app.metadataCache.getFirstLinkpathDest(g,t.path);if(!y)continue;let b=await c(y);b&&(f=f.replaceAll(m[0],`![${m[1]}](${b})`))}return f}async publishNote(e,t=!1,n=null){try{let a=n!==null?n:await this.uploadContentImages(await this.app.vault.read(e),e,t),s=this.app.metadataCache.getFileCache(e)?.frontmatter||{},r=s.permalink??s.slug,i=$(e.basename),l=r!=null?String(r).replace(/^\/+|\/+$/g,""):i,c=l===""?"~root":l,f=s.created||(e.stat?.ctime?new Date(e.stat.ctime).toISOString():new Date().toISOString()),d=s.modified||(e.stat?.mtime?new Date(e.stat.mtime).toISOString():new Date().toISOString()),p=await Ce(`${this.plugin.settings.apiUrl}/publish/${encodeURIComponent(c)}`,{method:"PUT",headers:{"Content-Type":"application/json","x-api-key":this.plugin.settings.apiKey},body:JSON.stringify({title:e.basename,content:a,slug:c,created_at:f,updated_at:d})});if(p.status<200||p.status>=300){let u=`HTTP ${p.status}`;try{let g=JSON.parse(p.text||"{}");g.error&&(u+=`: ${g.error}`)}catch{p.text&&(u+=`: ${p.text.slice(0,80)}`)}return this.lastError=u,console.error(`Standard: Publish failed for ${e.basename}:`,p.status,p.text),!1}let h=await p.json().catch(()=>null),m=this.getLiveUrl(e);return await this.app.fileManager.processFrontMatter(e,u=>{delete u.published,delete u.url_public,u["garden-url"]=m,l!==""&&(u.permalink=l),h&&h.nano_id&&(u["garden-short"]=`https://stnd.gd/${h.nano_id}`),u.modified!=null&&(u.modified=new Date().toISOString())}),!0}catch(a){return this.lastError=a.message||String(a),console.error(`Standard: Publish error for ${e.basename}:`,a),!1}}async unpublishNote(e,t=null){try{let n=t;if(!n&&e){let s=await mo(this.app,e),r=s.permalink??s.slug,i=$(e.basename),l=r!=null?String(r).replace(/^\/+|\/+$/g,""):i;n=l===""?"~root":l}if(!n)return!1;let a=await Ce(`${this.plugin.settings.apiUrl}/publish/${encodeURIComponent(n)}`,{method:"DELETE",headers:{"x-api-key":this.plugin.settings.apiKey}});if(a.status!==404&&(a.status<200||a.status>=300)){let s=`HTTP ${a.status}`;try{let r=JSON.parse(a.text||"{}");r.error&&(s+=`: ${r.error}`)}catch{a.text&&(s+=`: ${a.text.slice(0,80)}`)}return this.lastError=s,console.error(`Standard: Unpublish failed for ${e?e.basename:n}:`,a.status),!1}return e&&(this.noteStatsCache.delete(e.path),await this.app.fileManager.processFrontMatter(e,s=>{s.publish=!1,"status"in s&&delete s.status,delete s.published,delete s.url_public,delete s["garden-url"],delete s["garden-short"]})),!0}catch(n){return console.error(`Standard: Unpublish error for ${e?e.basename:t}:`,n),!1}}async generateTokens(e,t,n){let a=this.plugin.settings.apiKey;if(!a)throw new Error("Connect your Standard Garden account in settings first.");let s=Object.fromEntries(Object.entries(n).filter(([l])=>yl.has(l))),r=await O.requestUrl({url:`${this.plugin.settings.apiUrl}/ai/theme`,method:"POST",headers:{"Content-Type":"application/json","x-api-key":a},body:JSON.stringify({instruction:e,noteContent:t,currentTokens:s}),throw:!1});if(r.status<200||r.status>=300){let l=r.text;throw new Error(`Standard API ${r.status}: ${l}`)}let i=r.json;if(!i.tokens)throw new Error("No tokens returned from AI service");return i.tokens}async publishWithCheck(e){if(!this.checkApiKeyAndShowModal())return null;let n=this.app.metadataCache.getFileCache(e)?.frontmatter||{},a=async()=>(await this.app.fileManager.processFrontMatter(e,i=>{je(i)||(i.publish=!0),"status"in i&&delete i.status}),await this.publishNote(e)),s=[];return(n.publish===!1||n.publish==="false"||n.status==="draft")&&s.push("\u2022 publish: false \u2014 it was marked not to publish"),String(n.visibility||"").toLowerCase()==="private"&&s.push("\u2022 visibility: private \u2014 visitors won't see it"),s.length>0?new Promise(r=>{new ho(this.app,`\u{1F331} Plant "${e.basename}" in the garden anyway?

${s.join(`
`)}`,"Plant it",async()=>r(await a()),()=>r(null)).open()}):await a()}async checkNoteStatus(e){if(!this.plugin.settings.apiKey||this.isPathExcluded(e.path))return{status:"unpublished"};try{let t=await mo(this.app,e),n=t.permalink??t.slug,a=$(e.basename),s=n!=null?String(n).replace(/^\/+|\/+$/g,""):a,r=s===""?"~root":s,i=await Ce(`${this.plugin.settings.apiUrl}/publish/${encodeURIComponent(r)}`,{method:"GET",headers:{"x-api-key":this.plugin.settings.apiKey}});if(i.status===404)return{status:"unpublished"};if(i.status<200||i.status>=300)throw new Error(`HTTP error ${i.status}`);let l=await i.json(),c=l.content||"",f=l.hash,d=l.updated_at?new Date(l.updated_at).getTime():0;this.noteStatsCache.set(e.path,{views:l.views||0,citations:Array.isArray(l.citations)?l.citations:[],related:Array.isArray(l.related)?l.related:[],created_at:l.created_at,updated_at:l.updated_at,online:!0});let p=await this.app.vault.read(e),h=T=>{if(!T)return"";let x=T.replace(/\r\n/g,`
`);return x=x.replace(/!\[\[([^\]]+)\]\]/g,(L,w)=>{let v=w.split("|"),C=v[0].trim(),D=v[1]?v[1].trim():"";return D?`[IMAGE:${D.toLowerCase()}]`:`[IMAGE:${(C.substring(0,C.lastIndexOf("."))||C).toLowerCase()}]`}),x=x.replace(/!\[([^\]]*)\]\(([^)]+)\)/g,(L,w,v)=>{let C=w.trim();if(C)return`[IMAGE:${C.toLowerCase()}]`;let D=v.split("/").pop()||"";return`[IMAGE:${(D.substring(0,D.lastIndexOf("."))||D).toLowerCase()}]`}),x.trim()},m=h(p),u=h(c),g=new TextEncoder().encode(m),y=await crypto.subtle.digest("SHA-256",g),k=Array.from(new Uint8Array(y)).map(T=>T.toString(16).padStart(2,"0")).join("");if(f===k)return{status:"synced"};let S=e.stat.mtime;return d>S+5e3?{status:"outdated",remoteContent:c}:{status:"changed"}}catch(t){return console.error("Standard : Erreur lors de la v\xE9rification du statut de la note :",t),{status:"error"}}}async deleteOnlineVersion(e){return this.checkApiKeyAndShowModal()?new Promise(t=>{new ho(this.app,`Remove "${e.basename}" from Standard Garden?

The online version will be permanently deleted.`,"Delete online version",async()=>{let n=await this.unpublishNote(e);t(n)},()=>t(null)).open()}):null}async getNoteStats(e){if(!this.plugin.settings.apiKey||this.isPathExcluded(e.path))return null;try{let t=await mo(this.app,e),n=t.permalink??t.slug,a=$(e.basename),s=n!=null?String(n).replace(/^\/+|\/+$/g,""):a,r=s===""?"~root":s,i=await Ce(`${this.plugin.settings.apiUrl}/publish/${encodeURIComponent(r)}`,{method:"GET",headers:{"x-api-key":this.plugin.settings.apiKey}});if(i.status===200){let l=await i.json(),c={views:l.views||0,citations:Array.isArray(l.citations)?l.citations:[],related:Array.isArray(l.related)?l.related:[],created_at:l.created_at,updated_at:l.updated_at,online:!0};return this.noteStatsCache.set(e.path,c),c}return null}catch(t){return console.error("[Standard] Error fetching note stats:",t),null}}async askHypheInquiry(e,t){if(!this.checkApiKeyAndShowModal())return null;try{let n=e?e.basename:"Untitled",a=await O.requestUrl({url:`${this.plugin.settings.apiUrl}/ai/inquire`,method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.plugin.settings.apiKey},body:JSON.stringify({title:n,content:t}),throw:!1});if(a.status===200){let s=a.json;return Array.isArray(s.questions)?s.questions:[]}else{let s=a.text||"";if(s.trim().startsWith("<")||s.includes("<html"))s=`Endpoint returned HTTP ${a.status} (service updating)`;else try{let r=JSON.parse(s);r.error&&(s=r.error)}catch{}throw new Error(s||`Server error (${a.status})`)}}catch(n){throw console.error("[Standard] Error calling askHypheInquiry:",n),n}}async askGardenAI(){this.checkApiKeyAndShowModal()&&new wl(this.app,this.plugin).open()}};Rr.exports={GardenFeature:bo}});var Ur=j((em,Pr)=>{"use strict";var{EditorSuggest:Sl,setTooltip:xl}=require("obsidian"),wo=[{id:"feed",name:"::feed",category:"Flux",syntax:"::feed #tag",description:"Flux de cartes visuelles avec image cover, date relative et extrait markdown.",insertText:"::feed #",cursorOffset:8},{id:"list",name:"::list",category:"Flux",syntax:"::list #tag",description:"Liste compacte \xE0 puces des notes li\xE9es au tag sp\xE9cifi\xE9.",insertText:"::list #",cursorOffset:8},{id:"callout",name:"::callout",category:"Bloc",syntax:`::callout note
...
